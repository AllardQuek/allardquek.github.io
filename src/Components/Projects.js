      ...
      <ProjectsStyled>
        ...
        >
          <ProjectCard
            iconComps={{
              icon1: [
                "https://github.com/AllardQuek/RamsiiBot",
                <GithubIcon />,
              ],
          ...
          <ProjectCard
            iconComps={{
              icon1: [
                "https://github.com/AllardQuek/EduExchange",
                <GithubIcon />,
              ],
              icon2: [
                "https://eduexchange-aq.herokuapp.com/",
                <VisibilityIcon />,
              ],
            }}
          ...
          <ProjectCard
            iconComps={{
              icon1: [
                "https://docs.google.com/presentation/d/1VblWh1uSwqG95XGz1nxdZSTrnRhW3B6Y24AV8RJGRRU/edit?usp=sharing",
                <SlideshowIcon />,
              ],
              icon2: [],
            }}
