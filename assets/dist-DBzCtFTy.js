...
`).find(e=>!e.trim().startsWith(`#`)&&e.trim()!==``)}async function No(e){if(!e)return!1;if(/\.m3u8?(\?.*)?$/i.test(e))return!0;if(e.startsWith(`blob:`))return!1;try{let t=(await fetch(e,{method:`HEAD`})).headers.get(`Content-Type`);return vo.some(e=>t===e)}catch(e){return console.error(`Error while trying to get the Content-Type of the manifest`,e),!1}}async function Po(e){if(!(!e||e.startsWith(`blob:`)))try{let t=await(await fetch(e)).text(),n=t,r=jo(t);if(r.length>0){let t=new URL(r[0],e).toString();n=await(await fetch(t)).text()}return Ao(Mo(n))}catch(e){console.error(`Error while trying to parse the manifest playlist`,e);return}}var Fo=new yo,Io=new WeakSet,Lo;bo(()=>{if(!globalThis.chrome?.cast?.isAvailable){console.debug(`chrome.cast.isAvailable`,globalThis.chrome?.cast?.isAvailable);return}Lo||(Lo=cast.framework,Co().addEventListener(Lo.CastContextEventType.CAST_STATE_CHANGED,e=>{Fo.forEach(t=>ho.get(t).onCastStateChanged?.(e))}),Co().addEventListener(Lo.CastContextEventType.SESSION_STATE_CHANGED,e=>{Fo.forEach(t=>ho.get(t).onSessionStateChanged?.(e))}),Fo.forEach(e=>ho.get(e).init?.()))});var Ro=0,zo=class extends EventTarget{#e;#t;#n;#r;#i=`disconnected`;#a=!1;#o=new Set;#s=new WeakMap;#c=()=>this.#g();constructor(e){super(),this.#e=e,Fo.add(this),ho.set(this,{init:()=>this.#m(),onCastStateChanged:()=>this.#f(),onSessionStateChanged:()=>this.#p(),getCastPlayer:()=>this.#l}),this.#m()}destroy(){this.#e?.textTracks?.removeEventListener(`change`,this.#c),this.#r&&this.#n?.controller&&Object.entries(this.#r).forEach(([e,t])=>{this.#n.controller.removeEventListener(e,t)}),this.#e&&Io.delete(this.#e),this.#t=!1}get#l(){if(Io.has(this.#e))return this.#n}get state(){return this.#i}async watchAvailability(e){if(this.#e.disableRemotePlayback)throw new go(`disableRemotePlayback attribute is present.`);return this.#s.set(e,++Ro),this.#o.add(e),queueMicrotask(()=>e(this.#d())),Ro}async cancelWatchAvailability(e){if(this.#e.disableRemotePlayback)throw new go(`disableRemotePlayback attribute is present.`);e?this.#o.delete(e):this.#o.clear()}async prompt(){if(this.#e.disableRemotePlayback)throw new go(`disableRemotePlayback attribute is present.`);if(!globalThis.chrome?.cast?.isAvailable)throw new _o(`The RemotePlayback API is disabled on this platform.`);let e=Io.has(this.#e);Io.add(this.#e),Oo(this.#e.castOptions),Object.entries(this.#r).forEach(([e,t])=>{this.#n.controller.addEventListener(e,t)});try{await Co().requestSession()}catch(t){if(e||Io.delete(this.#e),t===`cancel`)return;throw Error(t)}ho.get(this.#e)?.loadOnPrompt?.()}#u(){Io.has(this.#e)&&(Object.entries(this.#r).forEach(([e,t])=>{this.#n.controller.removeEventListener(e,t)}),Io.delete(this.#e),this.#e.muted=this.#n.isMuted,this.#e.currentTime=this.#n.savedPlayerState.currentTime,this.#n.savedPlayerState.isPaused===!1&&this.#e.play())}#d(){let e=Co()?.getCastState();return e&&e!==`NO_DEVICES_AVAILABLE`}#f(){let e=Co().getCastState();if(Io.has(this.#e)&&e===`CONNECTING`&&(this.#i=`connecting`,this.dispatchEvent(new Event(`connecting`))),!this.#a&&e?.includes(`CONNECT`)){this.#a=!0;for(let e of this.#o)e(!0)}else if(this.#a&&(!e||e===`NO_DEVICES_AVAILABLE`)){this.#a=!1;for(let e of this.#o)e(!1)}}async#p(){let{SESSION_RESUMED:e}=Lo.SessionState;if(Co().getSessionState()===e&&this.#e.castSrc===To()?.media.contentId){Io.add(this.#e),Object.entries(this.#r).forEach(([e,t])=>{this.#n.controller.addEventListener(e,t)});try{await Do(new chrome.cast.media.GetStatusRequest)}catch(e){console.error(e)}this.#r[Lo.RemotePlayerEventType.IS_PAUSED_CHANGED](),this.#r[Lo.RemotePlayerEventType.PLAYER_STATE_CHANGED]()}}#m(){!Lo||this.#t||(this.#t=!0,Oo(this.#e.castOptions),this.#e.textTracks.addEventListener(`change`,this.#c),this.#f(),this.#n=new Lo.RemotePlayer,new Lo.RemotePlayerController(this.#n),this.#r={[Lo.RemotePlayerEventType.IS_CONNECTED_CHANGED]:({value:e})=>{e===!0?(this.#i=`connected`,this.dispatchEvent(new Event(`connect`))):(this.#u(),this.#i=`disconnected`,this.dispatchEvent(new Event(`disconnect`)))},[Lo.RemotePlayerEventType.DURATION_CHANGED]:()=>{this.#e.dispatchEvent(new Event(`durationchange`))},[Lo.RemotePlayerEventType.VOLUME_LEVEL_CHANGED]:()=>{this.#e.dispatchEvent(new Event(`volumechange`))},[Lo.RemotePlayerEventType.IS_MUTED_CHANGED]:()=>{this.#e.dispatchEvent(new Event(`volumechange`))},[Lo.RemotePlayerEventType.CURRENT_TIME_CHANGED]:()=>{this.#l?.isMediaLoaded&&this.#e.dispatchEvent(new Event(`timeupdate`))},[Lo.RemotePlayerEventType.VIDEO_INFO_CHANGED]:()=>{this.#e.dispatchEvent(new Event(`resize`))},[Lo.RemotePlayerEventType.IS_PAUSED_CHANGED]:()=>{this.#e.dispatchEvent(new Event(this.paused?`pause`:`play`))},[Lo.RemotePlayerEventType.PLAYER_STATE_CHANGED]:()=>{this.#l?.playerState!==chrome.cast.media.PlayerState.PAUSED&&this.#e.dispatchEvent(new Event({[chrome.cast.media.PlayerState.PLAYING]:`playing`,[chrome.cast.media.PlayerState.BUFFERING]:`waiting`,[chrome.cast.media.PlayerState.IDLE]:`emptied`}[this.#l?.playerState]))},[Lo.RemotePlayerEventType.IS_MEDIA_LOADED_CHANGED]:async()=>{this.#l?.isMediaLoaded&&(await Promise.resolve(),this.#h())}})}#h(){this.#g()}async#g(){if(!this.#l)return;let e=(this.#n.mediaInfo?.tracks??[]).filter(({type:e})=>e===chrome.cast.media.TrackType.TEXT),t=[...this.#e.textTracks].filter(({kind:e})=>e===`subtitles`||e===`captions`),n=e.map(({language:e,name:n,trackId:r})=>{let{mode:i}=t.find(t=>t.language===e&&t.label===n)??{};return i?{mode:i,trackId:r}:!1}).filter(Boolean),r=n.filter(({mode:e})=>e!==`showing`).map(({trackId:e})=>e),i=n.find(({mode:e})=>e===`showing`),a=wo()?.getSessionObj().media[0]?.activeTrackIds??[],o=a;if(a.length&&(o=o.filter(e=>!r.includes(e))),i?.trackId&&(o=[...o,i.trackId]),o=[...new Set(o)],!((e,t)=>e.length===t.length&&e.every(e=>t.includes(e)))(a,o))try{await Eo(new chrome.cast.media.EditTracksInfoRequest(o))}catch(e){console.error(e)}}},Bo=e=>class extends e{static observedAttributes=[...e.observedAttributes??[],`cast-src`,`cast-content-type`,`cast-stream-type`,`cast-receiver`];#e={paused:!1};#t=ko();#n;#r;get remote(){return this.#r?this.#r:xo()?this.isConnected?(this.disableRemotePlayback||So(),ho.set(this,{loadOnPrompt:()=>this.#a()}),this.#r=new zo(this)):void 0:super.remote}get#i(){return ho.get(this.remote)?.getCastPlayer?.()}disconnectedCallback(){this.#r?.destroy(),this.#r=null,ho.delete(this),super.disconnectedCallback?.()}attributeChangedCallback(e,t,n){if(super.attributeChangedCallback(e,t,n),e===`cast-receiver`&&n){this.#t.receiverApplicationId=n;return}if(this.#i)switch(e){case`cast-stream-type`:case`cast-src`:this.load();break}}async#a(){this.#e.paused=super.paused,super.pause(),this.muted=super.muted;try{await this.load()}catch(e){console.error(e)}}async load(){if(!this.#i)return super.load();let e=new chrome.cast.media.MediaInfo(this.castSrc,this.castContentType);e.customData=this.castCustomData;let t=[...this.querySelectorAll(`track`)].filter(({kind:e,src:t})=>t&&(e===`subtitles`||e===`captions`)),n=[],r=0;if(t.length&&(e.tracks=t.map(e=>{let t=++r;n.length===0&&e.track.mode===`showing`&&n.push(t);let i=new chrome.cast.media.Track(t,chrome.cast.media.TrackType.TEXT);return i.trackContentId=e.src,i.trackContentType=`text/vtt`,i.subtype=e.kind===`captions`?chrome.cast.media.TextTrackType.CAPTIONS:chrome.cast.media.TextTrackType.SUBTITLES,i.name=e.label,i.language=e.srclang,i})),this.castStreamType===`live`?e.streamType=chrome.cast.media.StreamType.LIVE:e.streamType=chrome.cast.media.StreamType.BUFFERED,e.metadata=new chrome.cast.media.GenericMediaMetadata,e.metadata.title=this.title,e.metadata.images=[{url:this.poster}],await No(this.castSrc)){e.contentType||=`application/x-mpegURL`;let t=await Po(this.castSrc);t?.includes(`m4s`)||t?.includes(`mp4`)?(e.hlsSegmentFormat=chrome.cast.media.HlsSegmentFormat.FMP4,e.hlsVideoSegmentFormat=chrome.cast.media.HlsVideoSegmentFormat.FMP4):t?.includes(`ts`)&&(e.hlsSegmentFormat=chrome.cast.media.HlsSegmentFormat.TS,e.hlsVideoSegmentFormat=chrome.cast.media.HlsVideoSegmentFormat.TS)}let i=new chrome.cast.media.LoadRequest(e);i.currentTime=super.currentTime??0,i.autoplay=!this.#e.paused,i.activeTrackIds=n,await wo()?.loadMedia(i),this.dispatchEvent(new Event(`volumechange`))}play(){if(this.#i){this.#i.isPaused&&this.#i.controller?.playOrPause();return}return super.play()}pause(){if(this.#i){this.#i.isPaused||this.#i.controller?.playOrPause();return}super.pause()}get castOptions(){return this.#t}get castReceiver(){return this.getAttribute(`cast-receiver`)??void 0}set castReceiver(e){this.castReceiver!=e&&this.setAttribute(`cast-receiver`,`${e}`)}get castSrc(){let e=this.currentSrc,t=e?.startsWith(`blob:`)?void 0:e;return this.getAttribute(`cast-src`)??this.querySelector(`source`)?.src??t??this.getAttribute(`src`)??void 0}set castSrc(e){this.castSrc!=e&&this.setAttribute(`cast-src`,`${e}`)}get castContentType(){return this.getAttribute(`cast-content-type`)??void 0}set castContentType(e){this.setAttribute(`cast-content-type`,`${e}`)}get castStreamType(){return this.getAttribute(`cast-stream-type`)??this.streamType??void 0}set castStreamType(e){this.setAttribute(`cast-stream-type`,`${e}`)}get castCustomData(){return this.#n}set castCustomData(e){let t=typeof e;if(![`object`,`undefined`].includes(t)){console.error(`castCustomData must be nullish or an object but value was of type ${t}`);return}this.#n=e}get readyState(){if(this.#i)switch(this.#i.playerState){case chrome.cast.media.PlayerState.IDLE:return 0;case chrome.cast.media.PlayerState.BUFFERING:return 2;default:return 3}return super.readyState}get paused(){return this.#i?this.#i.isPaused:super.paused}get muted(){return this.#i?this.#i?.isMuted:super.muted}set muted(e){if(this.#i){(e&&!this.#i.isMuted||!e&&this.#i.isMuted)&&this.#i.controller?.muteOrUnmute();return}super.muted=e}get volume(){return this.#i?this.#i?.volumeLevel??1:super.volume}set volume(e){if(this.#i){this.#i.volumeLevel=+e,this.#i.controller?.setVolumeLevel();return}super.volume=e}get duration(){return this.#i&&this.#i?.isMediaLoaded?this.#i?.duration??NaN:super.duration}get currentTime(){return this.#i&&this.#i?.isMediaLoaded?this.#i?.currentTime??0:super.currentTime}set currentTime(e){if(this.#i){this.#i.currentTime=e,this.#i.controller?.seek();return}super.currentTime=e}},Vo=e=>{throw TypeError(e)},Ho=(e,t,n)=>t.has(e)||Vo(`Cannot `+n),Uo=(e,t,n)=>(Ho(e,t,`read from private field`),n?n.call(e):t.get(e)),Wo=(e,t,n)=>t.has(e)?Vo(`Cannot add the same private member more than once`):t instanceof WeakSet?t.add(e):t.set(e,n),Go=(e,t,n,r)=>(Ho(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),Ko=class{addEventListener(){}removeEventListener(){}dispatchEvent(e){return!0}};if(typeof DocumentFragment>`u`){class e extends Ko{}globalThis.DocumentFragment=e}var qo=class extends Ko{},Jo=class extends Ko{},Yo={get(e){},define(e,t,n){},getName(e){return null},upgrade(e){},whenDefined(e){return Promise.resolve(qo)}},Xo,Zo=class{constructor(e,t={}){Wo(this,Xo),Go(this,Xo,t?.detail)}get detail(){return Uo(this,Xo)}initCustomEvent(){}};Xo=new WeakMap;function Qo(e,t){return new qo}var $o={document:{createElement:Qo},DocumentFragment,customElements:Yo,CustomEvent:Zo,EventTarget:Ko,HTMLElement:qo,HTMLVideoElement:Jo},es=typeof window>`u`||globalThis.customElements===void 0,ts=es?$o:globalThis;es?$o.document:globalThis.document;var ns,rs=class extends Bo(a(mo)){constructor(){super(...arguments),Wo(this,ns)}get autoplay(){let e=this.getAttribute(`autoplay`);return e===null?!1:e===``?!0:e}set autoplay(e){e!==this.autoplay&&(e?this.setAttribute(`autoplay`,typeof e==`string`?e:``):this.removeAttribute(`autoplay`))}get muxCastCustomData(){return{mux:{playbackId:this.playbackId,minResolution:this.minResolution,maxResolution:this.maxResolution,renditionOrder:this.renditionOrder,customDomain:this.customDomain,tokens:{drm:this.drmToken},envKey:this.envKey,metadata:this.metadata,disableCookies:this.disableCookies,disableTracking:this.disableTracking,beaconCollectionDomain:this.beaconCollectionDomain,startTime:this.startTime,preferCmcd:this.preferCmcd}}}get castCustomData(){return Uo(this,ns)??this.muxCastCustomData}set castCustomData(e){Go(this,ns,e)}};ns=new WeakMap,ts.customElements.get(`mux-video`)||(ts.customElements.define(`mux-video`,rs),ts.MuxVideoElement=rs);var k={MEDIA_PLAY_REQUEST:`mediaplayrequest`,MEDIA_PAUSE_REQUEST:`mediapauserequest`,MEDIA_MUTE_REQUEST:`mediamuterequest`,MEDIA_UNMUTE_REQUEST:`mediaunmuterequest`,MEDIA_LOOP_REQUEST:`medialooprequest`,MEDIA_VOLUME_REQUEST:`mediavolumerequest`,MEDIA_SEEK_REQUEST:`mediaseekrequest`,MEDIA_AIRPLAY_REQUEST:`mediaairplayrequest`,MEDIA_ENTER_FULLSCREEN_REQUEST:`mediaenterfullscreenrequest`,MEDIA_EXIT_FULLSCREEN_REQUEST:`mediaexitfullscreenrequest`,MEDIA_PREVIEW_REQUEST:`mediapreviewrequest`,MEDIA_ENTER_PIP_REQUEST:`mediaenterpiprequest`,MEDIA_EXIT_PIP_REQUEST:`mediaexitpiprequest`,MEDIA_ENTER_CAST_REQUEST:`mediaentercastrequest`,MEDIA_EXIT_CAST_REQUEST:`mediaexitcastrequest`,MEDIA_SHOW_TEXT_TRACKS_REQUEST:`mediashowtexttracksrequest`,MEDIA_HIDE_TEXT_TRACKS_REQUEST:`mediahidetexttracksrequest`,MEDIA_SHOW_SUBTITLES_REQUEST:`mediashowsubtitlesrequest`,MEDIA_DISABLE_SUBTITLES_REQUEST:`mediadisablesubtitlesrequest`,MEDIA_TOGGLE_SUBTITLES_REQUEST:`mediatogglesubtitlesrequest`,MEDIA_PLAYBACK_RATE_REQUEST:`mediaplaybackraterequest`,MEDIA_RENDITION_REQUEST:`mediarenditionrequest`,MEDIA_AUDIO_TRACK_REQUEST:`mediaaudiotrackrequest`,MEDIA_SEEK_TO_LIVE_REQUEST:`mediaseektoliverequest`,REGISTER_MEDIA_STATE_RECEIVER:`registermediastatereceiver`,UNREGISTER_MEDIA_STATE_RECEIVER:`unregistermediastatereceiver`},A={MEDIA_CHROME_ATTRIBUTES:`mediachromeattributes`,MEDIA_CONTROLLER:`mediacontroller`},is={MEDIA_AIRPLAY_UNAVAILABLE:`mediaAirplayUnavailable`,MEDIA_AUDIO_TRACK_ENABLED:`mediaAudioTrackEnabled`,MEDIA_AUDIO_TRACK_LIST:`mediaAudioTrackList`,MEDIA_AUDIO_TRACK_UNAVAILABLE:`mediaAudioTrackUnavailable`,MEDIA_BUFFERED:`mediaBuffered`,MEDIA_CAST_UNAVAILABLE:`mediaCastUnavailable`,MEDIA_CHAPTERS_CUES:`mediaChaptersCues`,MEDIA_CURRENT_TIME:`mediaCurrentTime`,MEDIA_DURATION:`mediaDuration`,MEDIA_ENDED:`mediaEnded`,MEDIA_ERROR:`mediaError`,MEDIA_ERROR_CODE:`mediaErrorCode`,MEDIA_ERROR_MESSAGE:`mediaErrorMessage`,MEDIA_FULLSCREEN_UNAVAILABLE:`mediaFullscreenUnavailable`,MEDIA_HAS_PLAYED:`mediaHasPlayed`,MEDIA_HEIGHT:`mediaHeight`,MEDIA_IS_AIRPLAYING:`mediaIsAirplaying`,MEDIA_IS_CASTING:`mediaIsCasting`,MEDIA_IS_FULLSCREEN:`mediaIsFullscreen`,MEDIA_IS_PIP:`mediaIsPip`,MEDIA_LOADING:`mediaLoading`,MEDIA_MUTED:`mediaMuted`,MEDIA_LOOP:`mediaLoop`,MEDIA_PAUSED:`mediaPaused`,MEDIA_PIP_UNAVAILABLE:`mediaPipUnavailable`,MEDIA_PLAYBACK_RATE:`mediaPlaybackRate`,MEDIA_PREVIEW_CHAPTER:`mediaPreviewChapter`,MEDIA_PREVIEW_COORDS:`mediaPreviewCoords`,MEDIA_PREVIEW_IMAGE:`mediaPreviewImage`,MEDIA_PREVIEW_TIME:`mediaPreviewTime`,MEDIA_RENDITION_LIST:`mediaRenditionList`,MEDIA_RENDITION_SELECTED:`mediaRenditionSelected`,MEDIA_RENDITION_UNAVAILABLE:`mediaRenditionUnavailable`,MEDIA_SEEKABLE:`mediaSeekable`,MEDIA_STREAM_TYPE:`mediaStreamType`,MEDIA_SUBTITLES_LIST:`mediaSubtitlesList`,MEDIA_SUBTITLES_SHOWING:`mediaSubtitlesShowing`,MEDIA_TARGET_LIVE_WINDOW:`mediaTargetLiveWindow`,MEDIA_TIME_IS_LIVE:`mediaTimeIsLive`,MEDIA_VOLUME:`mediaVolume`,MEDIA_VOLUME_LEVEL:`mediaVolumeLevel`,MEDIA_VOLUME_UNAVAILABLE:`mediaVolumeUnavailable`,MEDIA_LANG:`mediaLang`,MEDIA_WIDTH:`mediaWidth`},as=Object.entries(is),j=as.reduce((e,[t,n])=>(e[t]=n.toLowerCase(),e),{}),os=as.reduce((e,[t,n])=>(e[t]=n.toLowerCase(),e),{USER_INACTIVE_CHANGE:`userinactivechange`,BREAKPOINTS_CHANGE:`breakpointchange`,BREAKPOINTS_COMPUTED:`breakpointscomputed`});Object.entries(os).reduce((e,[t,n])=>{let r=j[t];return r&&(e[n]=r),e},{userinactivechange:`userinactive`});var ss=Object.entries(j).reduce((e,[t,n])=>{let r=os[t];return r&&(e[n]=r),e},{userinactive:`userinactivechange`}),cs={SUBTITLES:`subtitles`,CAPTIONS:`captions`,DESCRIPTIONS:`descriptions`,CHAPTERS:`chapters`,METADATA:`metadata`},ls={DISABLED:`disabled`,HIDDEN:`hidden`,SHOWING:`showing`},us={MOUSE:`mouse`,PEN:`pen`,TOUCH:`touch`},ds={UNAVAILABLE:`unavailable`,UNSUPPORTED:`unsupported`},fs={LIVE:`live`,ON_DEMAND:`on-demand`,UNKNOWN:`unknown`},ps={INLINE:`inline`,FULLSCREEN:`fullscreen`,PICTURE_IN_PICTURE:`picture-in-picture`};function ms(e){return e?.map(gs).join(` `)}function hs(e){return e?.split(/\s+/).map(_s)}function gs(e){if(e){let{id:t,width:n,height:r}=e;return[t,n,r].filter(e=>e!=null).join(`:`)}}function _s(e){if(e){let[t,n,r]=e.split(`:`);return{id:t,width:+n,height:+r}}}function vs(e){return e?.map(bs).join(` `)}function ys(e){return e?.split(/\s+/).map(xs)}function bs(e){if(e){let{id:t,kind:n,language:r,label:i}=e;return[t,n,r,i].filter(e=>e!=null).join(`:`)}}function xs(e){if(e){let[t,n,r,i]=e.split(`:`);return{id:t,kind:n,language:r,label:i}}}function Ss(e){return e.replace(/[-_]([a-z])/g,(e,t)=>t.toUpperCase())}function Cs(e){return typeof e==`number`&&!Number.isNaN(e)&&Number.isFinite(e)}function ws(e){return typeof e==`string`?!isNaN(e)&&!isNaN(parseFloat(e)):!1}var Ts=e=>new Promise(t=>setTimeout(t,e)),Es={en:{"Start airplay":`Start airplay`,"Stop airplay":`Stop airplay`,Audio:`Audio`,Captions:`Captions`,"Enable captions":`Enable captions`,"Disable captions":`Disable captions`,"Start casting":`Start casting`,"Stop casting":`Stop casting`,"Enter fullscreen mode":`Enter fullscreen mode`,"Exit fullscreen mode":`Exit fullscreen mode`,Mute:`Mute`,Unmute:`Unmute`,Loop:`Loop`,"Enter picture in picture mode":`Enter picture in picture mode`,"Exit picture in picture mode":`Exit picture in picture mode`,Play:`Play`,Pause:`Pause`,"Playback rate":`Playback rate`,"Playback rate {playbackRate}":`Playback rate {playbackRate}`,Quality:`Quality`,"Seek backward":`Seek backward`,"Seek forward":`Seek forward`,Settings:`Settings`,Auto:`Auto`,"audio player":`audio player`,"video player":`video player`,volume:`volume`,seek:`seek`,"closed captions":`closed captions`,"current playback rate":`current playback rate`,"playback time":`playback time`,"media loading":`media loading`,settings:`settings`,"audio tracks":`audio tracks`,quality:`quality`,play:`play`,pause:`pause`,mute:`mute`,unmute:`unmute`,"chapter: {chapterName}":`chapter: {chapterName}`,live:`live`,Off:`Off`,"start airplay":`start airplay`,"stop airplay":`stop airplay`,"start casting":`start casting`,"stop casting":`stop casting`,"enter fullscreen mode":`enter fullscreen mode`,"exit fullscreen mode":`exit fullscreen mode`,"enter picture in picture mode":`enter picture in picture mode`,"exit picture in picture mode":`exit picture in picture mode`,"seek to live":`seek to live`,"playing live":`playing live`,"seek back {seekOffset} seconds":`seek back {seekOffset} seconds`,"seek forward {seekOffset} seconds":`seek forward {seekOffset} seconds`,"Network Error":`Network Error`,"Decode Error":`Decode Error`,"Source Not Supported":`Source Not Supported`,"Encryption Error":`Encryption Error`,"A network error caused the media download to fail.":`A network error caused the media download to fail.`,"A media error caused playback to be aborted. The media could be corrupt or your browser does not support this format.":`A media error caused playback to be aborted. The media could be corrupt or your browser does not support this format.`,"An unsupported error occurred. The server or network failed, or your browser does not support this format.":`An unsupported error occurred. The server or network failed, or your browser does not support this format.`,"The media is encrypted and there are no keys to decrypt it.":`The media is encrypted and there are no keys to decrypt it.`,hour:`hour`,hours:`hours`,minute:`minute`,minutes:`minutes`,second:`second`,seconds:`seconds`,"{time} remaining":`{time} remaining`,"{currentTime} of {totalTime}":`{currentTime} of {totalTime}`,"video not loaded, unknown time.":`video not loaded, unknown time.`}},Ds=globalThis.navigator?.language||`en`,Os=e=>{Ds=e},ks=e=>{let[t]=Ds.split(`-`);return Es[Ds]?.[e]||Es[t]?.[e]||Es.en?.[e]||e},M=(e,t={})=>ks(e).replace(/\{(\w+)\}/g,(e,n)=>n in t?String(t[n]):`{${n}}`),As=[{singular:`hour`,plural:`hours`},{singular:`minute`,plural:`minutes`},{singular:`second`,plural:`seconds`}],js=(e,t)=>`${e} ${M(e===1?As[t].singular:As[t].plural)}`,Ms=e=>{if(!Cs(e))return``;let t=Math.abs(e),n=t!==e,r=new Date(0,0,0,0,0,t,0),i=[r.getHours(),r.getMinutes(),r.getSeconds()].map((e,t)=>e&&js(e,t)).filter(e=>e).join(`, `);return n?M(`{time} remaining`,{time:i}):i};function Ns(e,t){let n=!1;e<0&&(n=!0,e=0-e),e=e<0?0:e;let r=Math.floor(e%60),i=Math.floor(e/60%60),a=Math.floor(e/3600),o=Math.floor(t/60%60),s=Math.floor(t/3600);return(isNaN(e)||e===1/0)&&(a=i=r=`0`),a=a>0||s>0?a+`:`:``,i=((a||o>=10)&&i<10?`0`+i:i)+`:`,r=r<10?`0`+r:r,(n?`-`:``)+a+i+r}Object.freeze({length:0,start(e){let t=e>>>0;if(t>=this.length)throw new DOMException(`Failed to execute 'start' on 'TimeRanges': The index provided (${t}) is greater than or equal to the maximum bound (${this.length}).`);return 0},end(e){let t=e>>>0;if(t>=this.length)throw new DOMException(`Failed to execute 'end' on 'TimeRanges': The index provided (${t}) is greater than or equal to the maximum bound (${this.length}).`);return 0}});var Ps=class{addEventListener(){}removeEventListener(){}dispatchEvent(){return!0}},Fs=class extends Ps{},Is=class extends Fs{constructor(){super(...arguments),this.role=null}},Ls=class{observe(){}unobserve(){}disconnect(){}},Rs={createElement:function(){return new zs.HTMLElement},createElementNS:function(){return new zs.HTMLElement},addEventListener(){},removeEventListener(){},dispatchEvent(e){return!1}},zs={ResizeObserver:Ls,document:Rs,Node:Fs,Element:Is,HTMLElement:class extends Is{constructor(){super(...arguments),this.innerHTML=``}get content(){return new zs.DocumentFragment}},DocumentFragment:class extends Ps{},customElements:{get:function(){},define:function(){},whenDefined:function(){}},localStorage:{getItem(e){return null},setItem(e,t){},removeItem(e){}},CustomEvent:function(){},getComputedStyle:function(){},navigator:{languages:[],get userAgent(){return``}},matchMedia(e){return{matches:!1,media:e}},DOMParser:class{parseFromString(e,t){return{body:{textContent:e}}}}},Bs=`global`in globalThis&&(globalThis==null?void 0:globalThis.global)===globalThis||typeof window>`u`||window.customElements===void 0,Vs=Object.keys(zs).every(e=>e in globalThis),N=Bs&&!Vs?zs:globalThis,Hs=Bs&&!Vs?Rs:globalThis.document,Us=new WeakMap,Ws=e=>{let t=Us.get(e);return t||Us.set(e,t=new Set),t},Gs=new N.ResizeObserver(e=>{for(let t of e)for(let e of Ws(t.target))e(t)});function Ks(e,t){Ws(e).add(t),Gs.observe(e)}function qs(e,t){let n=Ws(e);n.delete(t),n.size||Gs.unobserve(e)}function Js(e){let t={};for(let n of e)t[n.name]=n.value;return t}function Ys(e){return Xs(e)??tc(e,`media-controller`)}function Xs(e){let{MEDIA_CONTROLLER:t}=A,n=e.getAttribute(t);if(n)return rc(e)?.getElementById(n)}var Zs=(e,t,n=`.value`)=>{let r=e.querySelector(n);r&&(r.textContent=t)},Qs=(e,t)=>{let n=`slot[name="${t}"]`,r=e.shadowRoot.querySelector(n);return r?r.children:[]},$s=(e,t)=>Qs(e,t)[0],ec=(e,t)=>!e||!t?!1:e?.contains(t)?!0:ec(e,t.getRootNode().host),tc=(e,t)=>e?e.closest(t)||tc(e.getRootNode().host,t):null;function nc(e=document){let t=e?.activeElement;return t?nc(t.shadowRoot)??t:null}function rc(e){let t=(e?.getRootNode)?.call(e);return t instanceof ShadowRoot||t instanceof Document?t:null}function ic(e,{depth:t=3,checkOpacity:n=!0,checkVisibilityCSS:r=!0}={}){if(e.checkVisibility)return e.checkVisibility({checkOpacity:n,checkVisibilityCSS:r});let i=e;for(;i&&t>0;){let e=getComputedStyle(i);if(n&&e.opacity===`0`||r&&e.visibility===`hidden`||e.display===`none`)return!1;i=i.parentElement,t--}return!0}function ac(e,t,n,r){let i=r.x-n.x,a=r.y-n.y,o=i*i+a*a;if(o===0)return 0;let s=((e-n.x)*i+(t-n.y)*a)/o;return Math.max(0,Math.min(1,s))}function oc(e,t){return sc(e,e=>e===t)||cc(e,t)}function sc(e,t){let n;for(n of e.querySelectorAll(`style:not([media])`)??[]){let e;try{e=n.sheet?.cssRules}catch{continue}for(let n of e??[])if(t(n.selectorText))return n}}function cc(e,t){let n=e.querySelectorAll(`style:not([media])`)??[],r=n?.[n.length-1];if(!r?.sheet)return console.warn(`Media Chrome: No style sheet found on style tag of`,e),{style:{setProperty:()=>{},removeProperty:()=>``,getPropertyValue:()=>``}};let i=r?.sheet.insertRule(`${t}{}`,r.sheet.cssRules.length);return r.sheet.cssRules?.[i]}function P(e,t,n=NaN){let r=e.getAttribute(t);return r==null?n:+r}function F(e,t,n){let r=+n;if(n==null||Number.isNaN(r)){e.hasAttribute(t)&&e.removeAttribute(t);return}P(e,t,void 0)!==r&&e.setAttribute(t,`${r}`)}function I(e,t){return e.hasAttribute(t)}function L(e,t,n){if(n==null){e.hasAttribute(t)&&e.removeAttribute(t);return}I(e,t)!=n&&e.toggleAttribute(t,n)}function R(e,t,n=null){return e.getAttribute(t)??n}function z(e,t,n){if(n==null){e.hasAttribute(t)&&e.removeAttribute(t);return}let r=`${n}`;R(e,t,void 0)!==r&&e.setAttribute(t,r)}var lc=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},uc=(e,t,n)=>(lc(e,t,`read from private field`),n?n.call(e):t.get(e)),dc=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},fc=(e,t,n,r)=>(lc(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),pc;function mc(e){return`
  ...
  `}var hc=class extends N.HTMLElement{constructor(){if(super(),dc(this,pc,void 0),!this.shadowRoot){this.attachShadow(this.constructor.shadowRootOptions);let e=Js(this.attributes);this.shadowRoot.innerHTML=this.constructor.getTemplateHTML(e)}}static get observedAttributes(){return[A.MEDIA_CONTROLLER,j.MEDIA_PAUSED]}attributeChangedCallback(e,t,n){var r,i,a,o;e===A.MEDIA_CONTROLLER&&(t&&((i=(r=uc(this,pc))?.unassociateElement)==null||i.call(r,this),fc(this,pc,null)),n&&this.isConnected&&(fc(this,pc,this.getRootNode()?.getElementById(n)),(o=(a=uc(this,pc))?.associateElement)==null||o.call(a,this)))}connectedCallback(){var e,t;this.tabIndex=-1,this.setAttribute(`aria-hidden`,`true`),fc(this,pc,gc(this)),this.getAttribute(A.MEDIA_CONTROLLER)&&((t=(e=uc(this,pc))?.associateElement)==null||t.call(e,this)),uc(this,pc)&&(uc(this,pc).addEventListener(`pointerdown`,this),uc(this,pc).addEventListener(`click`,this),uc(this,pc).hasAttribute(`tabindex`)||(uc(this,pc).tabIndex=0))}disconnectedCallback(){var e,t,n,r;this.getAttribute(A.MEDIA_CONTROLLER)&&((t=(e=uc(this,pc))?.unassociateElement)==null||t.call(e,this)),(n=uc(this,pc))==null||n.removeEventListener(`pointerdown`,this),(r=uc(this,pc))==null||r.removeEventListener(`click`,this),fc(this,pc,null)}handleEvent(e){let t=e.composedPath()?.[0];if([`video`,`media-controller`].includes(t?.localName)){if(e.type===`pointerdown`)this._pointerType=e.pointerType;else if(e.type===`click`){let{clientX:t,clientY:n}=e,{left:r,top:i,width:a,height:o}=this.getBoundingClientRect(),s=t-r,c=n-i;if(s<0||c<0||s>a||c>o||a===0&&o===0)return;let l=this._pointerType||`mouse`;if(this._pointerType=void 0,l===us.TOUCH){this.handleTap(e);return}else if(l===us.MOUSE||l===us.PEN){this.handleMouseClick(e);return}}}}get mediaPaused(){return I(this,j.MEDIA_PAUSED)}set mediaPaused(e){L(this,j.MEDIA_PAUSED,e)}handleTap(e){}handleMouseClick(e){let t=this.mediaPaused?k.MEDIA_PLAY_REQUEST:k.MEDIA_PAUSE_REQUEST;this.dispatchEvent(new N.CustomEvent(t,{composed:!0,bubbles:!0}))}};pc=new WeakMap,hc.shadowRootOptions={mode:`open`},hc.getTemplateHTML=mc;function gc(e){let t=e.getAttribute(A.MEDIA_CONTROLLER);return t?e.getRootNode()?.getElementById(t):tc(e,`media-controller`)}N.customElements.get(`media-gesture-receiver`)||N.customElements.define(`media-gesture-receiver`,hc);var _c=hc,vc=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},yc=(e,t,n)=>(vc(e,t,`read from private field`),n?n.call(e):t.get(e)),bc=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},xc=(e,t,n,r)=>(vc(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),Sc=(e,t,n)=>(vc(e,t,`access private method`),n),Cc,wc,Tc,Ec,Dc,Oc,kc,Ac,jc,Mc,Nc,Pc,Fc,Ic,Lc,Rc,zc,Bc,Vc,Hc,B={AUDIO:`audio`,AUTOHIDE:`autohide`,BREAKPOINTS:`breakpoints`,GESTURES_DISABLED:`gesturesdisabled`,KEYBOARD_CONTROL:`keyboardcontrol`,NO_AUTOHIDE:`noautohide`,USER_INACTIVE:`userinactive`,AUTOHIDE_OVER_CONTROLS:`autohideovercontrols`};function Uc(e){return`
    <style>
    ...
    <slot name="gestures-chrome" part="layer gesture-layer">
      <media-gesture-receiver slot="gestures-chrome">
        <template shadowrootmode="${_c.shadowRootOptions.mode}">
          ${_c.getTemplateHTML({})}
        </template>
  ...
  `}var Wc=Object.values(j),Gc=`sm:384 md:576 lg:768 xl:960`;function Kc(e){qc(e.target,e.contentRect.width)}function qc(e,t){if(!e.isConnected)return;let n=Jc(e.getAttribute(B.BREAKPOINTS)??Gc),r=Yc(n,t),i=!1;if(Object.keys(n).forEach(t=>{if(r.includes(t)){e.hasAttribute(`breakpoint${t}`)||(e.setAttribute(`breakpoint${t}`,``),i=!0);return}e.hasAttribute(`breakpoint${t}`)&&(e.removeAttribute(`breakpoint${t}`),i=!0)}),i){let t=new CustomEvent(os.BREAKPOINTS_CHANGE,{detail:r});e.dispatchEvent(t)}e.breakpointsComputed||(e.breakpointsComputed=!0,e.dispatchEvent(new CustomEvent(os.BREAKPOINTS_COMPUTED,{bubbles:!0,composed:!0})))}function Jc(e){let t=e.split(/\s+/);return Object.fromEntries(t.map(e=>e.split(`:`)))}function Yc(e,t){return Object.keys(e).filter(n=>t>=parseInt(e[n]))}var Xc=class extends N.HTMLElement{constructor(){if(super(),bc(this,jc),bc(this,Nc),bc(this,Fc),bc(this,Lc),bc(this,zc),bc(this,Cc,void 0),bc(this,wc,0),bc(this,Tc,null),bc(this,Ec,null),bc(this,Dc,void 0),this.breakpointsComputed=!1,bc(this,Oc,e=>{let t=this.media;for(let n of e){if(n.type!==`childList`)continue;let e=n.removedNodes;for(let r of e){if(r.slot!=`media`||n.target!=this)continue;let e=n.previousSibling&&n.previousSibling.previousElementSibling;if(!e||!t)this.mediaUnsetCallback(r);else{let t=e.slot!==`media`;for(;(e=e.previousSibling)!==null;)e.slot==`media`&&(t=!1);t&&this.mediaUnsetCallback(r)}}if(t)for(let e of n.addedNodes)e===t&&this.handleMediaUpdated(t)}}),bc(this,kc,!1),bc(this,Ac,e=>{yc(this,kc)||(setTimeout(()=>{Kc(e),xc(this,kc,!1)},0),xc(this,kc,!0))}),bc(this,Vc,void 0),bc(this,Hc,()=>{if(!yc(this,Vc).assignedElements({flatten:!0}).length){yc(this,Tc)&&this.mediaUnsetCallback(yc(this,Tc));return}this.handleMediaUpdated(this.media)}),!this.shadowRoot){this.attachShadow(this.constructor.shadowRootOptions);let e=Js(this.attributes),t=this.constructor.getTemplateHTML(e);this.shadowRoot.setHTMLUnsafe?this.shadowRoot.setHTMLUnsafe(t):this.shadowRoot.innerHTML=t}xc(this,Cc,new MutationObserver(yc(this,Oc)))}static get observedAttributes(){return[B.AUTOHIDE,B.GESTURES_DISABLED].concat(Wc).filter(e=>![j.MEDIA_RENDITION_LIST,j.MEDIA_AUDIO_TRACK_LIST,j.MEDIA_CHAPTERS_CUES,j.MEDIA_WIDTH,j.MEDIA_HEIGHT,j.MEDIA_ERROR,j.MEDIA_ERROR_MESSAGE].includes(e))}attributeChangedCallback(e,t,n){e.toLowerCase()==B.AUTOHIDE&&(this.autohide=n)}get media(){let e=this.querySelector(`:scope > [slot=media]`);return e?.nodeName==`SLOT`&&(e=e.assignedElements({flatten:!0})[0]),e}async handleMediaUpdated(e){e&&(xc(this,Tc,e),e.localName.includes(`-`)&&await N.customElements.whenDefined(e.localName),this.mediaSetCallback(e))}connectedCallback(){var e;yc(this,Cc).observe(this,{childList:!0,subtree:!0}),Ks(this,yc(this,Ac));let t=this.getAttribute(B.AUDIO)==null?M(`video player`):M(`audio player`);this.setAttribute(`role`,`region`),this.setAttribute(`aria-label`,t),this.handleMediaUpdated(this.media),this.setAttribute(B.USER_INACTIVE,``),qc(this,this.getBoundingClientRect().width);let n=this.querySelector(`:scope > slot[slot=media]`);n&&(xc(this,Vc,n),yc(this,Vc).addEventListener(`slotchange`,yc(this,Hc))),this.addEventListener(`pointerdown`,this),this.addEventListener(`pointermove`,this),this.addEventListener(`pointerup`,this),this.addEventListener(`mouseleave`,this),this.addEventListener(`keyup`,this),(e=N.window)==null||e.addEventListener(`mouseup`,this)}disconnectedCallback(){var e;qs(this,yc(this,Ac)),clearTimeout(yc(this,Ec)),yc(this,Cc).disconnect(),this.media&&this.mediaUnsetCallback(this.media),(e=N.window)==null||e.removeEventListener(`mouseup`,this),this.removeEventListener(`pointerdown`,this),this.removeEventListener(`pointermove`,this),this.removeEventListener(`pointerup`,this),this.removeEventListener(`mouseleave`,this),this.removeEventListener(`keyup`,this),yc(this,Vc)&&(yc(this,Vc).removeEventListener(`slotchange`,yc(this,Hc)),xc(this,Vc,null)),xc(this,kc,!1)}mediaSetCallback(e){}mediaUnsetCallback(e){xc(this,Tc,null)}handleEvent(e){switch(e.type){case`pointerdown`:xc(this,wc,e.timeStamp);break;case`pointermove`:Sc(this,jc,Mc).call(this,e);break;case`pointerup`:Sc(this,Nc,Pc).call(this,e);break;case`mouseleave`:Sc(this,Fc,Ic).call(this);break;case`mouseup`:this.removeAttribute(B.KEYBOARD_CONTROL);break;case`keyup`:Sc(this,zc,Bc).call(this),this.setAttribute(B.KEYBOARD_CONTROL,``);break}}set autohide(e){let t=Number(e);xc(this,Dc,isNaN(t)?0:t)}get autohide(){return(yc(this,Dc)===void 0?2:yc(this,Dc)).toString()}get breakpoints(){return R(this,B.BREAKPOINTS)}set breakpoints(e){z(this,B.BREAKPOINTS,e)}get audio(){return I(this,B.AUDIO)}set audio(e){L(this,B.AUDIO,e)}get gesturesDisabled(){return I(this,B.GESTURES_DISABLED)}set gesturesDisabled(e){L(this,B.GESTURES_DISABLED,e)}get keyboardControl(){return I(this,B.KEYBOARD_CONTROL)}set keyboardControl(e){L(this,B.KEYBOARD_CONTROL,e)}get noAutohide(){return I(this,B.NO_AUTOHIDE)}set noAutohide(e){L(this,B.NO_AUTOHIDE,e)}get autohideOverControls(){return I(this,B.AUTOHIDE_OVER_CONTROLS)}set autohideOverControls(e){L(this,B.AUTOHIDE_OVER_CONTROLS,e)}get userInteractive(){return I(this,B.USER_INACTIVE)}set userInteractive(e){L(this,B.USER_INACTIVE,e)}};Cc=new WeakMap,wc=new WeakMap,Tc=new WeakMap,Ec=new WeakMap,Dc=new WeakMap,Oc=new WeakMap,kc=new WeakMap,Ac=new WeakMap,jc=new WeakSet,Mc=function(e){if(e.pointerType!==`mouse`&&e.timeStamp-yc(this,wc)<250)return;Sc(this,Lc,Rc).call(this),clearTimeout(yc(this,Ec));let t=this.hasAttribute(B.AUTOHIDE_OVER_CONTROLS);([this,this.media].includes(e.target)||t)&&Sc(this,zc,Bc).call(this)},Nc=new WeakSet,Pc=function(e){if(e.pointerType===`touch`){let t=!this.hasAttribute(B.USER_INACTIVE);[this,this.media].includes(e.target)&&t?Sc(this,Fc,Ic).call(this):Sc(this,zc,Bc).call(this)}else e.composedPath().some(e=>[`media-play-button`,`media-fullscreen-button`].includes(e?.localName))&&Sc(this,zc,Bc).call(this)},Fc=new WeakSet,Ic=function(){if(yc(this,Dc)<0||this.hasAttribute(B.USER_INACTIVE))return;this.setAttribute(B.USER_INACTIVE,``);let e=new N.CustomEvent(os.USER_INACTIVE_CHANGE,{composed:!0,bubbles:!0,detail:!0});this.dispatchEvent(e)},Lc=new WeakSet,Rc=function(){if(!this.hasAttribute(B.USER_INACTIVE))return;this.removeAttribute(B.USER_INACTIVE);let e=new N.CustomEvent(os.USER_INACTIVE_CHANGE,{composed:!0,bubbles:!0,detail:!1});this.dispatchEvent(e)},zc=new WeakSet,Bc=function(){Sc(this,Lc,Rc).call(this),clearTimeout(yc(this,Ec));let e=parseInt(this.autohide);e<0||xc(this,Ec,setTimeout(()=>{Sc(this,Fc,Ic).call(this)},e*1e3))},Vc=new WeakMap,Hc=new WeakMap,Xc.shadowRootOptions={mode:`open`},Xc.getTemplateHTML=Uc,N.customElements.get(`media-container`)||N.customElements.define(`media-container`,Xc);var Zc=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},Qc=(e,t,n)=>(Zc(e,t,`read from private field`),n?n.call(e):t.get(e)),$c=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},el=(e,t,n,r)=>(Zc(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),tl,nl,rl,il,al,ol,sl=class{constructor(e,t,{defaultValue:n}={defaultValue:void 0}){$c(this,al),$c(this,tl,void 0),$c(this,nl,void 0),$c(this,rl,void 0),$c(this,il,new Set),el(this,tl,e),el(this,nl,t),el(this,rl,new Set(n))}[Symbol.iterator](){return Qc(this,al,ol).values()}get length(){return Qc(this,al,ol).size}get value(){return[...Qc(this,al,ol)].join(` `)??``}set value(e){e!==this.value&&(el(this,il,new Set),this.add(...e?.split(` `)??[]))}toString(){return this.value}item(e){return[...Qc(this,al,ol)][e]}values(){return Qc(this,al,ol).values()}forEach(e,t){Qc(this,al,ol).forEach(e,t)}add(...e){var t;e.forEach(e=>Qc(this,il).add(e)),!(this.value===``&&!Qc(this,tl)?.hasAttribute(`${Qc(this,nl)}`))&&((t=Qc(this,tl))==null||t.setAttribute(`${Qc(this,nl)}`,`${this.value}`))}remove(...e){var t;e.forEach(e=>Qc(this,il).delete(e)),(t=Qc(this,tl))==null||t.setAttribute(`${Qc(this,nl)}`,`${this.value}`)}contains(e){return Qc(this,al,ol).has(e)}toggle(e,t){return t===void 0?this.contains(e)?(this.remove(e),!1):(this.add(e),!0):t?(this.add(e),!0):(this.remove(e),!1)}replace(e,t){return this.remove(e),this.add(t),e===t}};tl=new WeakMap,nl=new WeakMap,rl=new WeakMap,il=new WeakMap,al=new WeakSet,ol=function(){return Qc(this,il).size?Qc(this,il):Qc(this,rl)};var cl=(e=``)=>e.split(/\s+/),ll=(e=``)=>{let[t,n,r]=e.split(`:`),i=r?decodeURIComponent(r):void 0;return{kind:t===`cc`?cs.CAPTIONS:cs.SUBTITLES,language:n,label:i}},ul=(e=``,t={})=>cl(e).map(e=>{let n=ll(e);return{...t,...n}}),dl=e=>e?Array.isArray(e)?e.map(e=>typeof e==`string`?ll(e):e):typeof e==`string`?ul(e):[e]:[],fl=({kind:e,label:t,language:n}={kind:`subtitles`})=>t?`${e===`captions`?`cc`:`sb`}:${n}:${encodeURIComponent(t)}`:n,pl=(e=[])=>Array.prototype.map.call(e,fl).join(` `),ml=(e,t)=>n=>n[e]===t,hl=e=>{let t=Object.entries(e).map(([e,t])=>ml(e,t));return e=>t.every(t=>t(e))},gl=(e,t=[],n=[])=>{let r=dl(n).map(hl);Array.from(t).filter(e=>r.some(t=>t(e))).forEach(t=>{t.mode=e})},_l=(e,t=()=>!0)=>{if(!e?.textTracks)return[];let n=typeof t==`function`?t:hl(t);return Array.from(e.textTracks).filter(n)},vl=e=>!!e.mediaSubtitlesShowing?.length||e.hasAttribute(j.MEDIA_SUBTITLES_SHOWING),yl=e=>{let{media:t,fullscreenElement:n}=e;try{let e=n&&`requestFullscreen`in n?`requestFullscreen`:n&&`webkitRequestFullScreen`in n?`webkitRequestFullScreen`:void 0;if(e){let t=n[e]?.call(n);if(t instanceof Promise)return t.catch(()=>{})}else t?.webkitEnterFullscreen?t.webkitEnterFullscreen():t?.requestFullscreen&&t.requestFullscreen()}catch(e){console.error(e)}},bl=`exitFullscreen`in Hs?`exitFullscreen`:`webkitExitFullscreen`in Hs?`webkitExitFullscreen`:`webkitCancelFullScreen`in Hs?`webkitCancelFullScreen`:void 0,xl=e=>{let{documentElement:t}=e;if(bl){let e=(t?.[bl])?.call(t);if(e instanceof Promise)return e.catch(()=>{})}},Sl=`fullscreenElement`in Hs?`fullscreenElement`:`webkitFullscreenElement`in Hs?`webkitFullscreenElement`:void 0,Cl=e=>{let{documentElement:t,media:n}=e,r=t?.[Sl];return!r&&`webkitDisplayingFullscreen`in n&&`webkitPresentationMode`in n&&n.webkitDisplayingFullscreen&&n.webkitPresentationMode===ps.FULLSCREEN?n:r},wl=e=>{let{media:t,documentElement:n,fullscreenElement:r=t}=e;if(!t||!n)return!1;let i=Cl(e);if(!i)return!1;if(i===r||i===t)return!0;if(i.localName.includes(`-`)){let e=i.shadowRoot;if(!(Sl in e))return ec(i,r);for(;e?.[Sl];){if(e[Sl]===r)return!0;e=e[Sl]?.shadowRoot}}return!1},Tl=`fullscreenEnabled`in Hs?`fullscreenEnabled`:`webkitFullscreenEnabled`in Hs?`webkitFullscreenEnabled`:void 0,El=e=>{let{documentElement:t,media:n}=e;return!!t?.[Tl]||n&&`webkitSupportsFullscreen`in n},Dl,Ol=()=>{var e;return Dl||(Dl=((e=Hs)?.createElement)?.call(e,`video`),Dl)},kl=async(e=Ol())=>{if(!e)return!1;let t=e.volume;e.volume=t/2+.1;let n=new AbortController,r=await Promise.race([Al(e,n.signal),jl(e,t)]);return n.abort(),r},Al=(e,t)=>new Promise(n=>{e.addEventListener(`volumechange`,()=>n(!0),{signal:t})}),jl=async(e,t)=>{for(let n=0;n<10;n++){if(e.volume===t)return!1;await Ts(10)}return e.volume!==t},Ml=/.*Version\/.*Safari\/.*/.test(N.navigator.userAgent),Nl=(e=Ol())=>N.matchMedia(`(display-mode: standalone)`).matches&&Ml?!1:typeof e?.requestPictureInPicture==`function`,Pl=(e=Ol())=>El({documentElement:Hs,media:e}),Fl=Pl(),Il=Nl(),Ll=!!N.WebKitPlaybackTargetAvailabilityEvent,Rl=!!N.chrome,zl=e=>_l(e.media,e=>[cs.SUBTITLES,cs.CAPTIONS].includes(e.kind)).sort((e,t)=>e.kind>=t.kind?1:-1),Bl=e=>_l(e.media,e=>e.mode===ls.SHOWING&&[cs.SUBTITLES,cs.CAPTIONS].includes(e.kind)),Vl=(e,t)=>{let n=zl(e),r=Bl(e),i=!!r.length;if(n.length){if(t===!1||i&&t!==!0)gl(ls.DISABLED,n,r);else if(t===!0||!i&&t!==!1){let t=n[0],{options:i}=e;if(!i?.noSubtitlesLangPref){let e=N.localStorage.getItem(`media-chrome-pref-subtitles-lang`),r=e?[e,...N.navigator.languages]:N.navigator.languages,i=n.filter(e=>r.some(t=>e.language.toLowerCase().startsWith(t.split(`-`)[0]))).sort((e,t)=>r.findIndex(t=>e.language.toLowerCase().startsWith(t.split(`-`)[0]))-r.findIndex(e=>t.language.toLowerCase().startsWith(e.split(`-`)[0])));i[0]&&(t=i[0])}let{language:a,label:o,kind:s}=t;gl(ls.DISABLED,n,r),gl(ls.SHOWING,n,[{language:a,label:o,kind:s}])}}},Hl=(e,t)=>e===t?!0:e==null||t==null||typeof e!=typeof t?!1:typeof e==`number`&&Number.isNaN(e)&&Number.isNaN(t)?!0:typeof e==`object`?Array.isArray(e)?Ul(e,t):Object.entries(e).every(([e,n])=>e in t&&Hl(n,t[e])):!1,Ul=(e,t)=>{let n=Array.isArray(e),r=Array.isArray(t);return n===r?n||r?e.length===t.length?e.every((e,n)=>Hl(e,t[n])):!1:!0:!1},Wl=Object.values(fs),Gl,Kl=kl().then(e=>(Gl=e,Gl)),ql=async(...e)=>{await Promise.all(e.filter(e=>e).map(async e=>{if(!(`localName`in e&&e instanceof N.HTMLElement))return;let t=e.localName;if(!t.includes(`-`))return;let n=N.customElements.get(t);n&&e instanceof n||(await N.customElements.whenDefined(t),N.customElements.upgrade(e))}))},Jl=new N.DOMParser,Yl=e=>e&&(Jl.parseFromString(e,`text/html`).body.textContent||e),Xl={mediaError:{get(e,t){let{media:n}=e;if(t?.type!==`playing`)return n?.error},mediaEvents:[`emptied`,`error`,`playing`]},mediaErrorCode:{get(e,t){let{media:n}=e;if(t?.type!==`playing`)return n?.error?.code},mediaEvents:[`emptied`,`error`,`playing`]},mediaErrorMessage:{get(e,t){let{media:n}=e;if(t?.type!==`playing`)return n?.error?.message??``},mediaEvents:[`emptied`,`error`,`playing`]},mediaWidth:{get(e){let{media:t}=e;return t?.videoWidth??0},mediaEvents:[`resize`]},mediaHeight:{get(e){let{media:t}=e;return t?.videoHeight??0},mediaEvents:[`resize`]},mediaPaused:{get(e){let{media:t}=e;return t?.paused??!0},set(e,t){var n;let{media:r}=t;r&&(e?r.pause():(n=r.play())==null||n.catch(()=>{}))},mediaEvents:[`play`,`playing`,`pause`,`emptied`]},mediaHasPlayed:{get(e,t){let{media:n}=e;return n?t?t.type===`playing`:!n.paused:!1},mediaEvents:[`playing`,`emptied`]},mediaEnded:{get(e){let{media:t}=e;return t?.ended??!1},mediaEvents:[`seeked`,`ended`,`emptied`]},mediaPlaybackRate:{get(e){let{media:t}=e;return t?.playbackRate??1},set(e,t){let{media:n}=t;n&&Number.isFinite(+e)&&(n.playbackRate=+e)},mediaEvents:[`ratechange`,`loadstart`]},mediaMuted:{get(e){let{media:t}=e;return t?.muted??!1},set(e,t){let{media:n,options:{noMutedPref:r}={}}=t;if(n){n.muted=e;try{let t=N.localStorage.getItem(`media-chrome-pref-muted`)!==null,i=n.hasAttribute(`muted`);if(r){t&&N.localStorage.removeItem(`media-chrome-pref-muted`);return}if(i&&!t)return;N.localStorage.setItem(`media-chrome-pref-muted`,e?`true`:`false`)}catch(e){console.debug(`Error setting muted pref`,e)}}},mediaEvents:[`volumechange`],stateOwnersUpdateHandlers:[(e,t)=>{let{options:{noMutedPref:n}}=t,{media:r}=t;if(!(!r||r.muted||n))try{let n=N.localStorage.getItem(`media-chrome-pref-muted`)===`true`;Xl.mediaMuted.set(n,t),e(n)}catch(e){console.debug(`Error getting muted pref`,e)}}]},mediaLoop:{get(e){let{media:t}=e;return t?.loop},set(e,t){let{media:n}=t;n&&(n.loop=e)},mediaEvents:[`medialooprequest`]},mediaVolume:{get(e){let{media:t}=e;return t?.volume??1},set(e,t){let{media:n,options:{noVolumePref:r}={}}=t;if(n){try{e==null?N.localStorage.removeItem(`media-chrome-pref-volume`):!n.hasAttribute(`muted`)&&!r&&N.localStorage.setItem(`media-chrome-pref-volume`,e.toString())}catch(e){console.debug(`Error setting volume pref`,e)}Number.isFinite(+e)&&(n.volume=+e)}},mediaEvents:[`volumechange`],stateOwnersUpdateHandlers:[(e,t)=>{let{options:{noVolumePref:n}}=t;if(!n)try{let{media:n}=t;if(!n)return;let r=N.localStorage.getItem(`media-chrome-pref-volume`);if(r==null)return;Xl.mediaVolume.set(+r,t),e(+r)}catch(e){console.debug(`Error getting volume pref`,e)}}]},mediaVolumeLevel:{get(e){let{media:t}=e;return t?.volume===void 0?`high`:t.muted||t.volume===0?`off`:t.volume<.5?`low`:t.volume<.75?`medium`:`high`},mediaEvents:[`volumechange`]},mediaCurrentTime:{get(e){let{media:t}=e;return t?.currentTime??0},set(e,t){let{media:n}=t;!n||!Cs(e)||(n.currentTime=e)},mediaEvents:[`timeupdate`,`loadedmetadata`]},mediaDuration:{get(e){let{media:t,options:{defaultDuration:n}={}}=e;return n&&(!t||!t.duration||Number.isNaN(t.duration)||!Number.isFinite(t.duration))?n:Number.isFinite(t?.duration)?t.duration:NaN},mediaEvents:[`durationchange`,`loadedmetadata`,`emptied`]},mediaLoading:{get(e){let{media:t}=e;return t?.readyState<3},mediaEvents:[`waiting`,`playing`,`emptied`]},mediaSeekable:{get(e){let{media:t}=e;if(!t?.seekable?.length)return;let n=t.seekable.start(0),r=t.seekable.end(t.seekable.length-1);if(!(!n&&!r))return[Number(n.toFixed(3)),Number(r.toFixed(3))]},mediaEvents:[`loadedmetadata`,`emptied`,`progress`,`seekablechange`]},mediaBuffered:{get(e){let{media:t}=e,n=t?.buffered??[];return Array.from(n).map((e,t)=>[Number(n.start(t).toFixed(3)),Number(n.end(t).toFixed(3))])},mediaEvents:[`progress`,`emptied`]},mediaStreamType:{get(e){let{media:t,options:{defaultStreamType:n}={}}=e,r=[fs.LIVE,fs.ON_DEMAND].includes(n)?n:void 0;if(!t)return r;let{streamType:i}=t;if(Wl.includes(i))return i===fs.UNKNOWN?r:i;let a=t.duration;return a===1/0?fs.LIVE:Number.isFinite(a)?fs.ON_DEMAND:r},mediaEvents:[`emptied`,`durationchange`,`loadedmetadata`,`streamtypechange`]},mediaTargetLiveWindow:{get(e){let{media:t}=e;if(!t)return NaN;let{targetLiveWindow:n}=t,r=Xl.mediaStreamType.get(e);return(n==null||Number.isNaN(n))&&r===fs.LIVE?0:n},mediaEvents:[`emptied`,`durationchange`,`loadedmetadata`,`streamtypechange`,`targetlivewindowchange`]},mediaTimeIsLive:{get(e){let{media:t,options:{liveEdgeOffset:n=10}={}}=e;if(!t)return!1;if(typeof t.liveEdgeStart==`number`)return Number.isNaN(t.liveEdgeStart)?!1:t.currentTime>=t.liveEdgeStart;if(Xl.mediaStreamType.get(e)!==fs.LIVE)return!1;let r=t.seekable;if(!r)return!0;if(!r.length)return!1;let i=r.end(r.length-1)-n;return t.currentTime>=i},mediaEvents:[`playing`,`timeupdate`,`progress`,`waiting`,`emptied`]},mediaSubtitlesList:{get(e){return zl(e).map(({kind:e,label:t,language:n})=>({kind:e,label:t,language:n}))},mediaEvents:[`loadstart`],textTracksEvents:[`addtrack`,`removetrack`]},mediaSubtitlesShowing:{get(e){return Bl(e).map(({kind:e,label:t,language:n})=>({kind:e,label:t,language:n}))},mediaEvents:[`loadstart`],textTracksEvents:[`addtrack`,`removetrack`,`change`],stateOwnersUpdateHandlers:[(e,t)=>{var n,r;let{media:i,options:a}=t;if(!i)return;let o=e=>{a.defaultSubtitles&&(e&&![cs.CAPTIONS,cs.SUBTITLES].includes(e?.track?.kind)||Vl(t,!0))};return i.addEventListener(`loadstart`,o),(n=i.textTracks)==null||n.addEventListener(`addtrack`,o),(r=i.textTracks)==null||r.addEventListener(`removetrack`,o),()=>{var e,t;i.removeEventListener(`loadstart`,o),(e=i.textTracks)==null||e.removeEventListener(`addtrack`,o),(t=i.textTracks)==null||t.removeEventListener(`removetrack`,o)}}]},mediaChaptersCues:{get(e){let{media:t}=e;if(!t)return[];let[n]=_l(t,{kind:cs.CHAPTERS});return Array.from(n?.cues??[]).map(({text:e,startTime:t,endTime:n})=>({text:Yl(e),startTime:t,endTime:n}))},mediaEvents:[`loadstart`,`loadedmetadata`],textTracksEvents:[`addtrack`,`removetrack`,`change`],stateOwnersUpdateHandlers:[(e,t)=>{let{media:n}=t;if(!n)return;let r=n.querySelector(`track[kind="chapters"][default][src]`),i=n.shadowRoot?.querySelector(`:is(video,audio) > track[kind="chapters"][default][src]`);return r?.addEventListener(`load`,e),i?.addEventListener(`load`,e),()=>{r?.removeEventListener(`load`,e),i?.removeEventListener(`load`,e)}}]},mediaIsPip:{get(e){let{media:t,documentElement:n}=e;if(!t||!n||!n.pictureInPictureElement)return!1;if(n.pictureInPictureElement===t)return!0;if(n.pictureInPictureElement instanceof HTMLMediaElement)return t.localName?.includes(`-`)?ec(t,n.pictureInPictureElement):!1;if(n.pictureInPictureElement.localName.includes(`-`)){let e=n.pictureInPictureElement.shadowRoot;for(;e?.pictureInPictureElement;){if(e.pictureInPictureElement===t)return!0;e=e.pictureInPictureElement?.shadowRoot}}return!1},set(e,t){let{media:n}=t;if(n)if(e){if(!Hs.pictureInPictureEnabled){console.warn(`MediaChrome: Picture-in-picture is not enabled`);return}if(!n.requestPictureInPicture){console.warn(`MediaChrome: The current media does not support picture-in-picture`);return}let e=()=>{console.warn(`MediaChrome: The media is not ready for picture-in-picture. It must have a readyState > 0.`)};n.requestPictureInPicture().catch(t=>{if(t.code===11){if(!n.src){console.warn(`MediaChrome: The media is not ready for picture-in-picture. It must have a src set.`);return}if(n.readyState===0&&n.preload===`none`){let t=()=>{n.removeEventListener(`loadedmetadata`,r),n.preload=`none`},r=()=>{n.requestPictureInPicture().catch(e),t()};n.addEventListener(`loadedmetadata`,r),n.preload=`metadata`,setTimeout(()=>{n.readyState===0&&e(),t()},1e3)}else throw t}else throw t})}else Hs.pictureInPictureElement&&Hs.exitPictureInPicture()},mediaEvents:[`enterpictureinpicture`,`leavepictureinpicture`]},mediaRenditionList:{get(e){let{media:t}=e;return[...t?.videoRenditions??[]].map(e=>({...e}))},mediaEvents:[`emptied`,`loadstart`],videoRenditionsEvents:[`addrendition`,`removerendition`]},mediaRenditionSelected:{get(e){let{media:t}=e;return t?.videoRenditions?.[t.videoRenditions?.selectedIndex]?.id},set(e,t){let{media:n}=t;if(!n?.videoRenditions){console.warn(`MediaController: Rendition selection not supported by this media.`);return}let r=e,i=Array.prototype.findIndex.call(n.videoRenditions,e=>e.id==r);n.videoRenditions.selectedIndex!=i&&(n.videoRenditions.selectedIndex=i)},mediaEvents:[`emptied`],videoRenditionsEvents:[`addrendition`,`removerendition`,`change`]},mediaAudioTrackList:{get(e){let{media:t}=e;return[...t?.audioTracks??[]]},mediaEvents:[`emptied`,`loadstart`],audioTracksEvents:[`addtrack`,`removetrack`]},mediaAudioTrackEnabled:{get(e){let{media:t}=e;return[...t?.audioTracks??[]].find(e=>e.enabled)?.id},set(e,t){let{media:n}=t;if(!n?.audioTracks){console.warn(`MediaChrome: Audio track selection not supported by this media.`);return}let r=e;for(let e of n.audioTracks)e.enabled=r==e.id},mediaEvents:[`emptied`],audioTracksEvents:[`addtrack`,`removetrack`,`change`]},mediaIsFullscreen:{get(e){return wl(e)},set(e,t,n){var r;e?(yl(t),n.detail&&!t.media?.inert&&((r=t.media)==null||r.focus())):xl(t)},rootEvents:[`fullscreenchange`,`webkitfullscreenchange`],mediaEvents:[`webkitbeginfullscreen`,`webkitendfullscreen`,`webkitpresentationmodechanged`]},mediaIsCasting:{get(e){let{media:t}=e;return!t?.remote||t.remote?.state===`disconnected`?!1:!!t.remote.state},set(e,t){let{media:n}=t;if(n&&!(e&&n.remote?.state!==`disconnected`)&&!(!e&&n.remote?.state!==`connected`)){if(typeof n.remote.prompt!=`function`){console.warn(`MediaChrome: Casting is not supported in this environment`);return}n.remote.prompt().catch(()=>{})}},remoteEvents:[`connect`,`connecting`,`disconnect`]},mediaIsAirplaying:{get(){return!1},set(e,t){let{media:n}=t;if(n){if(!(n.webkitShowPlaybackTargetPicker&&N.WebKitPlaybackTargetAvailabilityEvent)){console.error(`MediaChrome: received a request to select AirPlay but AirPlay is not supported in this environment`);return}n.webkitShowPlaybackTargetPicker()}},mediaEvents:[`webkitcurrentplaybacktargetiswirelesschanged`]},mediaFullscreenUnavailable:{get(e){let{media:t}=e;if(!Fl||!Pl(t))return ds.UNSUPPORTED}},mediaPipUnavailable:{get(e){let{media:t}=e;if(!Il||!Nl(t))return ds.UNSUPPORTED;if(t?.disablePictureInPicture)return ds.UNAVAILABLE}},mediaVolumeUnavailable:{get(e){let{media:t}=e;if(Gl===!1||t?.volume==null)return ds.UNSUPPORTED},stateOwnersUpdateHandlers:[e=>{Gl??Kl.then(t=>e(t?void 0:ds.UNSUPPORTED))}]},mediaCastUnavailable:{get(e,{availability:t=`not-available`}={}){let{media:n}=e;if(!Rl||!n?.remote?.state)return ds.UNSUPPORTED;if(!(t==null||t===`available`))return ds.UNAVAILABLE},stateOwnersUpdateHandlers:[(e,t)=>{var n;let{media:r}=t;if(r)return r.disableRemotePlayback||r.hasAttribute(`disableremoteplayback`)||(n=r?.remote)==null||n.watchAvailability(t=>{e({availability:t?`available`:`not-available`})}).catch(t=>{t.name===`NotSupportedError`?e({availability:null}):e({availability:`not-available`})}),()=>{var e;(e=r?.remote)==null||e.cancelWatchAvailability().catch(()=>{})}}]},mediaAirplayUnavailable:{get(e,t){if(!Ll)return ds.UNSUPPORTED;if(t?.availability===`not-available`)return ds.UNAVAILABLE},mediaEvents:[`webkitplaybacktargetavailabilitychanged`],stateOwnersUpdateHandlers:[(e,t)=>{var n;let{media:r}=t;if(r)return r.disableRemotePlayback||r.hasAttribute(`disableremoteplayback`)||(n=r?.remote)==null||n.watchAvailability(t=>{e({availability:t?`available`:`not-available`})}).catch(t=>{t.name===`NotSupportedError`?e({availability:null}):e({availability:`not-available`})}),()=>{var e;(e=r?.remote)==null||e.cancelWatchAvailability().catch(()=>{})}}]},mediaRenditionUnavailable:{get(e){let{media:t}=e;if(!t?.videoRenditions)return ds.UNSUPPORTED;if(!t.videoRenditions?.length)return ds.UNAVAILABLE},mediaEvents:[`emptied`,`loadstart`],videoRenditionsEvents:[`addrendition`,`removerendition`]},mediaAudioTrackUnavailable:{get(e){let{media:t}=e;if(!t?.audioTracks)return ds.UNSUPPORTED;if((t.audioTracks?.length??0)<=1)return ds.UNAVAILABLE},mediaEvents:[`emptied`,`loadstart`],audioTracksEvents:[`addtrack`,`removetrack`]},mediaLang:{get(e){let{options:{mediaLang:t}={}}=e;return t??`en`}}},Zl={[k.MEDIA_PREVIEW_REQUEST](e,t,{detail:n}){let{media:r}=t,i=n??void 0,a,o;if(r&&i!=null){let[e]=_l(r,{kind:cs.METADATA,label:`thumbnails`}),t=Array.prototype.find.call(e?.cues??[],(e,t,n)=>t===0?e.endTime>i:t===n.length-1?e.startTime<=i:e.startTime<=i&&e.endTime>i);if(t){let e=/'^(?:[a-z]+:)?\/\//i.test(t.text)?void 0:r?.querySelector(`track[label="thumbnails"]`)?.src,n=new URL(t.text,e);o=new URLSearchParams(n.hash).get(`#xywh`).split(`,`).map(e=>+e),a=n.href}}let s=e.mediaDuration.get(t),c=e.mediaChaptersCues.get(t).find((e,t,n)=>t===n.length-1&&s===e.endTime?e.startTime<=i&&e.endTime>=i:e.startTime<=i&&e.endTime>i)?.text;return n!=null&&c==null&&(c=``),{mediaPreviewTime:i,mediaPreviewImage:a,mediaPreviewCoords:o,mediaPreviewChapter:c}},[k.MEDIA_PAUSE_REQUEST](e,t){e.mediaPaused.set(!0,t)},[k.MEDIA_PLAY_REQUEST](e,t){let n=e.mediaStreamType.get(t)===fs.LIVE,r=!t.options?.noAutoSeekToLive,i=e.mediaTargetLiveWindow.get(t)>0;if(n&&r&&!i){let n=e.mediaSeekable.get(t)?.[1];if(n){let r=n-(t.options?.seekToLiveOffset??0);e.mediaCurrentTime.set(r,t)}}e.mediaPaused.set(!1,t)},[k.MEDIA_PLAYBACK_RATE_REQUEST](e,t,{detail:n}){let r=n;e.mediaPlaybackRate.set(r,t)},[k.MEDIA_MUTE_REQUEST](e,t){e.mediaMuted.set(!0,t)},[k.MEDIA_UNMUTE_REQUEST](e,t){e.mediaVolume.get(t)||e.mediaVolume.set(.25,t),e.mediaMuted.set(!1,t)},[k.MEDIA_LOOP_REQUEST](e,t,{detail:n}){let r=!!n;return e.mediaLoop.set(r,t),{mediaLoop:r}},[k.MEDIA_VOLUME_REQUEST](e,t,{detail:n}){let r=n;r&&e.mediaMuted.get(t)&&e.mediaMuted.set(!1,t),e.mediaVolume.set(r,t)},[k.MEDIA_SEEK_REQUEST](e,t,{detail:n}){let r=n;e.mediaCurrentTime.set(r,t)},[k.MEDIA_SEEK_TO_LIVE_REQUEST](e,t){let n=e.mediaSeekable.get(t)?.[1];if(Number.isNaN(Number(n)))return;let r=n-(t.options?.seekToLiveOffset??0);e.mediaCurrentTime.set(r,t)},[k.MEDIA_SHOW_SUBTITLES_REQUEST](e,t,{detail:n}){let{options:r}=t,i=zl(t),a=dl(n),o=a[0]?.language;o&&!r.noSubtitlesLangPref&&N.localStorage.setItem(`media-chrome-pref-subtitles-lang`,o),gl(ls.SHOWING,i,a)},[k.MEDIA_DISABLE_SUBTITLES_REQUEST](e,t,{detail:n}){let r=zl(t),i=n??[];gl(ls.DISABLED,r,i)},[k.MEDIA_TOGGLE_SUBTITLES_REQUEST](e,t,{detail:n}){Vl(t,n)},[k.MEDIA_RENDITION_REQUEST](e,t,{detail:n}){let r=n;e.mediaRenditionSelected.set(r,t)},[k.MEDIA_AUDIO_TRACK_REQUEST](e,t,{detail:n}){let r=n;e.mediaAudioTrackEnabled.set(r,t)},[k.MEDIA_ENTER_PIP_REQUEST](e,t){e.mediaIsFullscreen.get(t)&&e.mediaIsFullscreen.set(!1,t),e.mediaIsPip.set(!0,t)},[k.MEDIA_EXIT_PIP_REQUEST](e,t){e.mediaIsPip.set(!1,t)},[k.MEDIA_ENTER_FULLSCREEN_REQUEST](e,t,n){e.mediaIsPip.get(t)&&e.mediaIsPip.set(!1,t),e.mediaIsFullscreen.set(!0,t,n)},[k.MEDIA_EXIT_FULLSCREEN_REQUEST](e,t){e.mediaIsFullscreen.set(!1,t)},[k.MEDIA_ENTER_CAST_REQUEST](e,t){e.mediaIsFullscreen.get(t)&&e.mediaIsFullscreen.set(!1,t),e.mediaIsCasting.set(!0,t)},[k.MEDIA_EXIT_CAST_REQUEST](e,t){e.mediaIsCasting.set(!1,t)},[k.MEDIA_AIRPLAY_REQUEST](e,t){e.mediaIsAirplaying.set(!0,t)}},Ql=({media:e,fullscreenElement:t,documentElement:n,stateMediator:r=Xl,requestMap:i=Zl,options:a={},monitorStateOwnersOnlyWithSubscriptions:o=!0})=>{let s=[],c={options:{...a}},l=Object.freeze({mediaPreviewTime:void 0,mediaPreviewImage:void 0,mediaPreviewCoords:void 0,mediaPreviewChapter:void 0}),u=e=>{e!=null&&(Hl(e,l)||(l=Object.freeze({...l,...e}),s.forEach(e=>e(l))))},d=()=>{u(Object.entries(r).reduce((e,[t,{get:n}])=>(e[t]=n(c),e),{}))},f={},p,m=async(e,t)=>{let n=!!p;if(p={...c,...p??{},...e},n)return;await ql(...Object.values(e));let i=s.length>0&&t===0&&o,a=c.media!==p.media,l=c.media?.textTracks!==p.media?.textTracks,m=c.media?.videoRenditions!==p.media?.videoRenditions,h=c.media?.audioTracks!==p.media?.audioTracks,g=c.media?.remote!==p.media?.remote,_=c.documentElement!==p.documentElement,ee=!!c.media&&(a||i),te=!!c.media?.textTracks&&(l||i),ne=!!c.media?.videoRenditions&&(m||i),re=!!c.media?.audioTracks&&(h||i),ie=!!c.media?.remote&&(g||i),ae=!!c.documentElement&&(_||i),oe=ee||te||ne||re||ie||ae,se=s.length===0&&t===1&&o,ce=!!p.media&&(a||se),le=!!p.media?.textTracks&&(l||se),ue=!!p.media?.videoRenditions&&(m||se),de=!!p.media?.audioTracks&&(h||se),fe=!!p.media?.remote&&(g||se),pe=!!p.documentElement&&(_||se),me=ce||le||ue||de||fe||pe;if(!(oe||me)){Object.entries(p).forEach(([e,t])=>{c[e]=t}),d(),p=void 0;return}Object.entries(r).forEach(([e,{get:t,mediaEvents:n=[],textTracksEvents:r=[],videoRenditionsEvents:i=[],audioTracksEvents:a=[],remoteEvents:o=[],rootEvents:s=[],stateOwnersUpdateHandlers:l=[]}])=>{f[e]||(f[e]={});let d=n=>{let r=t(c,n);u({[e]:r})},m;m=f[e].mediaEvents,n.forEach(t=>{m&&ee&&(c.media.removeEventListener(t,m),f[e].mediaEvents=void 0),ce&&(p.media.addEventListener(t,d),f[e].mediaEvents=d)}),m=f[e].textTracksEvents,r.forEach(t=>{var n,r;m&&te&&((n=c.media.textTracks)==null||n.removeEventListener(t,m),f[e].textTracksEvents=void 0),le&&((r=p.media.textTracks)==null||r.addEventListener(t,d),f[e].textTracksEvents=d)}),m=f[e].videoRenditionsEvents,i.forEach(t=>{var n,r;m&&ne&&((n=c.media.videoRenditions)==null||n.removeEventListener(t,m),f[e].videoRenditionsEvents=void 0),ue&&((r=p.media.videoRenditions)==null||r.addEventListener(t,d),f[e].videoRenditionsEvents=d)}),m=f[e].audioTracksEvents,a.forEach(t=>{var n,r;m&&re&&((n=c.media.audioTracks)==null||n.removeEventListener(t,m),f[e].audioTracksEvents=void 0),de&&((r=p.media.audioTracks)==null||r.addEventListener(t,d),f[e].audioTracksEvents=d)}),m=f[e].remoteEvents,o.forEach(t=>{var n,r;m&&ie&&((n=c.media.remote)==null||n.removeEventListener(t,m),f[e].remoteEvents=void 0),fe&&((r=p.media.remote)==null||r.addEventListener(t,d),f[e].remoteEvents=d)}),m=f[e].rootEvents,s.forEach(t=>{m&&ae&&(c.documentElement.removeEventListener(t,m),f[e].rootEvents=void 0),pe&&(p.documentElement.addEventListener(t,d),f[e].rootEvents=d)});let h=f[e].stateOwnersUpdateHandlers;if(h&&oe&&(Array.isArray(h)?h:[h]).forEach(e=>{typeof e==`function`&&e()}),me){let t=l.map(e=>e(d,p)).filter(e=>typeof e==`function`);f[e].stateOwnersUpdateHandlers=t.length===1?t[0]:t}else oe&&(f[e].stateOwnersUpdateHandlers=void 0)}),Object.entries(p).forEach(([e,t])=>{c[e]=t}),d(),p=void 0};return m({media:e,fullscreenElement:t,documentElement:n,options:a}),{dispatch(e){let{type:t,detail:n}=e;if(i[t]&&l.mediaErrorCode==null){u(i[t](r,c,e));return}t===`mediaelementchangerequest`?m({media:n}):t===`fullscreenelementchangerequest`?m({fullscreenElement:n}):t===`documentelementchangerequest`?m({documentElement:n}):t===`optionschangerequest`&&(Object.entries(n??{}).forEach(([e,t])=>{c.options[e]=t}),d())},getState(){return l},subscribe(e){return m({},s.length+1),s.push(e),e(l),()=>{let t=s.indexOf(e);t>=0&&(m({},s.length-1),s.splice(t,1))}}}},$l=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},V=(e,t,n)=>($l(e,t,`read from private field`),n?n.call(e):t.get(e)),eu=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},tu=(e,t,n,r)=>($l(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),nu=(e,t,n)=>($l(e,t,`access private method`),n),ru,iu,H,au,ou,su,cu,lu,uu,du,fu,pu,mu,hu,gu,_u=[`ArrowLeft`,`ArrowRight`,`ArrowUp`,`ArrowDown`,`Enter`,` `,`f`,`m`,`k`,`c`,`l`,`j`,`>`,`<`,`p`],vu=10,yu=.025,bu=.25,xu=.25,Su=2,U={DEFAULT_SUBTITLES:`defaultsubtitles`,DEFAULT_STREAM_TYPE:`defaultstreamtype`,DEFAULT_DURATION:`defaultduration`,FULLSCREEN_ELEMENT:`fullscreenelement`,HOTKEYS:`hotkeys`,KEYBOARD_BACKWARD_SEEK_OFFSET:`keyboardbackwardseekoffset`,KEYBOARD_FORWARD_SEEK_OFFSET:`keyboardforwardseekoffset`,KEYBOARD_DOWN_VOLUME_STEP:`keyboarddownvolumestep`,KEYBOARD_UP_VOLUME_STEP:`keyboardupvolumestep`,KEYS_USED:`keysused`,LANG:`lang`,LOOP:`loop`,LIVE_EDGE_OFFSET:`liveedgeoffset`,NO_AUTO_SEEK_TO_LIVE:`noautoseektolive`,NO_DEFAULT_STORE:`nodefaultstore`,NO_HOTKEYS:`nohotkeys`,NO_MUTED_PREF:`nomutedpref`,NO_SUBTITLES_LANG_PREF:`nosubtitleslangpref`,NO_VOLUME_PREF:`novolumepref`,SEEK_TO_LIVE_OFFSET:`seektoliveoffset`},Cu=class extends Xc{constructor(){super(),eu(this,uu),eu(this,pu),eu(this,hu),this.mediaStateReceivers=[],this.associatedElementSubscriptions=new Map,eu(this,ru,new sl(this,U.HOTKEYS)),eu(this,iu,void 0),eu(this,H,void 0),eu(this,au,null),eu(this,ou,void 0),eu(this,su,void 0),eu(this,cu,e=>{var t;(t=V(this,H))==null||t.dispatch(e)}),eu(this,lu,void 0),eu(this,fu,e=>{let{key:t,shiftKey:n}=e;if(!(n&&(t===`/`||t===`?`)||_u.includes(t))){this.removeEventListener(`keyup`,V(this,fu));return}this.keyboardShortcutHandler(e)}),this.associateElement(this);let e={};tu(this,ou,t=>{Object.entries(t).forEach(([t,n])=>{if(t in e&&e[t]===n)return;this.propagateMediaState(t,n);let r=t.toLowerCase(),i=new N.CustomEvent(ss[r],{composed:!0,detail:n});this.dispatchEvent(i)}),e=t})}static get observedAttributes(){return super.observedAttributes.concat(U.NO_HOTKEYS,U.HOTKEYS,U.DEFAULT_STREAM_TYPE,U.DEFAULT_SUBTITLES,U.DEFAULT_DURATION,U.NO_MUTED_PREF,U.NO_VOLUME_PREF,U.LANG,U.LOOP,U.LIVE_EDGE_OFFSET,U.SEEK_TO_LIVE_OFFSET,U.NO_AUTO_SEEK_TO_LIVE)}get mediaStore(){return V(this,H)}set mediaStore(e){var t;if(V(this,H)&&((t=V(this,su))==null||t.call(this),tu(this,su,void 0)),tu(this,H,e),!V(this,H)&&!this.hasAttribute(U.NO_DEFAULT_STORE)){nu(this,uu,du).call(this);return}tu(this,su,V(this,H)?.subscribe(V(this,ou)))}get fullscreenElement(){return V(this,iu)??this}set fullscreenElement(e){var t;this.hasAttribute(U.FULLSCREEN_ELEMENT)&&this.removeAttribute(U.FULLSCREEN_ELEMENT),tu(this,iu,e),(t=V(this,H))==null||t.dispatch({type:`fullscreenelementchangerequest`,detail:this.fullscreenElement})}get defaultSubtitles(){return I(this,U.DEFAULT_SUBTITLES)}set defaultSubtitles(e){L(this,U.DEFAULT_SUBTITLES,e)}get defaultStreamType(){return R(this,U.DEFAULT_STREAM_TYPE)}set defaultStreamType(e){z(this,U.DEFAULT_STREAM_TYPE,e)}get defaultDuration(){return P(this,U.DEFAULT_DURATION)}set defaultDuration(e){F(this,U.DEFAULT_DURATION,e)}get noHotkeys(){return I(this,U.NO_HOTKEYS)}set noHotkeys(e){L(this,U.NO_HOTKEYS,e)}get keysUsed(){return R(this,U.KEYS_USED)}set keysUsed(e){z(this,U.KEYS_USED,e)}get liveEdgeOffset(){return P(this,U.LIVE_EDGE_OFFSET)}set liveEdgeOffset(e){F(this,U.LIVE_EDGE_OFFSET,e)}get noAutoSeekToLive(){return I(this,U.NO_AUTO_SEEK_TO_LIVE)}set noAutoSeekToLive(e){L(this,U.NO_AUTO_SEEK_TO_LIVE,e)}get noVolumePref(){return I(this,U.NO_VOLUME_PREF)}set noVolumePref(e){L(this,U.NO_VOLUME_PREF,e)}get noMutedPref(){return I(this,U.NO_MUTED_PREF)}set noMutedPref(e){L(this,U.NO_MUTED_PREF,e)}get noSubtitlesLangPref(){return I(this,U.NO_SUBTITLES_LANG_PREF)}set noSubtitlesLangPref(e){L(this,U.NO_SUBTITLES_LANG_PREF,e)}get noDefaultStore(){return I(this,U.NO_DEFAULT_STORE)}set noDefaultStore(e){L(this,U.NO_DEFAULT_STORE,e)}attributeChangedCallback(e,t,n){var r,i,a,o,s,c,l,u,d,f;if(super.attributeChangedCallback(e,t,n),e===U.NO_HOTKEYS)n!==t&&n===``?(this.hasAttribute(U.HOTKEYS)&&console.warn("Media Chrome: Both `hotkeys` and `nohotkeys` have been set. All hotkeys will be disabled."),this.disableHotkeys()):n!==t&&n===null&&this.enableHotkeys();else if(e===U.HOTKEYS)V(this,ru).value=n;else if(e===U.DEFAULT_SUBTITLES&&n!==t)(r=V(this,H))==null||r.dispatch({type:`optionschangerequest`,detail:{defaultSubtitles:this.hasAttribute(U.DEFAULT_SUBTITLES)}});else if(e===U.DEFAULT_STREAM_TYPE)(i=V(this,H))==null||i.dispatch({type:`optionschangerequest`,detail:{defaultStreamType:this.getAttribute(U.DEFAULT_STREAM_TYPE)??void 0}});else if(e===U.LIVE_EDGE_OFFSET&&n!==t)(a=V(this,H))==null||a.dispatch({type:`optionschangerequest`,detail:{liveEdgeOffset:this.hasAttribute(U.LIVE_EDGE_OFFSET)?+this.getAttribute(U.LIVE_EDGE_OFFSET):void 0,seekToLiveOffset:this.hasAttribute(U.SEEK_TO_LIVE_OFFSET)?+this.getAttribute(U.SEEK_TO_LIVE_OFFSET):this.hasAttribute(U.LIVE_EDGE_OFFSET)?+this.getAttribute(U.LIVE_EDGE_OFFSET):void 0}});else if(e===U.SEEK_TO_LIVE_OFFSET&&n!==t)(o=V(this,H))==null||o.dispatch({type:`optionschangerequest`,detail:{seekToLiveOffset:this.hasAttribute(U.SEEK_TO_LIVE_OFFSET)?+this.getAttribute(U.SEEK_TO_LIVE_OFFSET):this.hasAttribute(U.LIVE_EDGE_OFFSET)?+this.getAttribute(U.LIVE_EDGE_OFFSET):void 0}});else if(e===U.NO_AUTO_SEEK_TO_LIVE)(s=V(this,H))==null||s.dispatch({type:`optionschangerequest`,detail:{noAutoSeekToLive:this.hasAttribute(U.NO_AUTO_SEEK_TO_LIVE)}});else if(e===U.FULLSCREEN_ELEMENT){let e=n?this.getRootNode()?.getElementById(n):void 0;tu(this,iu,e),(c=V(this,H))==null||c.dispatch({type:`fullscreenelementchangerequest`,detail:this.fullscreenElement})}else e===U.LANG&&n!==t?(Os(n),(l=V(this,H))==null||l.dispatch({type:`optionschangerequest`,detail:{mediaLang:n}})):e===U.LOOP&&n!==t?(u=V(this,H))==null||u.dispatch({type:k.MEDIA_LOOP_REQUEST,detail:n!=null}):e===U.NO_VOLUME_PREF&&n!==t?(d=V(this,H))==null||d.dispatch({type:`optionschangerequest`,detail:{noVolumePref:this.hasAttribute(U.NO_VOLUME_PREF)}}):e===U.NO_MUTED_PREF&&n!==t&&((f=V(this,H))==null||f.dispatch({type:`optionschangerequest`,detail:{noMutedPref:this.hasAttribute(U.NO_MUTED_PREF)}}))}connectedCallback(){var e,t;this.associateElement(this),!V(this,H)&&!this.hasAttribute(U.NO_DEFAULT_STORE)&&nu(this,uu,du).call(this),(e=V(this,H))==null||e.dispatch({type:`documentelementchangerequest`,detail:Hs}),(t=V(this,H))==null||t.dispatch({type:`fullscreenelementchangerequest`,detail:this.fullscreenElement}),super.connectedCallback(),V(this,H)&&!V(this,su)&&tu(this,su,V(this,H)?.subscribe(V(this,ou))),V(this,lu)!==void 0&&V(this,H)&&this.media&&setTimeout(()=>{var e;this.media?.textTracks?.length&&((e=V(this,H))==null||e.dispatch({type:k.MEDIA_TOGGLE_SUBTITLES_REQUEST,detail:V(this,lu)}))},0),this.hasAttribute(U.NO_HOTKEYS)?this.disableHotkeys():this.enableHotkeys()}disconnectedCallback(){var e,t,n,r,i;if((e=super.disconnectedCallback)==null||e.call(this),this.disableHotkeys(),V(this,H)){let e=V(this,H).getState();tu(this,lu,!!e.mediaSubtitlesShowing?.length),(t=V(this,H))==null||t.dispatch({type:`fullscreenelementchangerequest`,detail:void 0}),(n=V(this,H))==null||n.dispatch({type:`documentelementchangerequest`,detail:void 0}),(r=V(this,H))==null||r.dispatch({type:k.MEDIA_TOGGLE_SUBTITLES_REQUEST,detail:!1})}V(this,su)&&((i=V(this,su))==null||i.call(this),tu(this,su,void 0)),this.unassociateElement(this),V(this,au)&&(V(this,au).remove(),tu(this,au,null))}mediaSetCallback(e){var t;super.mediaSetCallback(e),(t=V(this,H))==null||t.dispatch({type:`mediaelementchangerequest`,detail:e}),e.hasAttribute(`tabindex`)||(e.tabIndex=-1)}mediaUnsetCallback(e){var t;super.mediaUnsetCallback(e),(t=V(this,H))==null||t.dispatch({type:`mediaelementchangerequest`,detail:void 0})}propagateMediaState(e,t){Pu(this.mediaStateReceivers,e,t)}associateElement(e){if(!e)return;let{associatedElementSubscriptions:t}=this;if(t.has(e))return;let n=Fu(e,this.registerMediaStateReceiver.bind(this),this.unregisterMediaStateReceiver.bind(this));Object.values(k).forEach(t=>{e.addEventListener(t,V(this,cu))}),t.set(e,n)}unassociateElement(e){if(!e)return;let{associatedElementSubscriptions:t}=this;t.has(e)&&(t.get(e)(),t.delete(e),Object.values(k).forEach(t=>{e.removeEventListener(t,V(this,cu))}))}registerMediaStateReceiver(e){if(!e)return;let t=this.mediaStateReceivers;t.indexOf(e)>-1||(t.push(e),V(this,H)&&Object.entries(V(this,H).getState()).forEach(([t,n])=>{Pu([e],t,n)}))}unregisterMediaStateReceiver(e){let t=this.mediaStateReceivers,n=t.indexOf(e);n<0||t.splice(n,1)}enableHotkeys(){this.addEventListener(`keydown`,nu(this,pu,mu))}disableHotkeys(){this.removeEventListener(`keydown`,nu(this,pu,mu)),this.removeEventListener(`keyup`,V(this,fu))}get hotkeys(){return V(this,ru)}set hotkeys(e){z(this,U.HOTKEYS,e)}keyboardShortcutHandler(e){let t=e.target;if((t.getAttribute(U.KEYS_USED)?.split(` `)??t?.keysUsed??[]).map(e=>e===`Space`?` `:e).filter(Boolean).includes(e.key))return;let n,r,i;if(!V(this,ru).contains(`no${e.key.toLowerCase()}`)&&!(e.key===` `&&V(this,ru).contains(`nospace`))&&!(e.shiftKey&&(e.key===`/`||e.key===`?`)&&V(this,ru).contains(`noshift+/`)))switch(e.key){case` `:case`k`:n=V(this,H).getState().mediaPaused?k.MEDIA_PLAY_REQUEST:k.MEDIA_PAUSE_REQUEST,this.dispatchEvent(new N.CustomEvent(n,{composed:!0,bubbles:!0}));break;case`m`:n=this.mediaStore.getState().mediaVolumeLevel===`off`?k.MEDIA_UNMUTE_REQUEST:k.MEDIA_MUTE_REQUEST,this.dispatchEvent(new N.CustomEvent(n,{composed:!0,bubbles:!0}));break;case`f`:n=this.mediaStore.getState().mediaIsFullscreen?k.MEDIA_EXIT_FULLSCREEN_REQUEST:k.MEDIA_ENTER_FULLSCREEN_REQUEST,this.dispatchEvent(new N.CustomEvent(n,{composed:!0,bubbles:!0}));break;case`c`:this.dispatchEvent(new N.CustomEvent(k.MEDIA_TOGGLE_SUBTITLES_REQUEST,{composed:!0,bubbles:!0}));break;case`ArrowLeft`:case`j`:{let e=this.hasAttribute(U.KEYBOARD_BACKWARD_SEEK_OFFSET)?+this.getAttribute(U.KEYBOARD_BACKWARD_SEEK_OFFSET):vu;r=Math.max((this.mediaStore.getState().mediaCurrentTime??0)-e,0),i=new N.CustomEvent(k.MEDIA_SEEK_REQUEST,{composed:!0,bubbles:!0,detail:r}),this.dispatchEvent(i);break}case`ArrowRight`:case`l`:{let e=this.hasAttribute(U.KEYBOARD_FORWARD_SEEK_OFFSET)?+this.getAttribute(U.KEYBOARD_FORWARD_SEEK_OFFSET):vu;r=Math.max((this.mediaStore.getState().mediaCurrentTime??0)+e,0),i=new N.CustomEvent(k.MEDIA_SEEK_REQUEST,{composed:!0,bubbles:!0,detail:r}),this.dispatchEvent(i);break}case`ArrowUp`:{let e=this.hasAttribute(U.KEYBOARD_UP_VOLUME_STEP)?+this.getAttribute(U.KEYBOARD_UP_VOLUME_STEP):yu;r=Math.min((this.mediaStore.getState().mediaVolume??1)+e,1),i=new N.CustomEvent(k.MEDIA_VOLUME_REQUEST,{composed:!0,bubbles:!0,detail:r}),this.dispatchEvent(i);break}case`ArrowDown`:{let e=this.hasAttribute(U.KEYBOARD_DOWN_VOLUME_STEP)?+this.getAttribute(U.KEYBOARD_DOWN_VOLUME_STEP):yu;r=Math.max((this.mediaStore.getState().mediaVolume??1)-e,0),i=new N.CustomEvent(k.MEDIA_VOLUME_REQUEST,{composed:!0,bubbles:!0,detail:r}),this.dispatchEvent(i);break}case`<`:{let e=this.mediaStore.getState().mediaPlaybackRate??1;r=Math.max(e-bu,xu).toFixed(2),i=new N.CustomEvent(k.MEDIA_PLAYBACK_RATE_REQUEST,{composed:!0,bubbles:!0,detail:r}),this.dispatchEvent(i);break}case`>`:{let e=this.mediaStore.getState().mediaPlaybackRate??1;r=Math.min(e+bu,Su).toFixed(2),i=new N.CustomEvent(k.MEDIA_PLAYBACK_RATE_REQUEST,{composed:!0,bubbles:!0,detail:r}),this.dispatchEvent(i);break}case`/`:case`?`:e.shiftKey&&nu(this,hu,gu).call(this);break;case`p`:n=this.mediaStore.getState().mediaIsPip?k.MEDIA_EXIT_PIP_REQUEST:k.MEDIA_ENTER_PIP_REQUEST,i=new N.CustomEvent(n,{composed:!0,bubbles:!0}),this.dispatchEvent(i);break;default:break}}};ru=new WeakMap,iu=new WeakMap,H=new WeakMap,au=new WeakMap,ou=new WeakMap,su=new WeakMap,cu=new WeakMap,lu=new WeakMap,uu=new WeakSet,du=function(){this.mediaStore=Ql({media:this.media,fullscreenElement:this.fullscreenElement,options:{defaultSubtitles:this.hasAttribute(U.DEFAULT_SUBTITLES),defaultDuration:this.hasAttribute(U.DEFAULT_DURATION)?+this.getAttribute(U.DEFAULT_DURATION):void 0,defaultStreamType:this.getAttribute(U.DEFAULT_STREAM_TYPE)??void 0,liveEdgeOffset:this.hasAttribute(U.LIVE_EDGE_OFFSET)?+this.getAttribute(U.LIVE_EDGE_OFFSET):void 0,seekToLiveOffset:this.hasAttribute(U.SEEK_TO_LIVE_OFFSET)?+this.getAttribute(U.SEEK_TO_LIVE_OFFSET):this.hasAttribute(U.LIVE_EDGE_OFFSET)?+this.getAttribute(U.LIVE_EDGE_OFFSET):void 0,noAutoSeekToLive:this.hasAttribute(U.NO_AUTO_SEEK_TO_LIVE),noVolumePref:this.hasAttribute(U.NO_VOLUME_PREF),noMutedPref:this.hasAttribute(U.NO_MUTED_PREF),noSubtitlesLangPref:this.hasAttribute(U.NO_SUBTITLES_LANG_PREF)}})},fu=new WeakMap,pu=new WeakSet,mu=function(e){let{metaKey:t,altKey:n,key:r,shiftKey:i}=e,a=i&&(r===`/`||r===`?`);if(a&&V(this,au)?.open){this.removeEventListener(`keyup`,V(this,fu));return}if(t||n||!a&&!_u.includes(r)){this.removeEventListener(`keyup`,V(this,fu));return}let o=e.target,s=o instanceof HTMLElement&&(o.tagName.toLowerCase()===`media-volume-range`||o.tagName.toLowerCase()===`media-time-range`);[` `,`ArrowLeft`,`ArrowRight`,`ArrowUp`,`ArrowDown`].includes(r)&&!(V(this,ru).contains(`no${r.toLowerCase()}`)||r===` `&&V(this,ru).contains(`nospace`))&&!s&&e.preventDefault(),this.addEventListener(`keyup`,V(this,fu),{once:!0})},hu=new WeakSet,gu=function(){V(this,au)||(tu(this,au,Hs.createElement(`media-keyboard-shortcuts-dialog`)),this.appendChild(V(this,au))),V(this,au).open=!0};var wu=Object.values(j),Tu=Object.values(is),Eu=e=>{var t;let{observedAttributes:n}=e.constructor;!n&&e.nodeName?.includes(`-`)&&(N.customElements.upgrade(e),{observedAttributes:n}=e.constructor);let r=((t=(e?.getAttribute)?.call(e,A.MEDIA_CHROME_ATTRIBUTES))?.split)?.call(t,/\s+/);return Array.isArray(n||r)?(n||r).filter(e=>wu.includes(e)):[]},Du=e=>(e.nodeName?.includes(`-`)&&N.customElements.get(e.nodeName?.toLowerCase())&&!(e instanceof N.customElements.get(e.nodeName.toLowerCase()))&&N.customElements.upgrade(e),Tu.some(t=>t in e)),Ou=e=>Du(e)||!!Eu(e).length,ku=e=>(e?.join)?.call(e,`:`),Au={[j.MEDIA_SUBTITLES_LIST]:pl,[j.MEDIA_SUBTITLES_SHOWING]:pl,[j.MEDIA_SEEKABLE]:ku,[j.MEDIA_BUFFERED]:e=>e?.map(ku).join(` `),[j.MEDIA_PREVIEW_COORDS]:e=>e?.join(` `),[j.MEDIA_RENDITION_LIST]:ms,[j.MEDIA_AUDIO_TRACK_LIST]:vs},ju=async(e,t,n)=>{if(e.isConnected||await Ts(0),typeof n==`boolean`||n==null)return L(e,t,n);if(typeof n==`number`)return F(e,t,n);if(typeof n==`string`)return z(e,t,n);if(Array.isArray(n)&&!n.length)return e.removeAttribute(t);let r=Au[t]?.call(Au,n)??n;return e.setAttribute(t,r)},Mu=e=>!!e.closest?.call(e,`*[slot="media"]`),Nu=(e,t)=>{if(Mu(e))return;let n=(e,t)=>{Ou(e)&&t(e);let{children:n=[]}=e??{},r=e?.shadowRoot?.children??[];[...n,...r].forEach(e=>Nu(e,t))},r=e?.nodeName.toLowerCase();if(r.includes(`-`)&&!Ou(e)){N.customElements.whenDefined(r).then(()=>{n(e,t)});return}n(e,t)},Pu=(e,t,n)=>{e.forEach(e=>{if(t in e){e[t]=n;return}let r=Eu(e),i=t.toLowerCase();r.includes(i)&&ju(e,i,n)})},Fu=(e,t,n)=>{Nu(e,t);let r=e=>{t(e?.composedPath()[0]??e.target)},i=e=>{n(e?.composedPath()[0]??e.target)};e.addEventListener(k.REGISTER_MEDIA_STATE_RECEIVER,r),e.addEventListener(k.UNREGISTER_MEDIA_STATE_RECEIVER,i);let a=e=>{e.forEach(e=>{let{addedNodes:r=[],removedNodes:i=[],type:a,target:o,attributeName:s}=e;a===`childList`?(Array.prototype.forEach.call(r,e=>Nu(e,t)),Array.prototype.forEach.call(i,e=>Nu(e,n))):a===`attributes`&&s===A.MEDIA_CHROME_ATTRIBUTES&&(Ou(o)?t(o):n(o))})},o=[],s=e=>{let r=e.target;r.name!==`media`&&(o.forEach(e=>Nu(e,n)),o=[...r.assignedElements({flatten:!0})],o.forEach(e=>Nu(e,t)))};e.addEventListener(`slotchange`,s);let c=new MutationObserver(a);return c.observe(e,{childList:!0,attributes:!0,subtree:!0}),()=>{Nu(e,n),e.removeEventListener(`slotchange`,s),c.disconnect(),e.removeEventListener(k.REGISTER_MEDIA_STATE_RECEIVER,r),e.removeEventListener(k.UNREGISTER_MEDIA_STATE_RECEIVER,i)}};N.customElements.get(`media-controller`)||N.customElements.define(`media-controller`,Cu);var Iu=Cu,Lu={PLACEMENT:`placement`,BOUNDS:`bounds`};function Ru(e){return`
    <style>
      :host {
    ...
    <slot></slot>
    <div id="arrow"></div>
  `}var zu=class extends N.HTMLElement{constructor(){if(super(),this.updateXOffset=()=>{if(!ic(this,{checkOpacity:!1,checkVisibilityCSS:!1}))return;let e=this.placement;if(e===`left`||e===`right`){this.style.removeProperty(`--media-tooltip-offset-x`);return}let t=getComputedStyle(this),n=tc(this,`#`+this.bounds)??Ys(this);if(!n)return;let{x:r,width:i}=n.getBoundingClientRect(),{x:a,width:o}=this.getBoundingClientRect(),s=a+o,c=r+i,l=t.getPropertyValue(`--media-tooltip-offset-x`),u=l?parseFloat(l.replace(`px`,``)):0,d=t.getPropertyValue(`--media-tooltip-container-margin`),f=d?parseFloat(d.replace(`px`,``)):0,p=a-r+u-f,m=s-c+u+f;if(p<0){this.style.setProperty(`--media-tooltip-offset-x`,`${p}px`);return}if(m>0){this.style.setProperty(`--media-tooltip-offset-x`,`${m}px`);return}this.style.removeProperty(`--media-tooltip-offset-x`)},!this.shadowRoot){this.attachShadow(this.constructor.shadowRootOptions);let e=Js(this.attributes);this.shadowRoot.innerHTML=this.constructor.getTemplateHTML(e)}if(this.arrowEl=this.shadowRoot.querySelector(`#arrow`),Object.prototype.hasOwnProperty.call(this,`placement`)){let e=this.placement;delete this.placement,this.placement=e}}static get observedAttributes(){return[Lu.PLACEMENT,Lu.BOUNDS]}get placement(){return R(this,Lu.PLACEMENT)}set placement(e){z(this,Lu.PLACEMENT,e)}get bounds(){return R(this,Lu.BOUNDS)}set bounds(e){z(this,Lu.BOUNDS,e)}};zu.shadowRootOptions={mode:`open`},zu.getTemplateHTML=Ru,N.customElements.get(`media-tooltip`)||N.customElements.define(`media-tooltip`,zu);var Bu=zu,Vu=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},Hu=(e,t,n)=>(Vu(e,t,`read from private field`),n?n.call(e):t.get(e)),Uu=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},Wu=(e,t,n,r)=>(Vu(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),Gu=(e,t,n)=>(Vu(e,t,`access private method`),n),Ku,qu,Ju,Yu,Xu,Zu,Qu,$u={TOOLTIP_PLACEMENT:`tooltipplacement`,DISABLED:`disabled`,NO_TOOLTIP:`notooltip`};function ed(e,t={}){return`
    <style>
      :host {
        position: relative;
        font: var(--media-font,
    ...
    <slot name="tooltip">
      <media-tooltip part="tooltip" aria-hidden="true">
        <template shadowrootmode="${Bu.shadowRootOptions.mode}">
          ${Bu.getTemplateHTML({})}
        </template>
  ...
  `}function td(e,t){return`
    <slot></slot>
  `}function nd(){return``}var rd=class extends N.HTMLElement{constructor(){if(super(),Uu(this,Zu),Uu(this,Ku,void 0),this.preventClick=!1,this.tooltipEl=null,Uu(this,qu,e=>{this.preventClick||this.handleClick(e),setTimeout(Hu(this,Ju),0)}),Uu(this,Ju,()=>{var e,t;(t=(e=this.tooltipEl)?.updateXOffset)==null||t.call(e)}),Uu(this,Yu,e=>{let{key:t}=e;if(!this.keysUsed.includes(t)){this.removeEventListener(`keyup`,Hu(this,Yu));return}this.preventClick||this.handleClick(e)}),Uu(this,Xu,e=>{let{metaKey:t,altKey:n,key:r}=e;if(t||n||!this.keysUsed.includes(r)){this.removeEventListener(`keyup`,Hu(this,Yu));return}this.addEventListener(`keyup`,Hu(this,Yu),{once:!0})}),!this.shadowRoot){this.attachShadow(this.constructor.shadowRootOptions);let e=Js(this.attributes),t=this.constructor.getTemplateHTML(e);this.shadowRoot.setHTMLUnsafe?this.shadowRoot.setHTMLUnsafe(t):this.shadowRoot.innerHTML=t}this.tooltipEl=this.shadowRoot.querySelector(`media-tooltip`)}static get observedAttributes(){return[`disabled`,$u.TOOLTIP_PLACEMENT,A.MEDIA_CONTROLLER,j.MEDIA_LANG]}enable(){this.addEventListener(`click`,Hu(this,qu)),this.addEventListener(`keydown`,Hu(this,Xu)),this.tabIndex=0}disable(){this.removeEventListener(`click`,Hu(this,qu)),this.removeEventListener(`keydown`,Hu(this,Xu)),this.removeEventListener(`keyup`,Hu(this,Yu)),this.tabIndex=-1}attributeChangedCallback(e,t,n){var r,i,a,o;e===A.MEDIA_CONTROLLER?(t&&((i=(r=Hu(this,Ku))?.unassociateElement)==null||i.call(r,this),Wu(this,Ku,null)),n&&this.isConnected&&(Wu(this,Ku,this.getRootNode()?.getElementById(n)),(o=(a=Hu(this,Ku))?.associateElement)==null||o.call(a,this))):e===`disabled`&&n!==t?n==null?this.enable():this.disable():e===$u.TOOLTIP_PLACEMENT&&this.tooltipEl&&n!==t?this.tooltipEl.placement=n:e===j.MEDIA_LANG&&(this.shadowRoot.querySelector(`slot[name="tooltip-content"]`).innerHTML=this.constructor.getTooltipContentHTML()),Hu(this,Ju).call(this)}connectedCallback(){var e,t;let{style:n}=oc(this.shadowRoot,`:host`);n.setProperty(`display`,`var(--media-control-display, var(--${this.localName}-display, inline-flex))`),this.hasAttribute(`disabled`)?this.disable():this.enable(),this.setAttribute(`role`,`button`);let r=this.getAttribute(A.MEDIA_CONTROLLER);r&&(Wu(this,Ku,this.getRootNode()?.getElementById(r)),(t=(e=Hu(this,Ku))?.associateElement)==null||t.call(e,this)),N.customElements.whenDefined(`media-tooltip`).then(()=>Gu(this,Zu,Qu).call(this))}disconnectedCallback(){var e,t;this.disable(),(t=(e=Hu(this,Ku))?.unassociateElement)==null||t.call(e,this),Wu(this,Ku,null),this.removeEventListener(`mouseenter`,Hu(this,Ju)),this.removeEventListener(`focus`,Hu(this,Ju)),this.removeEventListener(`click`,Hu(this,qu))}get keysUsed(){return[`Enter`,` `]}get tooltipPlacement(){return R(this,$u.TOOLTIP_PLACEMENT)}set tooltipPlacement(e){z(this,$u.TOOLTIP_PLACEMENT,e)}get mediaController(){return R(this,A.MEDIA_CONTROLLER)}set mediaController(e){z(this,A.MEDIA_CONTROLLER,e)}get disabled(){return I(this,$u.DISABLED)}set disabled(e){L(this,$u.DISABLED,e)}get noTooltip(){return I(this,$u.NO_TOOLTIP)}set noTooltip(e){L(this,$u.NO_TOOLTIP,e)}handleClick(e){}};Ku=new WeakMap,qu=new WeakMap,Ju=new WeakMap,Yu=new WeakMap,Xu=new WeakMap,Zu=new WeakSet,Qu=function(){this.addEventListener(`mouseenter`,Hu(this,Ju)),this.addEventListener(`focus`,Hu(this,Ju)),this.addEventListener(`click`,Hu(this,qu));let e=this.tooltipPlacement;e&&this.tooltipEl&&(this.tooltipEl.placement=e)},rd.shadowRootOptions={mode:`open`},rd.getTemplateHTML=ed,rd.getSlotTemplateHTML=td,rd.getTooltipContentHTML=nd,N.customElements.get(`media-chrome-button`)||N.customElements.define(`media-chrome-button`,rd);var id=`<svg aria-hidden="true" viewBox="0 0 26 24">
...
`;function ad(e){return`
  ...
  `}var sd=e=>{let t=e.mediaIsAirplaying?M(`stop airplay`):M(`start airplay`);e.setAttribute(`aria-label`,t)},cd=class extends rd{static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_IS_AIRPLAYING,j.MEDIA_AIRPLAY_UNAVAILABLE]}connectedCallback(){super.connectedCallback(),sd(this)}attributeChangedCallback(e,t,n){super.attributeChangedCallback(e,t,n),e===j.MEDIA_IS_AIRPLAYING&&sd(this)}get mediaIsAirplaying(){return I(this,j.MEDIA_IS_AIRPLAYING)}set mediaIsAirplaying(e){L(this,j.MEDIA_IS_AIRPLAYING,e)}get mediaAirplayUnavailable(){return R(this,j.MEDIA_AIRPLAY_UNAVAILABLE)}set mediaAirplayUnavailable(e){z(this,j.MEDIA_AIRPLAY_UNAVAILABLE,e)}handleClick(){let e=new N.CustomEvent(k.MEDIA_AIRPLAY_REQUEST,{composed:!0,bubbles:!0});this.dispatchEvent(e)}};cd.getSlotTemplateHTML=ad,cd.getTooltipContentHTML=od,N.customElements.get(`media-airplay-button`)||N.customElements.define(`media-airplay-button`,cd);var ld=`<svg aria-hidden="true" viewBox="0 0 26 24">
...
</svg>`,ud=`<svg aria-hidden="true" viewBox="0 0 26 24">
  <path d="M17.73 14.09a1.4 1.4 0 0 1-1 .37 1.579 1.579 0 0 1-1.27-.58A3 3 0 0 1 15 12a2.8 2.8 0 0 1 .5-1.85 1.63 1.63 0 0 1 1.29-.57 1.47 1.47 0 0 1 1.51 1.2l1.43-.34A2.89 2.89 0 0 0 19 9.07a3 3 0 0 0-2.14-.78 3.14 3.14 0 0 0-2.42 1 3.91 3.91 0 0 0-.93 2.78 3.74 3.74 0 0 0 .92 2.66 3.07 3.07 0 0 0 2.34 1 3.07 3.07 0 0 0 1.91-.57 3.17 3.17 0 0 0 1.07-1.74l-1.4-.45c-.083.43-.3.822-.62 1.12Zm-7.22 0a1.43 1.43 0 0 1-1 .37 1.58 1.58 0 0 1-1.27-.58A3 3 0 0 1 7.76 12a2.8 2.8 0 0 1 .5-1.85 1.63 1.63 0 0 1 1.29-.57 1.47 1.47 0 0 1 1.51 1.2l1.43-.34a2.81 2.81 0 0 0-.74-1.32 2.94 2.94 0 0 0-2.13-.78 3.18 3.18 0 0 0-2.43 1 4 4 0 0 0-.92 2.78 3.74 3.74 0 0 0 .92 2.66 3.07 3.07 0 0 0 2.34 1 3.07 3.07 0 0 0 1.91-.57 3.23 3.23 0 0 0 1.07-1.74l-1.4-.45a2.06 2.06 0 0 1-.6 1.07Zm12.32-8.41a2.59 2.59 0 0 0-2.3-2.51C18.72 3.05 15.86 3 13 3c-2.86 0-5.72.05-7.53.17a2.59 2.59 0 0 0-2.3 2.51c-.23 4.207-.23 8.423 0 12.63a2.57 2.57 0 0 0 2.3 2.5c1.81.13 4.67.19 7.53.19 2.86 0 5.72-.06 7.53-.19a2.57 2.57 0 0 0 2.3-2.5c.23-4.207.23-8.423 0-12.63Zm-1.49 12.53a1.11 1.11 0 0 1-.91 1.11c-1.67.11-4.45.18-7.43.18-2.98 0-5.76-.07-7.43-.18a1.11 1.11 0 0 1-.91-1.11c-.21-4.14-.21-8.29 0-12.43a1.11 1.11 0 0 1 .91-1.11C7.24 4.56 10 4.49 13 4.49s5.76.07 7.43.18a1.11 1.11 0 0 1 .91 1.11c.21 4.14.21 8.29 0 12.43Z"/>
    ...
    <slot name="icon">
      ...
      <slot name="off">${ud}</slot>
    </slot>
  `}function fd(){return`
    <slot name="tooltip-enable">${M(`Enable captions`)}</slot>
    <slot name="tooltip-disable">${M(`Disable captions`)}</slot>
  `}var pd=e=>{e.setAttribute(`aria-checked`,vl(e).toString())},md=class extends rd{static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_SUBTITLES_LIST,j.MEDIA_SUBTITLES_SHOWING]}connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`button`),this.setAttribute(`aria-label`,M(`closed captions`)),pd(this)}attributeChangedCallback(e,t,n){super.attributeChangedCallback(e,t,n),e===j.MEDIA_SUBTITLES_SHOWING&&pd(this)}get mediaSubtitlesList(){return hd(this,j.MEDIA_SUBTITLES_LIST)}set mediaSubtitlesList(e){gd(this,j.MEDIA_SUBTITLES_LIST,e)}get mediaSubtitlesShowing(){return hd(this,j.MEDIA_SUBTITLES_SHOWING)}set mediaSubtitlesShowing(e){gd(this,j.MEDIA_SUBTITLES_SHOWING,e)}handleClick(){this.dispatchEvent(new N.CustomEvent(k.MEDIA_TOGGLE_SUBTITLES_REQUEST,{composed:!0,bubbles:!0}))}};md.getSlotTemplateHTML=dd,md.getTooltipContentHTML=fd;var hd=(e,t)=>{let n=e.getAttribute(t);return n?ul(n):[]},gd=(e,t,n)=>{if(!n?.length){e.removeAttribute(t);return}let r=pl(n);e.getAttribute(t)!==r&&e.setAttribute(t,r)};N.customElements.get(`media-captions-button`)||N.customElements.define(`media-captions-button`,md);var _d=`<svg aria-hidden="true" viewBox="0 0 24 24"><g><path class="cast_caf_icon_arch0" d="M1,18 L1,21 L4,21 C4,19.3 2.66,18 1,18 L1,18 Z"/><path class="cast_caf_icon_arch1" d="M1,14 L1,16 C3.76,16 6,18.2 6,21 L8,21 C8,17.13 4.87,14 1,14 L1,14 Z"/><path class="cast_caf_icon_arch2" d="M1,10 L1,12 C5.97,12 10,16.0 10,21 L12,21 C12,14.92 7.07,10 1,10 L1,10 Z"/><path class="cast_caf_icon_box" d="M21,3 L3,3 C1.9,3 1,3.9 1,5 L1,8 L3,8 L3,5 L21,5 L21,19 L14,19 L14,21 L21,21 C22.1,21 23,20.1 23,19 L23,5 C23,3.9 22.1,3 21,3 L21,3 Z"/></g></svg>`,vd=`<svg aria-hidden="true" viewBox="0 0 24 24"><g><path class="cast_caf_icon_arch0" d="M1,18 L1,21 L4,21 C4,19.3 2.66,18 1,18 L1,18 Z"/><path class="cast_caf_icon_arch1" d="M1,14 L1,16 C3.76,16 6,18.2 6,21 L8,21 C8,17.13 4.87,14 1,14 L1,14 Z"/><path class="cast_caf_icon_arch2" d="M1,10 L1,12 C5.97,12 10,16.0 10,21 L12,21 C12,14.92 7.07,10 1,10 L1,10 Z"/><path class="cast_caf_icon_box" d="M21,3 L3,3 C1.9,3 1,3.9 1,5 L1,8 L3,8 L3,5 L21,5 L21,19 L14,19 L14,21 L21,21 C22.1,21 23,20.1 23,19 L23,5 C23,3.9 22.1,3 21,3 L21,3 Z"/><path class="cast_caf_icon_boxfill" d="M5,7 L5,8.63 C8,8.6 13.37,14 13.37,17 L19,17 L19,7 Z"/></g></svg>`;function yd(e){return`
    <style>
  ...
  `}var xd=e=>{let t=e.mediaIsCasting?M(`stop casting`):M(`start casting`);e.setAttribute(`aria-label`,t)},Sd=class extends rd{static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_IS_CASTING,j.MEDIA_CAST_UNAVAILABLE]}connectedCallback(){super.connectedCallback(),xd(this)}attributeChangedCallback(e,t,n){super.attributeChangedCallback(e,t,n),e===j.MEDIA_IS_CASTING&&xd(this)}get mediaIsCasting(){return I(this,j.MEDIA_IS_CASTING)}set mediaIsCasting(e){L(this,j.MEDIA_IS_CASTING,e)}get mediaCastUnavailable(){return R(this,j.MEDIA_CAST_UNAVAILABLE)}set mediaCastUnavailable(e){z(this,j.MEDIA_CAST_UNAVAILABLE,e)}handleClick(){let e=this.mediaIsCasting?k.MEDIA_EXIT_CAST_REQUEST:k.MEDIA_ENTER_CAST_REQUEST;this.dispatchEvent(new N.CustomEvent(e,{composed:!0,bubbles:!0}))}};Sd.getSlotTemplateHTML=yd,Sd.getTooltipContentHTML=bd,N.customElements.get(`media-cast-button`)||N.customElements.define(`media-cast-button`,Sd);var Cd=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},wd=(e,t,n)=>(Cd(e,t,`read from private field`),n?n.call(e):t.get(e)),Td=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},Ed=(e,t,n,r)=>(Cd(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),Dd=(e,t,n)=>(Cd(e,t,`access private method`),n),Od,kd,Ad,jd,Md,Nd,Pd,Fd,Id,Ld,Rd,zd,Bd,Vd,Hd;function Ud(e){return`
    <style>
      :host {
        font: var(--media-font,
  ...
  `}var Gd={OPEN:`open`,ANCHOR:`anchor`},Kd=class extends N.HTMLElement{constructor(){super(),Td(this,jd),Td(this,Nd),Td(this,Fd),Td(this,Ld),Td(this,zd),Td(this,Vd),Td(this,Od,!1),Td(this,kd,null),Td(this,Ad,null)}static get observedAttributes(){return[Gd.OPEN,Gd.ANCHOR]}get open(){return I(this,Gd.OPEN)}set open(e){L(this,Gd.OPEN,e)}handleEvent(e){switch(e.type){case`invoke`:Dd(this,Ld,Rd).call(this,e);break;case`focusout`:Dd(this,zd,Bd).call(this,e);break;case`keydown`:Dd(this,Vd,Hd).call(this,e);break}}connectedCallback(){Dd(this,jd,Md).call(this),this.role||=`dialog`,this.addEventListener(`invoke`,this),this.addEventListener(`focusout`,this),this.addEventListener(`keydown`,this)}disconnectedCallback(){this.removeEventListener(`invoke`,this),this.removeEventListener(`focusout`,this),this.removeEventListener(`keydown`,this)}attributeChangedCallback(e,t,n){Dd(this,jd,Md).call(this),e===Gd.OPEN&&n!==t&&(this.open?Dd(this,Nd,Pd).call(this):Dd(this,Fd,Id).call(this))}focus(){Ed(this,kd,nc());let e=!this.dispatchEvent(new Event(`focus`,{composed:!0,cancelable:!0})),t=!this.dispatchEvent(new Event(`focusin`,{composed:!0,bubbles:!0,cancelable:!0}));e||t||this.querySelector(`[autofocus], [tabindex]:not([tabindex="-1"]), [role="menu"]`)?.focus()}get keysUsed(){return[`Escape`,`Tab`]}};Od=new WeakMap,kd=new WeakMap,Ad=new WeakMap,jd=new WeakSet,Md=function(){if(!wd(this,Od)&&(Ed(this,Od,!0),!this.shadowRoot)){this.attachShadow(this.constructor.shadowRootOptions);let e=Js(this.attributes);this.shadowRoot.innerHTML=this.constructor.getTemplateHTML(e),queueMicrotask(()=>{let{style:e}=oc(this.shadowRoot,`:host`);e.setProperty(`transition`,`display .15s, visibility .15s, opacity .15s ease-in, transform .15s ease-in`)})}},Nd=new WeakSet,Pd=function(){var e;(e=wd(this,Ad))==null||e.setAttribute(`aria-expanded`,`true`),this.dispatchEvent(new Event(`open`,{composed:!0,bubbles:!0})),this.addEventListener(`transitionend`,()=>this.focus(),{once:!0})},Fd=new WeakSet,Id=function(){var e;(e=wd(this,Ad))==null||e.setAttribute(`aria-expanded`,`false`),this.dispatchEvent(new Event(`close`,{composed:!0,bubbles:!0}))},Ld=new WeakSet,Rd=function(e){Ed(this,Ad,e.relatedTarget),ec(this,e.relatedTarget)||(this.open=!this.open)},zd=new WeakSet,Bd=function(e){var t;ec(this,e.relatedTarget)||((t=wd(this,kd))==null||t.focus(),wd(this,Ad)&&wd(this,Ad)!==e.relatedTarget&&this.open&&(this.open=!1))},Vd=new WeakSet,Hd=function(e){var t,n,r,i,a;let{key:o,ctrlKey:s,altKey:c,metaKey:l}=e;s||c||l||this.keysUsed.includes(o)&&(e.preventDefault(),e.stopPropagation(),o===`Tab`?(e.shiftKey?(n=(t=this.previousElementSibling)?.focus)==null||n.call(t):(i=(r=this.nextElementSibling)?.focus)==null||i.call(r),this.blur()):o===`Escape`&&((a=wd(this,kd))==null||a.focus(),this.open=!1))},Kd.shadowRootOptions={mode:`open`},Kd.getTemplateHTML=Ud,Kd.getSlotTemplateHTML=Wd,N.customElements.get(`media-chrome-dialog`)||N.customElements.define(`media-chrome-dialog`,Kd);var qd=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},W=(e,t,n)=>(qd(e,t,`read from private field`),n?n.call(e):t.get(e)),Jd=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},Yd=(e,t,n,r)=>(qd(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),Xd=(e,t,n)=>(qd(e,t,`access private method`),n),Zd,Qd,$d,ef,tf,nf,rf,af,of,sf,cf,lf,uf,df,ff,pf,mf,hf,gf,_f,vf,yf,bf,xf,Sf;function Cf(e){return`
    <style>
      :host {
    ...
    <div id="rightgap"></div>
  `}function wf(e){return``}var Tf=class extends N.HTMLElement{constructor(){if(super(),Jd(this,sf),Jd(this,lf),Jd(this,df),Jd(this,pf),Jd(this,hf),Jd(this,_f),Jd(this,yf),Jd(this,xf),Jd(this,Zd,void 0),Jd(this,Qd,void 0),Jd(this,$d,void 0),Jd(this,ef,void 0),Jd(this,tf,{}),Jd(this,nf,[]),Jd(this,rf,()=>{if(this.range.matches(`:focus-visible`)){let{style:e}=oc(this.shadowRoot,`:host`);e.setProperty(`--_focus-visible-box-shadow`,`var(--_focus-box-shadow)`)}}),Jd(this,af,()=>{let{style:e}=oc(this.shadowRoot,`:host`);e.removeProperty(`--_focus-visible-box-shadow`)}),Jd(this,of,()=>{let e=this.shadowRoot.querySelector(`#segments-clipping`);e&&e.parentNode.append(e)}),!this.shadowRoot){this.attachShadow(this.constructor.shadowRootOptions);let e=Js(this.attributes),t=this.constructor.getTemplateHTML(e);this.shadowRoot.setHTMLUnsafe?this.shadowRoot.setHTMLUnsafe(t):this.shadowRoot.innerHTML=t}this.container=this.shadowRoot.querySelector(`#container`),Yd(this,$d,this.shadowRoot.querySelector(`#startpoint`)),Yd(this,ef,this.shadowRoot.querySelector(`#endpoint`)),this.range=this.shadowRoot.querySelector(`#range`),this.appearance=this.shadowRoot.querySelector(`#appearance`)}static get observedAttributes(){return[`disabled`,`aria-disabled`,A.MEDIA_CONTROLLER]}attributeChangedCallback(e,t,n){var r,i,a,o;e===A.MEDIA_CONTROLLER?(t&&((i=(r=W(this,Zd))?.unassociateElement)==null||i.call(r,this),Yd(this,Zd,null)),n&&this.isConnected&&(Yd(this,Zd,this.getRootNode()?.getElementById(n)),(o=(a=W(this,Zd))?.associateElement)==null||o.call(a,this))):(e===`disabled`||e===`aria-disabled`&&t!==n)&&(n==null?(this.range.removeAttribute(e),Xd(this,lf,uf).call(this)):(this.range.setAttribute(e,n),Xd(this,df,ff).call(this)))}connectedCallback(){var e,t;let{style:n}=oc(this.shadowRoot,`:host`);n.setProperty(`display`,`var(--media-control-display, var(--${this.localName}-display, inline-flex))`),W(this,tf).pointer=oc(this.shadowRoot,`#pointer`),W(this,tf).progress=oc(this.shadowRoot,`#progress`),W(this,tf).thumb=oc(this.shadowRoot,`#thumb, ::slotted([slot="thumb"])`),W(this,tf).activeSegment=oc(this.shadowRoot,`#segments-clipping rect:nth-child(0)`);let r=this.getAttribute(A.MEDIA_CONTROLLER);r&&(Yd(this,Zd,this.getRootNode()?.getElementById(r)),(t=(e=W(this,Zd))?.associateElement)==null||t.call(e,this)),this.updateBar(),this.shadowRoot.addEventListener(`focusin`,W(this,rf)),this.shadowRoot.addEventListener(`focusout`,W(this,af)),Xd(this,lf,uf).call(this),Ks(this.container,W(this,of))}disconnectedCallback(){var e,t;Xd(this,df,ff).call(this),(t=(e=W(this,Zd))?.unassociateElement)==null||t.call(e,this),Yd(this,Zd,null),this.shadowRoot.removeEventListener(`focusin`,W(this,rf)),this.shadowRoot.removeEventListener(`focusout`,W(this,af)),qs(this.container,W(this,of))}updatePointerBar(e){var t;(t=W(this,tf).pointer)==null||t.style.setProperty(`width`,`${this.getPointerRatio(e)*100}%`)}updateBar(){var e,t;let n=this.range.valueAsNumber*100;(e=W(this,tf).progress)==null||e.style.setProperty(`width`,`${n}%`),(t=W(this,tf).thumb)==null||t.style.setProperty(`left`,`${n}%`)}updateSegments(e){let t=this.shadowRoot.querySelector(`#segments-clipping`);if(t.textContent=``,this.container.classList.toggle(`segments`,!!e?.length),!e?.length)return;let n=[...new Set([+this.range.min,...e.flatMap(e=>[e.start,e.end]),+this.range.max])];Yd(this,nf,[...n]);let r=n.pop();for(let[e,i]of n.entries()){let[a,o]=[e===0,e===n.length-1],s=a?`calc(var(--segments-gap) / -1)`:`${i*100}%`,c=`calc(${((o?r:n[e+1])-i)*100}%${a||o?``:` - var(--segments-gap)`})`,l=Hs.createElementNS(`http://www.w3.org/2000/svg`,`rect`),u=cc(this.shadowRoot,`#segments-clipping rect:nth-child(${e+1})`);u.style.setProperty(`x`,s),u.style.setProperty(`width`,c),t.append(l)}}getPointerRatio(e){return ac(e.clientX,e.clientY,W(this,$d).getBoundingClientRect(),W(this,ef).getBoundingClientRect())}get dragging(){return this.hasAttribute(`dragging`)}handleEvent(e){switch(e.type){case`pointermove`:Xd(this,xf,Sf).call(this,e);break;case`input`:this.updateBar();break;case`pointerenter`:Xd(this,hf,gf).call(this,e);break;case`pointerdown`:Xd(this,pf,mf).call(this,e);break;case`pointerup`:Xd(this,_f,vf).call(this);break;case`pointerleave`:Xd(this,yf,bf).call(this);break}}get keysUsed(){return[`ArrowUp`,`ArrowRight`,`ArrowDown`,`ArrowLeft`]}};Zd=new WeakMap,Qd=new WeakMap,$d=new WeakMap,ef=new WeakMap,tf=new WeakMap,nf=new WeakMap,rf=new WeakMap,af=new WeakMap,of=new WeakMap,sf=new WeakSet,cf=function(e){let t=W(this,tf).activeSegment;if(!t)return;let n=this.getPointerRatio(e),r=`#segments-clipping rect:nth-child(${W(this,nf).findIndex((e,t,r)=>{let i=r[t+1];return i!=null&&n>=e&&n<=i})+1})`;(t.selectorText!=r||!t.style.transform)&&(t.selectorText=r,t.style.setProperty(`transform`,`var(--media-range-segment-hover-transform, scaleY(2))`))},lf=new WeakSet,uf=function(){this.hasAttribute(`disabled`)||!this.isConnected||(this.addEventListener(`input`,this),this.addEventListener(`pointerdown`,this),this.addEventListener(`pointerenter`,this))},df=new WeakSet,ff=function(){var e,t;this.removeEventListener(`input`,this),this.removeEventListener(`pointerdown`,this),this.removeEventListener(`pointerenter`,this),this.removeEventListener(`pointerleave`,this),(e=N.window)==null||e.removeEventListener(`pointerup`,this),(t=N.window)==null||t.removeEventListener(`pointermove`,this)},pf=new WeakSet,mf=function(e){var t;Yd(this,Qd,e.composedPath().includes(this.range)),(t=N.window)==null||t.addEventListener(`pointerup`,this,{once:!0})},hf=new WeakSet,gf=function(e){var t;e.pointerType!==`mouse`&&Xd(this,pf,mf).call(this,e),this.addEventListener(`pointerleave`,this,{once:!0}),(t=N.window)==null||t.addEventListener(`pointermove`,this)},_f=new WeakSet,vf=function(){var e;(e=N.window)==null||e.removeEventListener(`pointerup`,this),this.toggleAttribute(`dragging`,!1),this.range.disabled=this.hasAttribute(`disabled`)},yf=new WeakSet,bf=function(){var e,t;this.removeEventListener(`pointerleave`,this),(e=N.window)==null||e.removeEventListener(`pointermove`,this),this.toggleAttribute(`dragging`,!1),this.range.disabled=this.hasAttribute(`disabled`),(t=W(this,tf).activeSegment)==null||t.style.removeProperty(`transform`)},xf=new WeakSet,Sf=function(e){e.pointerType===`pen`&&e.buttons===0||(this.toggleAttribute(`dragging`,e.buttons===1||e.pointerType!==`mouse`),this.updatePointerBar(e),Xd(this,sf,cf).call(this,e),this.dragging&&(e.pointerType!==`mouse`||!W(this,Qd))&&(this.range.disabled=!0,this.range.valueAsNumber=this.getPointerRatio(e),this.range.dispatchEvent(new Event(`input`,{bubbles:!0,composed:!0}))))},Tf.shadowRootOptions={mode:`open`},Tf.getTemplateHTML=Cf,Tf.getContainerTemplateHTML=wf,N.customElements.get(`media-chrome-range`)||N.customElements.define(`media-chrome-range`,Tf);var Ef=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},Df=(e,t,n)=>(Ef(e,t,`read from private field`),n?n.call(e):t.get(e)),Of=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},kf=(e,t,n,r)=>(Ef(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),Af;function jf(e){return`
    <style>
      :host {
    ...
    <slot></slot>
  `}var Mf=class extends N.HTMLElement{constructor(){if(super(),Of(this,Af,void 0),!this.shadowRoot){this.attachShadow(this.constructor.shadowRootOptions);let e=Js(this.attributes);this.shadowRoot.innerHTML=this.constructor.getTemplateHTML(e)}}static get observedAttributes(){return[A.MEDIA_CONTROLLER]}attributeChangedCallback(e,t,n){var r,i,a,o;e===A.MEDIA_CONTROLLER&&(t&&((i=(r=Df(this,Af))?.unassociateElement)==null||i.call(r,this),kf(this,Af,null)),n&&this.isConnected&&(kf(this,Af,this.getRootNode()?.getElementById(n)),(o=(a=Df(this,Af))?.associateElement)==null||o.call(a,this)))}connectedCallback(){var e,t;let n=this.getAttribute(A.MEDIA_CONTROLLER);n&&(kf(this,Af,this.getRootNode()?.getElementById(n)),(t=(e=Df(this,Af))?.associateElement)==null||t.call(e,this))}disconnectedCallback(){var e,t;(t=(e=Df(this,Af))?.unassociateElement)==null||t.call(e,this),kf(this,Af,null)}};Af=new WeakMap,Mf.shadowRootOptions={mode:`open`},Mf.getTemplateHTML=jf,N.customElements.get(`media-control-bar`)||N.customElements.define(`media-control-bar`,Mf);var Nf=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},Pf=(e,t,n)=>(Nf(e,t,`read from private field`),n?n.call(e):t.get(e)),Ff=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},If=(e,t,n,r)=>(Nf(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),Lf;function Rf(e,t={}){return`
    <style>
      :host {
        font: var(--media-font,
          var(--media-font-weight, normal)
    ...
    ${this.getSlotTemplateHTML(e,t)}
  `}function zf(e,t){return`
    <slot></slot>
  `}var Bf=class extends N.HTMLElement{constructor(){if(super(),Ff(this,Lf,void 0),!this.shadowRoot){this.attachShadow(this.constructor.shadowRootOptions);let e=Js(this.attributes);this.shadowRoot.innerHTML=this.constructor.getTemplateHTML(e)}}static get observedAttributes(){return[A.MEDIA_CONTROLLER]}attributeChangedCallback(e,t,n){var r,i,a,o;e===A.MEDIA_CONTROLLER&&(t&&((i=(r=Pf(this,Lf))?.unassociateElement)==null||i.call(r,this),If(this,Lf,null)),n&&this.isConnected&&(If(this,Lf,this.getRootNode()?.getElementById(n)),(o=(a=Pf(this,Lf))?.associateElement)==null||o.call(a,this)))}connectedCallback(){var e,t;let{style:n}=oc(this.shadowRoot,`:host`);n.setProperty(`display`,`var(--media-control-display, var(--${this.localName}-display, inline-flex))`);let r=this.getAttribute(A.MEDIA_CONTROLLER);r&&(If(this,Lf,this.getRootNode()?.getElementById(r)),(t=(e=Pf(this,Lf))?.associateElement)==null||t.call(e,this))}disconnectedCallback(){var e,t;(t=(e=Pf(this,Lf))?.unassociateElement)==null||t.call(e,this),If(this,Lf,null)}};Lf=new WeakMap,Bf.shadowRootOptions={mode:`open`},Bf.getTemplateHTML=Rf,Bf.getSlotTemplateHTML=zf,N.customElements.get(`media-text-display`)||N.customElements.define(`media-text-display`,Bf);var Vf=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},Hf=(e,t,n)=>(Vf(e,t,`read from private field`),n?n.call(e):t.get(e)),Uf=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},Wf=(e,t,n,r)=>(Vf(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),Gf;function Kf(e,t){return`
    <slot>${Ns(t.mediaDuration)}</slot>
  `}var qf=class extends Bf{constructor(){super(),Uf(this,Gf,void 0),Wf(this,Gf,this.shadowRoot.querySelector(`slot`)),Hf(this,Gf).textContent=Ns(this.mediaDuration??0)}static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_DURATION]}attributeChangedCallback(e,t,n){e===j.MEDIA_DURATION&&(Hf(this,Gf).textContent=Ns(+n)),super.attributeChangedCallback(e,t,n)}get mediaDuration(){return P(this,j.MEDIA_DURATION)}set mediaDuration(e){F(this,j.MEDIA_DURATION,e)}};Gf=new WeakMap,qf.getSlotTemplateHTML=Kf,N.customElements.get(`media-duration-display`)||N.customElements.define(`media-duration-display`,qf);var Jf={2:M(`Network Error`),3:M(`Decode Error`),4:M(`Source Not Supported`),5:M(`Encryption Error`)},Yf={2:M(`A network error caused the media download to fail.`),3:M(`A media error caused playback to be aborted. The media could be corrupt or your browser does not support this format.`),4:M(`An unsupported error occurred. The server or network failed, or your browser does not support this format.`),5:M(`The media is encrypted and there are no keys to decrypt it.`)},Xf=e=>e.code===1?null:{title:Jf[e.code]??`Error ${e.code}`,message:Yf[e.code]??e.message},Zf=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},Qf=(e,t,n)=>(Zf(e,t,`read from private field`),n?n.call(e):t.get(e)),$f=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},ep=(e,t,n,r)=>(Zf(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),tp;function np(e){return`
    <style>
      :host {
  ...
  `}function rp(e){return e.code&&Xf(e)!==null}function ip(e){let{title:t,message:n}=Xf(e)??{},r=``;return t&&(r+=`<slot name="error-${e.code}-title"><h3>${t}</h3></slot>`),n&&(r+=`<slot name="error-${e.code}-message"><p>${n}</p></slot>`),r}var ap=[j.MEDIA_ERROR_CODE,j.MEDIA_ERROR_MESSAGE],op=class extends Kd{constructor(){super(...arguments),$f(this,tp,null)}static get observedAttributes(){return[...super.observedAttributes,...ap]}formatErrorMessage(e){return this.constructor.formatErrorMessage(e)}attributeChangedCallback(e,t,n){if(super.attributeChangedCallback(e,t,n),!ap.includes(e))return;let r=this.mediaError??{code:this.mediaErrorCode,message:this.mediaErrorMessage};if(this.open=rp(r),this.open&&(this.shadowRoot.querySelector(`slot`).name=`error-${this.mediaErrorCode}`,this.shadowRoot.querySelector(`#content`).innerHTML=this.formatErrorMessage(r),!this.hasAttribute(`aria-label`))){let{title:e}=Xf(r);e&&this.setAttribute(`aria-label`,e)}}get mediaError(){return Qf(this,tp)}set mediaError(e){ep(this,tp,e)}get mediaErrorCode(){return P(this,`mediaerrorcode`)}set mediaErrorCode(e){F(this,`mediaerrorcode`,e)}get mediaErrorMessage(){return R(this,`mediaerrormessage`)}set mediaErrorMessage(e){z(this,`mediaerrormessage`,e)}};tp=new WeakMap,op.getSlotTemplateHTML=np,op.formatErrorMessage=ip,N.customElements.get(`media-error-dialog`)||N.customElements.define(`media-error-dialog`,op);var sp=op,cp=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},lp=(e,t,n)=>(cp(e,t,`read from private field`),n?n.call(e):t.get(e)),up=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},dp,fp;function pp(e){return`
    <style>
      :host {
        position: fixed;
        top: 0;
  ...
  `}function mp(){return`
    ...
    `).join(``)}</table>
  `}var hp=class extends Kd{constructor(){super(...arguments),up(this,dp,e=>{if(!this.open)return;let t=this.shadowRoot?.querySelector(`#content`);if(!t)return;let n=e.composedPath(),r=n[0]===this||n.includes(this),i=n.includes(t);r&&!i&&(this.open=!1)}),up(this,fp,e=>{if(!this.open)return;let t=e.shiftKey&&(e.key===`/`||e.key===`?`);(e.key===`Escape`||t)&&!e.ctrlKey&&!e.altKey&&!e.metaKey&&(this.open=!1,e.preventDefault(),e.stopPropagation())})}connectedCallback(){super.connectedCallback(),this.open&&(this.addEventListener(`click`,lp(this,dp)),document.addEventListener(`keydown`,lp(this,fp)))}disconnectedCallback(){this.removeEventListener(`click`,lp(this,dp)),document.removeEventListener(`keydown`,lp(this,fp))}attributeChangedCallback(e,t,n){super.attributeChangedCallback(e,t,n),e===`open`&&(this.open?(this.addEventListener(`click`,lp(this,dp)),document.addEventListener(`keydown`,lp(this,fp))):(this.removeEventListener(`click`,lp(this,dp)),document.removeEventListener(`keydown`,lp(this,fp))))}};dp=new WeakMap,fp=new WeakMap,hp.getSlotTemplateHTML=pp,N.customElements.get(`media-keyboard-shortcuts-dialog`)||N.customElements.define(`media-keyboard-shortcuts-dialog`,hp);var gp=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},_p=(e,t,n)=>(gp(e,t,`read from private field`),n?n.call(e):t.get(e)),vp=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},yp=(e,t,n,r)=>(gp(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),bp,xp=`<svg aria-hidden="true" viewBox="0 0 26 24">
  <path d="M16 3v2.5h3.5V9H22V3h-6ZM4 9h2.5V5.5H10V3H4v6Zm15.5 9.5H16V21h6v-6h-2.5v3.5ZM6.5 15H4v6h6v-2.5H6.5V15Z"/>
</svg>`,Sp=`<svg aria-hidden="true" viewBox="0 0 26 24">
  <path d="M18.5 6.5V3H16v6h6V6.5h-3.5ZM16 21h2.5v-3.5H22V15h-6v6ZM4 17.5h3.5V21H10v-6H4v2.5Zm3.5-11H4V9h6V3H7.5v3.5Z"/>
</svg>`;function Cp(e){return`
    <style>
  ...
  `}var Tp=e=>{let t=e.mediaIsFullscreen?M(`exit fullscreen mode`):M(`enter fullscreen mode`);e.setAttribute(`aria-label`,t)},Ep=class extends rd{constructor(){super(...arguments),vp(this,bp,null)}static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_IS_FULLSCREEN,j.MEDIA_FULLSCREEN_UNAVAILABLE]}connectedCallback(){super.connectedCallback(),Tp(this)}attributeChangedCallback(e,t,n){super.attributeChangedCallback(e,t,n),e===j.MEDIA_IS_FULLSCREEN&&Tp(this)}get mediaFullscreenUnavailable(){return R(this,j.MEDIA_FULLSCREEN_UNAVAILABLE)}set mediaFullscreenUnavailable(e){z(this,j.MEDIA_FULLSCREEN_UNAVAILABLE,e)}get mediaIsFullscreen(){return I(this,j.MEDIA_IS_FULLSCREEN)}set mediaIsFullscreen(e){L(this,j.MEDIA_IS_FULLSCREEN,e)}handleClick(e){yp(this,bp,e);let t=_p(this,bp)instanceof PointerEvent,n=this.mediaIsFullscreen?new N.CustomEvent(k.MEDIA_EXIT_FULLSCREEN_REQUEST,{composed:!0,bubbles:!0}):new N.CustomEvent(k.MEDIA_ENTER_FULLSCREEN_REQUEST,{composed:!0,bubbles:!0,detail:t});this.dispatchEvent(n)}};bp=new WeakMap,Ep.getSlotTemplateHTML=Cp,Ep.getTooltipContentHTML=wp,N.customElements.get(`media-fullscreen-button`)||N.customElements.define(`media-fullscreen-button`,Ep);var{MEDIA_TIME_IS_LIVE:Dp,MEDIA_PAUSED:Op}=j,{MEDIA_SEEK_TO_LIVE_REQUEST:kp,MEDIA_PLAY_REQUEST:Ap}=k,jp=`<svg viewBox="0 0 6 12" aria-hidden="true"><circle cx="3" cy="6" r="2"></circle></svg>`;function Mp(e){return`
    <style>
      ...
      :host([${Dp}]:not([${Op}])) slot[name=indicator] > *,
      :host([${Dp}]:not([${Op}])) ::slotted([slot=indicator]) {
    ...
    <slot name="indicator">${jp}</slot>
    
    <slot name="spacer">&nbsp;</slot><slot name="text">${M(`live`)}</slot>
  `}var Np=e=>{let t=e.mediaPaused||!e.mediaTimeIsLive,n=M(t?`seek to live`:`playing live`);e.setAttribute(`aria-label`,n);let r=e.shadowRoot?.querySelector(`slot[name="text"]`);r&&(r.textContent=M(`live`)),t?e.removeAttribute(`aria-disabled`):e.setAttribute(`aria-disabled`,`true`)},Pp=class extends rd{static get observedAttributes(){return[...super.observedAttributes,Dp,Op]}connectedCallback(){super.connectedCallback(),Np(this)}attributeChangedCallback(e,t,n){super.attributeChangedCallback(e,t,n),Np(this)}get mediaPaused(){return I(this,j.MEDIA_PAUSED)}set mediaPaused(e){L(this,j.MEDIA_PAUSED,e)}get mediaTimeIsLive(){return I(this,j.MEDIA_TIME_IS_LIVE)}set mediaTimeIsLive(e){L(this,j.MEDIA_TIME_IS_LIVE,e)}handleClick(){!this.mediaPaused&&this.mediaTimeIsLive||(this.dispatchEvent(new N.CustomEvent(kp,{composed:!0,bubbles:!0})),this.hasAttribute(Op)&&this.dispatchEvent(new N.CustomEvent(Ap,{composed:!0,bubbles:!0})))}};Pp.getSlotTemplateHTML=Mp,N.customElements.get(`media-live-button`)||N.customElements.define(`media-live-button`,Pp);var Fp=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},Ip=(e,t,n)=>(Fp(e,t,`read from private field`),n?n.call(e):t.get(e)),Lp=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},Rp=(e,t,n,r)=>(Fp(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),zp,Bp,Vp={LOADING_DELAY:`loadingdelay`,NO_AUTOHIDE:`noautohide`},Hp=500,Up=`
...
`;function Wp(e){return`
  ...
  `}var Gp=class extends N.HTMLElement{constructor(){if(super(),Lp(this,zp,void 0),Lp(this,Bp,Hp),!this.shadowRoot){this.attachShadow(this.constructor.shadowRootOptions);let e=Js(this.attributes);this.shadowRoot.innerHTML=this.constructor.getTemplateHTML(e)}}static get observedAttributes(){return[A.MEDIA_CONTROLLER,j.MEDIA_PAUSED,j.MEDIA_LOADING,Vp.LOADING_DELAY]}attributeChangedCallback(e,t,n){var r,i,a,o;e===Vp.LOADING_DELAY&&t!==n?this.loadingDelay=Number(n):e===A.MEDIA_CONTROLLER&&(t&&((i=(r=Ip(this,zp))?.unassociateElement)==null||i.call(r,this),Rp(this,zp,null)),n&&this.isConnected&&(Rp(this,zp,this.getRootNode()?.getElementById(n)),(o=(a=Ip(this,zp))?.associateElement)==null||o.call(a,this)))}connectedCallback(){var e,t;let n=this.getAttribute(A.MEDIA_CONTROLLER);n&&(Rp(this,zp,this.getRootNode()?.getElementById(n)),(t=(e=Ip(this,zp))?.associateElement)==null||t.call(e,this))}disconnectedCallback(){var e,t;(t=(e=Ip(this,zp))?.unassociateElement)==null||t.call(e,this),Rp(this,zp,null)}get loadingDelay(){return Ip(this,Bp)}set loadingDelay(e){Rp(this,Bp,e);let{style:t}=oc(this.shadowRoot,`:host`);t.setProperty(`--_loading-indicator-delay`,`var(--media-loading-indicator-transition-delay, ${e}ms)`)}get mediaPaused(){return I(this,j.MEDIA_PAUSED)}set mediaPaused(e){L(this,j.MEDIA_PAUSED,e)}get mediaLoading(){return I(this,j.MEDIA_LOADING)}set mediaLoading(e){L(this,j.MEDIA_LOADING,e)}get mediaController(){return R(this,A.MEDIA_CONTROLLER)}set mediaController(e){z(this,A.MEDIA_CONTROLLER,e)}get noAutohide(){return I(this,Vp.NO_AUTOHIDE)}set noAutohide(e){L(this,Vp.NO_AUTOHIDE,e)}};zp=new WeakMap,Bp=new WeakMap,Gp.shadowRootOptions={mode:`open`},Gp.getTemplateHTML=Wp,N.customElements.get(`media-loading-indicator`)||N.customElements.define(`media-loading-indicator`,Gp);var Kp=`<svg aria-hidden="true" viewBox="0 0 24 24">
  <path d="M16.5 12A4.5 4.5 0 0 0 14 8v2.18l2.45 2.45a4.22 4.22 0 0 0 .05-.63Zm2.5 0a6.84 6.84 0 0 1-.54 2.64L20 16.15A8.8 8.8 0 0 0 21 12a9 9 0 0 0-7-8.77v2.06A7 7 0 0 1 19 12ZM4.27 3 3 4.27 7.73 9H3v6h4l5 5v-6.73l4.25 4.25A6.92 6.92 0 0 1 14 18.7v2.06A9 9 0 0 0 17.69 19l2 2.05L21 19.73l-9-9L4.27 3ZM12 4 9.91 6.09 12 8.18V4Z"/>
</svg>`,qp=`<svg aria-hidden="true" viewBox="0 0 24 24">
  ...
  <path d="M3 9v6h4l5 5V4L7 9H3Zm13.5 3A4.5 4.5 0 0 0 14 8v8a4.47 4.47 0 0 0 2.5-4ZM14 3.23v2.06a7 7 0 0 1 0 13.42v2.06a9 9 0 0 0 0-17.54Z"/>
    ...
    <slot name="icon">
      ...
      <slot name="low">${qp}</slot>
      <slot name="medium">${qp}</slot>
      <slot name="high">${Jp}</slot>
    </slot>
  `}function Xp(){return`
    <slot name="tooltip-mute">${M(`Mute`)}</slot>
    <slot name="tooltip-unmute">${M(`Unmute`)}</slot>
  `}var Zp=e=>{let t=e.mediaVolumeLevel===`off`?M(`unmute`):M(`mute`);e.setAttribute(`aria-label`,t)},Qp=class extends rd{static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_VOLUME_LEVEL]}connectedCallback(){super.connectedCallback(),Zp(this)}attributeChangedCallback(e,t,n){super.attributeChangedCallback(e,t,n),e===j.MEDIA_VOLUME_LEVEL&&Zp(this)}get mediaVolumeLevel(){return R(this,j.MEDIA_VOLUME_LEVEL)}set mediaVolumeLevel(e){z(this,j.MEDIA_VOLUME_LEVEL,e)}handleClick(){let e=this.mediaVolumeLevel===`off`?k.MEDIA_UNMUTE_REQUEST:k.MEDIA_MUTE_REQUEST;this.dispatchEvent(new N.CustomEvent(e,{composed:!0,bubbles:!0}))}};Qp.getSlotTemplateHTML=Yp,Qp.getTooltipContentHTML=Xp,N.customElements.get(`media-mute-button`)||N.customElements.define(`media-mute-button`,Qp);var $p=`<svg aria-hidden="true" viewBox="0 0 28 24">
  ...
  `}var nm=e=>{let t=e.mediaIsPip?M(`exit picture in picture mode`):M(`enter picture in picture mode`);e.setAttribute(`aria-label`,t)},rm=class extends rd{static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_IS_PIP,j.MEDIA_PIP_UNAVAILABLE]}connectedCallback(){super.connectedCallback(),nm(this)}attributeChangedCallback(e,t,n){super.attributeChangedCallback(e,t,n),e===j.MEDIA_IS_PIP&&nm(this)}get mediaPipUnavailable(){return R(this,j.MEDIA_PIP_UNAVAILABLE)}set mediaPipUnavailable(e){z(this,j.MEDIA_PIP_UNAVAILABLE,e)}get mediaIsPip(){return I(this,j.MEDIA_IS_PIP)}set mediaIsPip(e){L(this,j.MEDIA_IS_PIP,e)}handleClick(){let e=this.mediaIsPip?k.MEDIA_EXIT_PIP_REQUEST:k.MEDIA_ENTER_PIP_REQUEST;this.dispatchEvent(new N.CustomEvent(e,{composed:!0,bubbles:!0}))}};rm.getSlotTemplateHTML=em,rm.getTooltipContentHTML=tm,N.customElements.get(`media-pip-button`)||N.customElements.define(`media-pip-button`,rm);var im=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},am=(e,t,n)=>(im(e,t,`read from private field`),n?n.call(e):t.get(e)),om=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},sm,cm={RATES:`rates`},lm=[1,1.2,1.5,1.7,2];function um(e){return`
    <style>
      :host {
        min-width: 5ch;
  ...
  `}function dm(){return M(`Playback rate`)}var fm=class extends rd{constructor(){super(),om(this,sm,new sl(this,cm.RATES,{defaultValue:lm})),this.container=this.shadowRoot.querySelector(`slot[name="icon"]`),this.container.innerHTML=`${this.mediaPlaybackRate??1}x`}static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_PLAYBACK_RATE,cm.RATES]}attributeChangedCallback(e,t,n){if(super.attributeChangedCallback(e,t,n),e===cm.RATES&&(am(this,sm).value=n),e===j.MEDIA_PLAYBACK_RATE){let e=n?+n:NaN,t=Number.isNaN(e)?1:e;this.container.innerHTML=`${t}x`,this.setAttribute(`aria-label`,M(`Playback rate {playbackRate}`,{playbackRate:t}))}}get rates(){return am(this,sm)}set rates(e){e?Array.isArray(e)?am(this,sm).value=e.join(` `):typeof e==`string`&&(am(this,sm).value=e):am(this,sm).value=``}get mediaPlaybackRate(){return P(this,j.MEDIA_PLAYBACK_RATE,1)}set mediaPlaybackRate(e){F(this,j.MEDIA_PLAYBACK_RATE,e)}handleClick(){let e=Array.from(am(this,sm).values(),e=>+e).sort((e,t)=>e-t),t=e.find(e=>e>this.mediaPlaybackRate)??e[0]??1,n=new N.CustomEvent(k.MEDIA_PLAYBACK_RATE_REQUEST,{composed:!0,bubbles:!0,detail:t});this.dispatchEvent(n)}};sm=new WeakMap,fm.getSlotTemplateHTML=um,fm.getTooltipContentHTML=dm,N.customElements.get(`media-playback-rate-button`)||N.customElements.define(`media-playback-rate-button`,fm);var pm=`<svg aria-hidden="true" viewBox="0 0 24 24">
  ...
  <path d="M6 20h4V4H6v16Zm8-16v16h4V4h-4Z"/>
    ...
    <slot name="icon">
      <slot name="play">${pm}</slot>
      <slot name="pause">${mm}</slot>
    </slot>
  `}function gm(){return`
    <slot name="tooltip-play">${M(`Play`)}</slot>
    <slot name="tooltip-pause">${M(`Pause`)}</slot>
  `}var _m=e=>{let t=e.mediaPaused?M(`play`):M(`pause`);e.setAttribute(`aria-label`,t)},vm=class extends rd{static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_PAUSED,j.MEDIA_ENDED]}connectedCallback(){super.connectedCallback(),_m(this)}attributeChangedCallback(e,t,n){super.attributeChangedCallback(e,t,n),(e===j.MEDIA_PAUSED||e===j.MEDIA_LANG)&&_m(this)}get mediaPaused(){return I(this,j.MEDIA_PAUSED)}set mediaPaused(e){L(this,j.MEDIA_PAUSED,e)}handleClick(){let e=this.mediaPaused?k.MEDIA_PLAY_REQUEST:k.MEDIA_PAUSE_REQUEST;this.dispatchEvent(new N.CustomEvent(e,{composed:!0,bubbles:!0}))}};vm.getSlotTemplateHTML=hm,vm.getTooltipContentHTML=gm,N.customElements.get(`media-play-button`)||N.customElements.define(`media-play-button`,vm);var ym={PLACEHOLDER_SRC:`placeholdersrc`,SRC:`src`};function bm(e){return`
    <style>
      :host {
        pointer-events: none;
  ...
  `}var xm=e=>{e.style.removeProperty(`background-image`)},Sm=(e,t)=>{e.style[`background-image`]=`url('${t}')`},Cm=class extends N.HTMLElement{static get observedAttributes(){return[ym.PLACEHOLDER_SRC,ym.SRC]}constructor(){if(super(),!this.shadowRoot){this.attachShadow(this.constructor.shadowRootOptions);let e=Js(this.attributes);this.shadowRoot.innerHTML=this.constructor.getTemplateHTML(e)}this.image=this.shadowRoot.querySelector(`#image`)}attributeChangedCallback(e,t,n){e===ym.SRC&&(n==null?this.image.removeAttribute(ym.SRC):this.image.setAttribute(ym.SRC,n)),e===ym.PLACEHOLDER_SRC&&(n==null?xm(this.image):Sm(this.image,n))}get placeholderSrc(){return R(this,ym.PLACEHOLDER_SRC)}set placeholderSrc(e){z(this,ym.SRC,e)}get src(){return R(this,ym.SRC)}set src(e){z(this,ym.SRC,e)}};Cm.shadowRootOptions={mode:`open`},Cm.getTemplateHTML=bm,N.customElements.get(`media-poster-image`)||N.customElements.define(`media-poster-image`,Cm);var wm=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},Tm=(e,t,n)=>(wm(e,t,`read from private field`),n?n.call(e):t.get(e)),Em=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},Dm=(e,t,n,r)=>(wm(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),Om,km=class extends Bf{constructor(){super(),Em(this,Om,void 0),Dm(this,Om,this.shadowRoot.querySelector(`slot`))}static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_PREVIEW_CHAPTER,j.MEDIA_LANG]}attributeChangedCallback(e,t,n){if(super.attributeChangedCallback(e,t,n),(e===j.MEDIA_PREVIEW_CHAPTER||e===j.MEDIA_LANG)&&n!==t&&n!=null)if(Tm(this,Om).textContent=n,n!==``){let e=M(`chapter: {chapterName}`,{chapterName:n});this.setAttribute(`aria-valuetext`,e)}else this.removeAttribute(`aria-valuetext`)}get mediaPreviewChapter(){return R(this,j.MEDIA_PREVIEW_CHAPTER)}set mediaPreviewChapter(e){z(this,j.MEDIA_PREVIEW_CHAPTER,e)}};Om=new WeakMap,N.customElements.get(`media-preview-chapter-display`)||N.customElements.define(`media-preview-chapter-display`,km);var Am=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},jm=(e,t,n)=>(Am(e,t,`read from private field`),n?n.call(e):t.get(e)),Mm=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},Nm=(e,t,n,r)=>(Am(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),Pm;function Fm(e){return`
    <style>
      :host {
        box-sizing: border-box;
  ...
  `}var Im=class extends N.HTMLElement{constructor(){if(super(),Mm(this,Pm,void 0),!this.shadowRoot){this.attachShadow(this.constructor.shadowRootOptions);let e=Js(this.attributes);this.shadowRoot.innerHTML=this.constructor.getTemplateHTML(e)}}static get observedAttributes(){return[A.MEDIA_CONTROLLER,j.MEDIA_PREVIEW_IMAGE,j.MEDIA_PREVIEW_COORDS]}connectedCallback(){var e,t;let n=this.getAttribute(A.MEDIA_CONTROLLER);n&&(Nm(this,Pm,this.getRootNode()?.getElementById(n)),(t=(e=jm(this,Pm))?.associateElement)==null||t.call(e,this))}disconnectedCallback(){var e,t;(t=(e=jm(this,Pm))?.unassociateElement)==null||t.call(e,this),Nm(this,Pm,null)}attributeChangedCallback(e,t,n){var r,i,a,o;[j.MEDIA_PREVIEW_IMAGE,j.MEDIA_PREVIEW_COORDS].includes(e)&&this.update(),e===A.MEDIA_CONTROLLER&&(t&&((i=(r=jm(this,Pm))?.unassociateElement)==null||i.call(r,this),Nm(this,Pm,null)),n&&this.isConnected&&(Nm(this,Pm,this.getRootNode()?.getElementById(n)),(o=(a=jm(this,Pm))?.associateElement)==null||o.call(a,this)))}get mediaPreviewImage(){return R(this,j.MEDIA_PREVIEW_IMAGE)}set mediaPreviewImage(e){z(this,j.MEDIA_PREVIEW_IMAGE,e)}get mediaPreviewCoords(){let e=this.getAttribute(j.MEDIA_PREVIEW_COORDS);if(e)return e.split(/\s+/).map(e=>+e)}set mediaPreviewCoords(e){if(!e){this.removeAttribute(j.MEDIA_PREVIEW_COORDS);return}this.setAttribute(j.MEDIA_PREVIEW_COORDS,e.join(` `))}update(){let e=this.mediaPreviewCoords,t=this.mediaPreviewImage;if(!(e&&t))return;let[n,r,i,a]=e,o=t.split(`#`)[0],s=getComputedStyle(this),{maxWidth:c,maxHeight:l,minWidth:u,minHeight:d}=s,f=s.getPropertyValue(`--media-preview-thumbnail-object-fit`).trim()||`contain`,p,m;if(f===`fill`){let e=parseInt(c)/i,t=parseInt(l)/a,n=parseInt(u)/i,r=parseInt(d)/a;p=e<1?e:Math.max(e,n),m=t<1?t:Math.max(t,r)}else{let e=Math.min(parseInt(c)/i,parseInt(l)/a),t=Math.max(parseInt(u)/i,parseInt(d)/a),n=e<1?e:t>1?t:1;p=n,m=n}let{style:h}=oc(this.shadowRoot,`:host`),g=oc(this.shadowRoot,`img`).style,_=this.shadowRoot.querySelector(`img`),ee=Math.min(p,m)<1?`min`:`max`;h.setProperty(`${ee}-width`,`initial`,`important`),h.setProperty(`${ee}-height`,`initial`,`important`),h.width=`${i*p}px`,h.height=`${a*m}px`;let te=()=>{g.width=`${this.imgWidth*p}px`,g.height=`${this.imgHeight*m}px`,g.display=`block`};_.src!==o&&(_.onload=()=>{this.imgWidth=_.naturalWidth,this.imgHeight=_.naturalHeight,te(),_.onload=null},_.src=o,te()),te(),g.transform=`translate(-${n*p}px, -${r*m}px)`}};Pm=new WeakMap,Im.shadowRootOptions={mode:`open`},Im.getTemplateHTML=Fm,N.customElements.get(`media-preview-thumbnail`)||N.customElements.define(`media-preview-thumbnail`,Im);var Lm=Im,Rm=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},zm=(e,t,n)=>(Rm(e,t,`read from private field`),n?n.call(e):t.get(e)),Bm=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},Vm=(e,t,n,r)=>(Rm(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),Hm,Um=class extends Bf{constructor(){super(),Bm(this,Hm,void 0),Vm(this,Hm,this.shadowRoot.querySelector(`slot`)),zm(this,Hm).textContent=Ns(0)}static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_PREVIEW_TIME]}attributeChangedCallback(e,t,n){super.attributeChangedCallback(e,t,n),e===j.MEDIA_PREVIEW_TIME&&n!=null&&(zm(this,Hm).textContent=Ns(parseFloat(n)))}get mediaPreviewTime(){return P(this,j.MEDIA_PREVIEW_TIME)}set mediaPreviewTime(e){F(this,j.MEDIA_PREVIEW_TIME,e)}};Hm=new WeakMap,N.customElements.get(`media-preview-time-display`)||N.customElements.define(`media-preview-time-display`,Um);var Wm={SEEK_OFFSET:`seekoffset`},Gm=30,Km=e=>`
  <svg aria-hidden="true" viewBox="0 0 20 24">
    ...
    <slot name="icon">${Km(t.seekOffset)}</slot>
  `}var Jm=(e,t)=>{e.setAttribute(`aria-label`,M(`seek back {seekOffset} seconds`,{seekOffset:t}))};function Ym(){return M(`Seek backward`)}var Xm=0,Zm=class extends rd{static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_CURRENT_TIME,Wm.SEEK_OFFSET]}connectedCallback(){super.connectedCallback(),this.seekOffset=P(this,Wm.SEEK_OFFSET,Gm)}attributeChangedCallback(e,t,n){super.attributeChangedCallback(e,t,n),Jm(this,this.seekOffset),e===Wm.SEEK_OFFSET&&(this.seekOffset=P(this,Wm.SEEK_OFFSET,Gm))}get seekOffset(){return P(this,Wm.SEEK_OFFSET,Gm)}set seekOffset(e){F(this,Wm.SEEK_OFFSET,e),this.setAttribute(`aria-label`,M(`seek back {seekOffset} seconds`,{seekOffset:this.seekOffset})),Zs($s(this,`icon`),this.seekOffset)}get mediaCurrentTime(){return P(this,j.MEDIA_CURRENT_TIME,Xm)}set mediaCurrentTime(e){F(this,j.MEDIA_CURRENT_TIME,e)}handleClick(){let e=Math.max(this.mediaCurrentTime-this.seekOffset,0),t=new N.CustomEvent(k.MEDIA_SEEK_REQUEST,{composed:!0,bubbles:!0,detail:e});this.dispatchEvent(t)}};Zm.getSlotTemplateHTML=qm,Zm.getTooltipContentHTML=Ym,N.customElements.get(`media-seek-backward-button`)||N.customElements.define(`media-seek-backward-button`,Zm);var Qm={SEEK_OFFSET:`seekoffset`},$m=30,eh=e=>`
  <svg aria-hidden="true" viewBox="0 0 20 24">
    <defs>
      <style>.text{font-size:8px;font-family:Arial-BoldMT, Arial;font-weight:700;}</style>
    </defs>
  ...
  </svg>`;function th(e,t){return`
    <slot name="icon">${eh(t.seekOffset)}</slot>
  `}var nh=(e,t)=>{e.setAttribute(`aria-label`,M(`seek forward {seekOffset} seconds`,{seekOffset:t}))};function rh(){return M(`Seek forward`)}var ih=0,ah=class extends rd{static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_CURRENT_TIME,Qm.SEEK_OFFSET]}connectedCallback(){super.connectedCallback(),this.seekOffset=P(this,Qm.SEEK_OFFSET,$m)}attributeChangedCallback(e,t,n){super.attributeChangedCallback(e,t,n),nh(this,this.seekOffset),e===Qm.SEEK_OFFSET&&(this.seekOffset=P(this,Qm.SEEK_OFFSET,$m))}get seekOffset(){return P(this,Qm.SEEK_OFFSET,$m)}set seekOffset(e){F(this,Qm.SEEK_OFFSET,e),this.setAttribute(`aria-label`,M(`seek forward {seekOffset} seconds`,{seekOffset:this.seekOffset})),Zs($s(this,`icon`),this.seekOffset)}get mediaCurrentTime(){return P(this,j.MEDIA_CURRENT_TIME,ih)}set mediaCurrentTime(e){F(this,j.MEDIA_CURRENT_TIME,e)}handleClick(){let e=this.mediaCurrentTime+this.seekOffset,t=new N.CustomEvent(k.MEDIA_SEEK_REQUEST,{composed:!0,bubbles:!0,detail:e});this.dispatchEvent(t)}};ah.getSlotTemplateHTML=th,ah.getTooltipContentHTML=rh,N.customElements.get(`media-seek-forward-button`)||N.customElements.define(`media-seek-forward-button`,ah);var oh=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},sh=(e,t,n)=>(oh(e,t,`read from private field`),n?n.call(e):t.get(e)),ch=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},lh=(e,t,n,r)=>(oh(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),uh=(e,t,n)=>(oh(e,t,`access private method`),n),dh,fh,ph,mh,hh,gh,_h,vh,yh,bh,xh,Sh={REMAINING:`remaining`,SHOW_DURATION:`showduration`,NO_TOGGLE:`notoggle`},Ch=[...Object.values(Sh),j.MEDIA_CURRENT_TIME,j.MEDIA_DURATION,j.MEDIA_SEEKABLE],wh=[`Enter`,` `],Th=`&nbsp;/&nbsp;`,Eh=(e,{timesSep:t=Th}={})=>{let n=e.mediaCurrentTime??0,[,r]=e.mediaSeekable??[],i=0;Number.isFinite(e.mediaDuration)?i=e.mediaDuration:Number.isFinite(r)&&(i=r);let a=e.remaining?Ns(0-(i-n)):Ns(n);return e.showDuration?`${a}${t}${Ns(i)}`:a},Dh=e=>{let t=e.mediaCurrentTime,[,n]=e.mediaSeekable??[],r=null;if(Number.isFinite(e.mediaDuration)?r=e.mediaDuration:Number.isFinite(n)&&(r=n),t==null||r===null){e.setAttribute(`aria-description`,M(`video not loaded, unknown time.`));return}let i=e.remaining?Ms(0-(r-t)):Ms(t);if(!e.showDuration){e.setAttribute(`aria-description`,i);return}let a=M(`{currentTime} of {totalTime}`,{currentTime:i,totalTime:Ms(r)});e.setAttribute(`aria-description`,a)};function Oh(e,t){return`
    <slot>${Eh(t)}</slot>
  `}var kh=e=>{e.setAttribute(`aria-label`,M(`playback time`))},Ah=class extends Bf{constructor(){super(),ch(this,mh),ch(this,gh),ch(this,vh),ch(this,bh),ch(this,dh,void 0),ch(this,fh,null),ch(this,ph,e=>{let{metaKey:t,altKey:n,key:r}=e;if(t||n||!wh.includes(r)){this.removeEventListener(`keyup`,sh(this,fh));return}this.addEventListener(`keyup`,sh(this,fh))}),lh(this,dh,this.shadowRoot.querySelector(`slot`)),sh(this,dh).innerHTML=`${Eh(this)}`}static get observedAttributes(){return[...super.observedAttributes,...Ch,`disabled`]}connectedCallback(){let{style:e}=oc(this.shadowRoot,`:host(:hover:not([notoggle]))`);e.setProperty(`cursor`,`var(--media-cursor, pointer)`),e.setProperty(`background`,`var(--media-control-hover-background, rgba(50 50 70 / .7))`),this.setAttribute(`aria-label`,M(`playback time`)),uh(this,vh,yh).call(this),super.connectedCallback()}toggleTimeDisplay(){this.noToggle||(this.hasAttribute(`remaining`)?this.removeAttribute(`remaining`):this.setAttribute(`remaining`,``))}disconnectedCallback(){this.disable(),uh(this,gh,_h).call(this),super.disconnectedCallback()}attributeChangedCallback(e,t,n){kh(this),Ch.includes(e)?this.update():e===`disabled`&&n!==t?n==null?uh(this,vh,yh).call(this):uh(this,bh,xh).call(this):e===Sh.NO_TOGGLE&&n!==t&&(this.noToggle?uh(this,bh,xh).call(this):uh(this,vh,yh).call(this)),super.attributeChangedCallback(e,t,n)}enable(){this.noToggle||(this.tabIndex=0)}disable(){this.tabIndex=-1}get remaining(){return I(this,Sh.REMAINING)}set remaining(e){L(this,Sh.REMAINING,e)}get showDuration(){return I(this,Sh.SHOW_DURATION)}set showDuration(e){L(this,Sh.SHOW_DURATION,e)}get noToggle(){return I(this,Sh.NO_TOGGLE)}set noToggle(e){L(this,Sh.NO_TOGGLE,e)}get mediaDuration(){return P(this,j.MEDIA_DURATION)}set mediaDuration(e){F(this,j.MEDIA_DURATION,e)}get mediaCurrentTime(){return P(this,j.MEDIA_CURRENT_TIME)}set mediaCurrentTime(e){F(this,j.MEDIA_CURRENT_TIME,e)}get mediaSeekable(){let e=this.getAttribute(j.MEDIA_SEEKABLE);if(e)return e.split(`:`).map(e=>+e)}set mediaSeekable(e){if(e==null){this.removeAttribute(j.MEDIA_SEEKABLE);return}this.setAttribute(j.MEDIA_SEEKABLE,e.join(`:`))}update(){let e=Eh(this);Dh(this),e!==sh(this,dh).innerHTML&&(sh(this,dh).innerHTML=e)}};dh=new WeakMap,fh=new WeakMap,ph=new WeakMap,mh=new WeakSet,hh=function(){sh(this,fh)||(lh(this,fh,e=>{let{key:t}=e;if(!wh.includes(t)){this.removeEventListener(`keyup`,sh(this,fh));return}this.toggleTimeDisplay()}),this.addEventListener(`keydown`,sh(this,ph)),this.addEventListener(`click`,this.toggleTimeDisplay))},gh=new WeakSet,_h=function(){sh(this,fh)&&(this.removeEventListener(`keyup`,sh(this,fh)),this.removeEventListener(`keydown`,sh(this,ph)),this.removeEventListener(`click`,this.toggleTimeDisplay),lh(this,fh,null))},vh=new WeakSet,yh=function(){!this.noToggle&&!this.hasAttribute(`disabled`)&&(this.setAttribute(`role`,`button`),this.enable(),uh(this,mh,hh).call(this))},bh=new WeakSet,xh=function(){this.removeAttribute(`role`),this.disable(),uh(this,gh,_h).call(this)},Ah.getSlotTemplateHTML=Oh,N.customElements.get(`media-time-display`)||N.customElements.define(`media-time-display`,Ah);var jh=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},Mh=(e,t,n)=>(jh(e,t,`read from private field`),n?n.call(e):t.get(e)),Nh=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},Ph=(e,t,n,r)=>(jh(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),Fh=(e,t,n,r)=>({set _(r){Ph(e,t,r,n)},get _(){return Mh(e,t,r)}}),Ih,Lh,Rh,zh,Bh,Vh,Hh,Uh,Wh,Gh,Kh=class{constructor(e,t,n){Nh(this,Ih,void 0),Nh(this,Lh,void 0),Nh(this,Rh,void 0),Nh(this,zh,void 0),Nh(this,Bh,void 0),Nh(this,Vh,void 0),Nh(this,Hh,void 0),Nh(this,Uh,void 0),Nh(this,Wh,0),Nh(this,Gh,(e=performance.now())=>{Ph(this,Wh,requestAnimationFrame(Mh(this,Gh))),Ph(this,zh,performance.now()-Mh(this,Rh));let t=1e3/this.fps;if(Mh(this,zh)>t){Ph(this,Rh,e-Mh(this,zh)%t);let n=1e3/((e-Mh(this,Lh))/++Fh(this,Bh)._),r=(e-Mh(this,Vh))/1e3/this.duration,i=Mh(this,Hh)+r*this.playbackRate;i-Mh(this,Ih).valueAsNumber>0?Ph(this,Uh,this.playbackRate/this.duration/n):(Ph(this,Uh,.995*Mh(this,Uh)),i=Mh(this,Ih).valueAsNumber+Mh(this,Uh)),this.callback(i)}}),Ph(this,Ih,e),this.callback=t,this.fps=n}start(){Mh(this,Wh)===0&&(Ph(this,Rh,performance.now()),Ph(this,Lh,Mh(this,Rh)),Ph(this,Bh,0),Mh(this,Gh).call(this))}stop(){Mh(this,Wh)!==0&&(cancelAnimationFrame(Mh(this,Wh)),Ph(this,Wh,0))}update({start:e,duration:t,playbackRate:n}){let r=e-Mh(this,Ih).valueAsNumber,i=Math.abs(t-this.duration);(r>0||r<-.03||i>=.5)&&this.callback(e),Ph(this,Hh,e),Ph(this,Vh,performance.now()),this.duration=t,this.playbackRate=n}};Ih=new WeakMap,Lh=new WeakMap,Rh=new WeakMap,zh=new WeakMap,Bh=new WeakMap,Vh=new WeakMap,Hh=new WeakMap,Uh=new WeakMap,Wh=new WeakMap,Gh=new WeakMap;var qh=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},G=(e,t,n)=>(qh(e,t,`read from private field`),n?n.call(e):t.get(e)),Jh=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},Yh=(e,t,n,r)=>(qh(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),Xh=(e,t,n)=>(qh(e,t,`access private method`),n),Zh,Qh,$h,eg,tg,ng,rg,ig,ag,og,sg,cg,lg,ug,dg,fg,pg,mg,hg,gg,_g,vg,yg,bg,xg,Sg,Cg=e=>{let t=e.range,n=Ms(+Eg(e)),r=Ms(+e.mediaSeekableEnd),i=n&&r?M(`{currentTime} of {totalTime}`,{currentTime:n,totalTime:r}):M(`video not loaded, unknown time.`);t.setAttribute(`aria-valuetext`,i)};function wg(e){return`
    <style>
      :host {
    ...
    <div id="preview-rail">
      <slot name="preview" part="box preview-box">
        <media-preview-thumbnail>
          <template shadowrootmode="${Lm.shadowRootOptions.mode}">
            ${Lm.getTemplateHTML({})}
          </template>
        </media-preview-thumbnail>
  ...
  `}var Tg=(e,t=e.mediaCurrentTime)=>{let n=Number.isFinite(e.mediaSeekableStart)?e.mediaSeekableStart:0,r=Number.isFinite(e.mediaDuration)?e.mediaDuration:e.mediaSeekableEnd;if(Number.isNaN(r))return 0;let i=(t-n)/(r-n);return Math.max(0,Math.min(i,1))},Eg=(e,t=e.range.valueAsNumber)=>{let n=Number.isFinite(e.mediaSeekableStart)?e.mediaSeekableStart:0,r=Number.isFinite(e.mediaDuration)?e.mediaDuration:e.mediaSeekableEnd;return Number.isNaN(r)?0:t*(r-n)+n},Dg=class extends Tf{constructor(){super(),Jh(this,cg),Jh(this,dg),Jh(this,pg),Jh(this,hg),Jh(this,_g),Jh(this,yg),Jh(this,xg),Jh(this,Zh,null),Jh(this,Qh,void 0),Jh(this,$h,void 0),Jh(this,eg,void 0),Jh(this,tg,void 0),Jh(this,ng,void 0),Jh(this,rg,void 0),Jh(this,ig,void 0),Jh(this,ag,void 0),Jh(this,og,void 0),Jh(this,sg,()=>{Xh(this,cg,lg).call(this)?G(this,Qh).start():G(this,Qh).stop()}),Jh(this,ug,e=>{this.dragging||(Cs(e)&&(this.range.valueAsNumber=e),G(this,og)||this.updateBar())}),this.shadowRoot.querySelector(`#track`).insertAdjacentHTML(`afterbegin`,`<div id="buffered" part="buffered"></div>`),Yh(this,$h,this.shadowRoot.querySelectorAll(`[part~="box"]`)),Yh(this,tg,this.shadowRoot.querySelector(`[part~="preview-box"]`)),Yh(this,ng,this.shadowRoot.querySelector(`[part~="current-box"]`));let e=getComputedStyle(this);Yh(this,rg,parseInt(e.getPropertyValue(`--media-box-padding-left`))),Yh(this,ig,parseInt(e.getPropertyValue(`--media-box-padding-right`))),Yh(this,Qh,new Kh(this.range,G(this,ug),60))}static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_PAUSED,j.MEDIA_DURATION,j.MEDIA_SEEKABLE,j.MEDIA_CURRENT_TIME,j.MEDIA_PREVIEW_IMAGE,j.MEDIA_PREVIEW_TIME,j.MEDIA_PREVIEW_CHAPTER,j.MEDIA_BUFFERED,j.MEDIA_PLAYBACK_RATE,j.MEDIA_LOADING,j.MEDIA_ENDED]}connectedCallback(){var e;super.connectedCallback(),this.range.setAttribute(`aria-label`,M(`seek`)),G(this,sg).call(this),Yh(this,Zh,this.getRootNode()),(e=G(this,Zh))==null||e.addEventListener(`transitionstart`,this)}disconnectedCallback(){var e;super.disconnectedCallback(),G(this,Qh).stop(),(e=G(this,Zh))==null||e.removeEventListener(`transitionstart`,this),Yh(this,Zh,null)}attributeChangedCallback(e,t,n){super.attributeChangedCallback(e,t,n),t!=n&&(e===j.MEDIA_CURRENT_TIME||e===j.MEDIA_PAUSED||e===j.MEDIA_ENDED||e===j.MEDIA_LOADING||e===j.MEDIA_DURATION||e===j.MEDIA_SEEKABLE?(G(this,Qh).update({start:Tg(this),duration:this.mediaSeekableEnd-this.mediaSeekableStart,playbackRate:this.mediaPlaybackRate}),G(this,sg).call(this),Cg(this)):e===j.MEDIA_BUFFERED&&this.updateBufferedBar(),(e===j.MEDIA_DURATION||e===j.MEDIA_SEEKABLE)&&(this.mediaChaptersCues=G(this,ag),this.updateBar()))}get mediaChaptersCues(){return G(this,ag)}set mediaChaptersCues(e){Yh(this,ag,e),this.updateSegments(G(this,ag)?.map(e=>({start:Tg(this,e.startTime),end:Tg(this,e.endTime)})))}get mediaPaused(){return I(this,j.MEDIA_PAUSED)}set mediaPaused(e){L(this,j.MEDIA_PAUSED,e)}get mediaLoading(){return I(this,j.MEDIA_LOADING)}set mediaLoading(e){L(this,j.MEDIA_LOADING,e)}get mediaDuration(){return P(this,j.MEDIA_DURATION)}set mediaDuration(e){F(this,j.MEDIA_DURATION,e)}get mediaCurrentTime(){return P(this,j.MEDIA_CURRENT_TIME)}set mediaCurrentTime(e){F(this,j.MEDIA_CURRENT_TIME,e)}get mediaPlaybackRate(){return P(this,j.MEDIA_PLAYBACK_RATE,1)}set mediaPlaybackRate(e){F(this,j.MEDIA_PLAYBACK_RATE,e)}get mediaBuffered(){let e=this.getAttribute(j.MEDIA_BUFFERED);return e?e.split(` `).map(e=>e.split(`:`).map(e=>+e)):[]}set mediaBuffered(e){if(!e){this.removeAttribute(j.MEDIA_BUFFERED);return}let t=e.map(e=>e.join(`:`)).join(` `);this.setAttribute(j.MEDIA_BUFFERED,t)}get mediaSeekable(){let e=this.getAttribute(j.MEDIA_SEEKABLE);if(e)return e.split(`:`).map(e=>+e)}set mediaSeekable(e){if(e==null){this.removeAttribute(j.MEDIA_SEEKABLE);return}this.setAttribute(j.MEDIA_SEEKABLE,e.join(`:`))}get mediaSeekableEnd(){let[,e=this.mediaDuration]=this.mediaSeekable??[];return e}get mediaSeekableStart(){let[e=0]=this.mediaSeekable??[];return e}get mediaPreviewImage(){return R(this,j.MEDIA_PREVIEW_IMAGE)}set mediaPreviewImage(e){z(this,j.MEDIA_PREVIEW_IMAGE,e)}get mediaPreviewTime(){return P(this,j.MEDIA_PREVIEW_TIME)}set mediaPreviewTime(e){F(this,j.MEDIA_PREVIEW_TIME,e)}get mediaEnded(){return I(this,j.MEDIA_ENDED)}set mediaEnded(e){L(this,j.MEDIA_ENDED,e)}updateBar(){super.updateBar(),this.updateBufferedBar(),this.updateCurrentBox()}updateBufferedBar(){let e=this.mediaBuffered;if(!e.length)return;let t;if(this.mediaEnded)t=1;else{let n=this.mediaCurrentTime,[,r=this.mediaSeekableStart]=e.find(([e,t])=>e<=n&&n<=t)??[];t=Tg(this,r)}let{style:n}=oc(this.shadowRoot,`#buffered`);n.setProperty(`width`,`${t*100}%`)}updateCurrentBox(){if(!this.shadowRoot.querySelector(`slot[name="current"]`).assignedElements().length)return;let e=oc(this.shadowRoot,`#current-rail`),t=oc(this.shadowRoot,`[part~="current-box"]`),n=Xh(this,dg,fg).call(this,G(this,ng)),r=Xh(this,pg,mg).call(this,n,this.range.valueAsNumber),i=Xh(this,hg,gg).call(this,n,this.range.valueAsNumber);e.style.transform=`translateX(${r})`,e.style.setProperty(`--_range-width`,`${n.range.width}`),t.style.setProperty(`--_box-shift`,`${i}`),t.style.setProperty(`--_box-width`,`${n.box.width}px`),t.style.setProperty(`visibility`,`initial`)}handleEvent(e){switch(super.handleEvent(e),e.type){case`input`:Xh(this,xg,Sg).call(this);break;case`pointermove`:Xh(this,_g,vg).call(this,e);break;case`pointerup`:G(this,og)&&Yh(this,og,!1);break;case`pointerdown`:Yh(this,og,!0);break;case`pointerleave`:Xh(this,yg,bg).call(this,null);break;case`transitionstart`:ec(e.target,this)&&setTimeout(()=>G(this,sg).call(this),0);break}}};Zh=new WeakMap,Qh=new WeakMap,$h=new WeakMap,eg=new WeakMap,tg=new WeakMap,ng=new WeakMap,rg=new WeakMap,ig=new WeakMap,ag=new WeakMap,og=new WeakMap,sg=new WeakMap,cg=new WeakSet,lg=function(){return this.isConnected&&!this.mediaPaused&&!this.mediaLoading&&!this.mediaEnded&&this.mediaSeekableEnd>0&&ic(this)},ug=new WeakMap,dg=new WeakSet,fg=function(e){let t=((this.getAttribute(`bounds`)?tc(this,`#${this.getAttribute(`bounds`)}`):this.parentElement)??this).getBoundingClientRect(),n=this.range.getBoundingClientRect(),r=e.offsetWidth;return{box:{width:r,min:-(n.left-t.left-r/2),max:t.right-n.left-r/2},bounds:t,range:n}},pg=new WeakSet,mg=function(e,t){let n=`${t*100}%`,{width:r,min:i,max:a}=e.box;if(!r)return n;if(Number.isNaN(i)||(n=`max(${`calc(1 / var(--_range-width) * 100 * ${i}% + var(--media-box-padding-left))`}, ${n})`),!Number.isNaN(a)){let e=`calc(1 / var(--_range-width) * 100 * ${a}% - var(--media-box-padding-right))`;n=`min(${n}, ${e})`}return n},hg=new WeakSet,gg=function(e,t){let{width:n,min:r,max:i}=e.box,a=t*e.range.width;if(a<r+G(this,rg)){let t=e.range.left-e.bounds.left-G(this,rg);return`${a-n/2+t}px`}if(a>i-G(this,ig)){let t=e.bounds.right-e.range.right-G(this,ig);return`${a+n/2-t-e.range.width}px`}return 0},_g=new WeakSet,vg=function(e){let t=[...G(this,$h)].some(t=>e.composedPath().includes(t));if(!this.dragging&&(t||!e.composedPath().includes(this))){Xh(this,yg,bg).call(this,null);return}let n=this.mediaSeekableEnd;if(!n)return;let r=oc(this.shadowRoot,`#preview-rail`),i=oc(this.shadowRoot,`[part~="preview-box"]`),a=Xh(this,dg,fg).call(this,G(this,tg)),o=(e.clientX-a.range.left)/a.range.width;o=Math.max(0,Math.min(1,o));let s=Xh(this,pg,mg).call(this,a,o),c=Xh(this,hg,gg).call(this,a,o);r.style.transform=`translateX(${s})`,r.style.setProperty(`--_range-width`,`${a.range.width}`),i.style.setProperty(`--_box-shift`,`${c}`),i.style.setProperty(`--_box-width`,`${a.box.width}px`);let l=Math.round(G(this,eg))-Math.round(o*n);Math.abs(l)<1&&o>.01&&o<.99||(Yh(this,eg,o*n),Xh(this,yg,bg).call(this,G(this,eg)))},yg=new WeakSet,bg=function(e){this.dispatchEvent(new N.CustomEvent(k.MEDIA_PREVIEW_REQUEST,{composed:!0,bubbles:!0,detail:e}))},xg=new WeakSet,Sg=function(){G(this,Qh).stop();let e=Eg(this);this.dispatchEvent(new N.CustomEvent(k.MEDIA_SEEK_REQUEST,{composed:!0,bubbles:!0,detail:e}))},Dg.shadowRootOptions={mode:`open`},Dg.getContainerTemplateHTML=wg,N.customElements.get(`media-time-range`)||N.customElements.define(`media-time-range`,Dg);var Og=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},kg=(e,t,n)=>(Og(e,t,`read from private field`),n?n.call(e):t.get(e)),Ag=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},jg,Mg=1,Ng=e=>e.mediaMuted?0:e.mediaVolume,Pg=e=>`${Math.round(e*100)}%`,Fg=class extends Tf{constructor(){super(...arguments),Ag(this,jg,()=>{let e=this.range.value,t=new N.CustomEvent(k.MEDIA_VOLUME_REQUEST,{composed:!0,bubbles:!0,detail:e});this.dispatchEvent(t)})}static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_VOLUME,j.MEDIA_MUTED,j.MEDIA_VOLUME_UNAVAILABLE]}connectedCallback(){super.connectedCallback(),this.range.setAttribute(`aria-label`,M(`volume`)),this.range.addEventListener(`input`,kg(this,jg))}disconnectedCallback(){this.range.removeEventListener(`input`,kg(this,jg)),super.disconnectedCallback()}attributeChangedCallback(e,t,n){super.attributeChangedCallback(e,t,n),(e===j.MEDIA_VOLUME||e===j.MEDIA_MUTED)&&(this.range.valueAsNumber=Ng(this),this.range.setAttribute(`aria-valuetext`,Pg(this.range.valueAsNumber)),this.updateBar())}get mediaVolume(){return P(this,j.MEDIA_VOLUME,Mg)}set mediaVolume(e){F(this,j.MEDIA_VOLUME,e)}get mediaMuted(){return I(this,j.MEDIA_MUTED)}set mediaMuted(e){L(this,j.MEDIA_MUTED,e)}get mediaVolumeUnavailable(){return R(this,j.MEDIA_VOLUME_UNAVAILABLE)}set mediaVolumeUnavailable(e){z(this,j.MEDIA_VOLUME_UNAVAILABLE,e)}};jg=new WeakMap,N.customElements.get(`media-volume-range`)||N.customElements.define(`media-volume-range`,Fg);function Ig(e){return`
      <style>
        :host {
          min-width: 4ch;
          padding: var(--media-button-padding, var(--media-control-padding, 10px 5px));
    ...
    `}function Lg(){return M(`Loop`)}var Rg=class extends rd{constructor(){super(...arguments),this.container=null}static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_LOOP]}connectedCallback(){super.connectedCallback(),this.container=this.shadowRoot?.querySelector(`#icon`)||null,this.container&&(this.container.textContent=M(`Loop`))}attributeChangedCallback(e,t,n){super.attributeChangedCallback(e,t,n),e===j.MEDIA_LOOP&&this.container&&this.setAttribute(`aria-checked`,this.mediaLoop?`true`:`false`)}get mediaLoop(){return I(this,j.MEDIA_LOOP)}set mediaLoop(e){L(this,j.MEDIA_LOOP,e)}handleClick(){let e=!this.mediaLoop,t=new N.CustomEvent(k.MEDIA_LOOP_REQUEST,{composed:!0,bubbles:!0,detail:e});this.dispatchEvent(t)}};Rg.getSlotTemplateHTML=Ig,Rg.getTooltipContentHTML=Lg,N.customElements.get(`media-loop-button`)||N.customElements.define(`media-loop-button`,Rg);var zg=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},K=(e,t,n)=>(zg(e,t,`read from private field`),n?n.call(e):t.get(e)),Bg=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},Vg=(e,t,n,r)=>(zg(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),Hg,Ug,Wg,Gg,Kg,qg,Jg,Yg,Xg,Zg,Qg,$g=1,e_=0,t_=1,n_={processCallback(e,t,n){if(n){for(let[e,r]of t)if(e in n){let t=n[e];typeof t==`boolean`&&r instanceof d_&&typeof r.element[r.attributeName]==`boolean`?r.booleanValue=t:typeof t==`function`&&r instanceof d_?r.element[r.attributeName]=t:r.value=t}}}},r_=class extends N.DocumentFragment{constructor(e,t,n=n_){var r;super(),Bg(this,Hg,void 0),Bg(this,Ug,void 0),this.append(e.content.cloneNode(!0)),Vg(this,Hg,i_(this)),Vg(this,Ug,n),(r=n.createCallback)==null||r.call(n,this,K(this,Hg),t),n.processCallback(this,K(this,Hg),t)}update(e){K(this,Ug).processCallback(this,K(this,Hg),e)}};Hg=new WeakMap,Ug=new WeakMap;var i_=(e,t=[])=>{let n,r;for(let i of e.attributes||[])if(i.value.includes(`{{`)){let a=new u_;for([n,r]of o_(i.value))if(!n)a.append(r);else{let n=new d_(e,i.name,i.namespaceURI);a.append(n),t.push([r,n])}i.value=a.toString()}for(let i of e.childNodes)if(i.nodeType===$g&&!(i instanceof HTMLTemplateElement))i_(i,t);else{let a=i.data;if(i.nodeType===$g||a.includes(`{{`)){let o=[];if(a)for([n,r]of o_(a))if(!n)o.push(new Text(r));else{let n=new f_(e);o.push(n),t.push([r,n])}else if(i instanceof HTMLTemplateElement){let n=new p_(e,i);o.push(n),t.push([n.expression,n])}i.replaceWith(...o.flatMap(e=>e.replacementNodes||[e]))}}return t},a_={},o_=e=>{let t=``,n=0,r=a_[e],i=0,a;if(r)return r;for(r=[];a=e[i];i++)a===`{`&&e[i+1]===`{`&&e[i-1]!==`\\`&&e[i+2]&&++n==1?(t&&r.push([e_,t]),t=``,i++):a===`}`&&e[i+1]===`}`&&e[i-1]!==`\\`&&!--n?(r.push([t_,t.trim()]),t=``,i++):t+=a||``;return t&&r.push([e_,(n>0?`{{`:``)+t]),a_[e]=r},s_=11,c_=class{get value(){return``}set value(e){}toString(){return this.value}},l_=new WeakMap,u_=class{constructor(){Bg(this,Wg,[])}[Symbol.iterator](){return K(this,Wg).values()}get length(){return K(this,Wg).length}item(e){return K(this,Wg)[e]}append(...e){for(let t of e)t instanceof d_&&l_.set(t,this),K(this,Wg).push(t)}toString(){return K(this,Wg).join(``)}};Wg=new WeakMap;var d_=class extends c_{constructor(e,t,n){super(),Bg(this,Yg),Bg(this,Gg,``),Bg(this,Kg,void 0),Bg(this,qg,void 0),Bg(this,Jg,void 0),Vg(this,Kg,e),Vg(this,qg,t),Vg(this,Jg,n)}get attributeName(){return K(this,qg)}get attributeNamespace(){return K(this,Jg)}get element(){return K(this,Kg)}get value(){return K(this,Gg)}set value(e){K(this,Gg)!==e&&(Vg(this,Gg,e),!K(this,Yg,Xg)||K(this,Yg,Xg).length===1?e==null?K(this,Kg).removeAttributeNS(K(this,Jg),K(this,qg)):K(this,Kg).setAttributeNS(K(this,Jg),K(this,qg),e):K(this,Kg).setAttributeNS(K(this,Jg),K(this,qg),K(this,Yg,Xg).toString()))}get booleanValue(){return K(this,Kg).hasAttributeNS(K(this,Jg),K(this,qg))}set booleanValue(e){if(!K(this,Yg,Xg)||K(this,Yg,Xg).length===1)this.value=e?``:null;else throw new DOMException(`Value is not fully templatized`)}};Gg=new WeakMap,Kg=new WeakMap,qg=new WeakMap,Jg=new WeakMap,Yg=new WeakSet,Xg=function(){return l_.get(this)};var f_=class extends c_{constructor(e,t){super(),Bg(this,Zg,void 0),Bg(this,Qg,void 0),Vg(this,Zg,e),Vg(this,Qg,t?[...t]:[new Text])}get replacementNodes(){return K(this,Qg)}get parentNode(){return K(this,Zg)}get nextSibling(){return K(this,Qg)[K(this,Qg).length-1].nextSibling}get previousSibling(){return K(this,Qg)[0].previousSibling}get value(){return K(this,Qg).map(e=>e.textContent).join(``)}set value(e){this.replace(e)}replace(...e){let t=e.flat().flatMap(e=>e==null?[new Text]:e.forEach?[...e]:e.nodeType===s_?[...e.childNodes]:e.nodeType?[e]:[new Text(e)]);t.length||t.push(new Text),Vg(this,Qg,m_(K(this,Qg)[0].parentNode,K(this,Qg),t,this.nextSibling))}};Zg=new WeakMap,Qg=new WeakMap;var p_=class extends f_{constructor(e,t){let n=t.getAttribute(`directive`)||t.getAttribute(`type`),r=t.getAttribute(`expression`)||t.getAttribute(n)||``;r.startsWith(`{{`)&&(r=r.trim().slice(2,-2).trim()),super(e),this.expression=r,this.template=t,this.directive=n}};function m_(e,t,n,r=null){let i=0,a,o,s,c=n.length,l=t.length;for(;i<c&&i<l&&t[i]==n[i];)i++;for(;i<c&&i<l&&n[c-1]==t[l-1];)r=n[--l,--c];if(i==l)for(;i<c;)e.insertBefore(n[i++],r);if(i==c)for(;i<l;)e.removeChild(t[i++]);else{for(a=t[i];i<c;)s=n[i++],o=a?a.nextSibling:r,a==s?a=o:i<c&&n[i]==o?(e.replaceChild(s,a),a=o):e.insertBefore(s,a);for(;a!=r;)o=a.nextSibling,e.removeChild(a),a=o}return n}var h_={string:e=>String(e)},g_=class{constructor(e){this.template=e,this.state=void 0}},__=new WeakMap,v_=new WeakMap,y_={partial:(e,t)=>{t[e.expression]=new g_(e.template)},if:(e,t)=>{var n;if(w_(e.expression,t))if(__.get(e)!==e.template){__.set(e,e.template);let n=new r_(e.template,t,x_);e.replace(n),v_.set(e,n)}else (n=v_.get(e))==null||n.update(t);else e.replace(``),__.delete(e),v_.delete(e)}},b_=Object.keys(y_),x_={processCallback(e,t,n){var r,i;if(n)for(let[e,a]of t){if(a instanceof p_){if(!a.directive){let e=b_.find(e=>a.template.hasAttribute(e));e&&(a.directive=e,a.expression=a.template.getAttribute(e))}(r=y_[a.directive])==null||r.call(y_,a,n);continue}let t=w_(e,n);if(t instanceof g_){__.get(a)===t.template?(i=v_.get(a))==null||i.update(t.state):(__.set(a,t.template),t=new r_(t.template,t.state,x_),a.value=t,v_.set(a,t));continue}t?(a instanceof d_&&a.attributeName.startsWith(`aria-`)&&(t=String(t)),a instanceof d_?typeof t==`boolean`?a.booleanValue=t:typeof t==`function`?a.element[a.attributeName]=t:a.value=t:(a.value=t,__.delete(a),v_.delete(a))):a instanceof d_?a.value=void 0:(a.value=void 0,__.delete(a),v_.delete(a))}}},S_={"!":e=>!e,"!!":e=>!!e,"==":(e,t)=>e==t,"!=":(e,t)=>e!=t,">":(e,t)=>e>t,">=":(e,t)=>e>=t,"<":(e,t)=>e<t,"<=":(e,t)=>e<=t,"??":(e,t)=>e??t,"|":(e,t)=>h_[t]?.call(h_,e)};function C_(e){return O_(e,{boolean:/true|false/,number:/-?\d+\.?\d*/,string:/(["'])((?:\\.|[^\\])*?)\1/,operator:/[!=><][=!]?|\?\?|\|/,ws:/\s+/,param:/[$a-z_][$\w]*/i}).filter(({type:e})=>e!==`ws`)}function w_(e,t={}){let n=C_(e);if(n.length===0||n.some(({type:e})=>!e))return T_(e);if(n[0]?.token===`>`){let r=t[n[1]?.token];if(!r)return T_(e);let i={...t};r.state=i;let a=n.slice(2);for(let e=0;e<a.length;e+=3){let n=a[e]?.token,r=a[e+1]?.token,o=a[e+2]?.token;n&&r===`=`&&(i[n]=D_(o,t))}return r}if(n.length===1)return E_(n[0])?D_(n[0].token,t):T_(e);if(n.length===2){let r=S_[n[0]?.token];return!r||!E_(n[1])?T_(e):r(D_(n[1].token,t))}if(n.length===3){let r=n[1]?.token,i=S_[r];if(!i||!E_(n[0])||!E_(n[2]))return T_(e);let a=D_(n[0].token,t);return r===`|`?i(a,n[2].token):i(a,D_(n[2].token,t))}}function T_(e){return console.warn(`Warning: invalid expression \`${e}\``),!1}function E_({type:e}){return[`number`,`boolean`,`string`,`param`].includes(e)}function D_(e,t){let n=e[0],r=e.slice(-1);return e===`true`||e===`false`?e===`true`:n===r&&[`'`,`"`].includes(n)?e.slice(1,-1):ws(e)?parseFloat(e):t[e]}function O_(e,t){let n,r,i,a=[];for(;e;){i=null,n=e.length;for(let a in t)r=t[a].exec(e),r&&r.index<n&&(i={token:r[0],type:a,matches:r.slice(1)},n=r.index);n&&a.push({token:e.substr(0,n),type:void 0}),i&&a.push(i),e=e.substr(n+(i?i.token.length:0))}return a}var k_=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},A_=(e,t,n)=>(k_(e,t,`read from private field`),n?n.call(e):t.get(e)),j_=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},M_=(e,t,n,r)=>(k_(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),N_=(e,t,n)=>(k_(e,t,`access private method`),n),P_,F_,I_,L_,R_,z_,B_,V_,H_,U_={mediatargetlivewindow:`targetlivewindow`,mediastreamtype:`streamtype`},W_=Hs.createElement(`template`);W_.innerHTML=`
  <style>
    :host {
      display: inline-block;
      line-height: 0;
...
`;var G_=class extends N.HTMLElement{constructor(){super(),j_(this,R_),j_(this,B_),j_(this,P_,void 0),j_(this,F_,void 0),j_(this,I_,void 0),j_(this,L_,void 0),j_(this,H_,void 0),this.shadowRoot?this.renderRoot=this.shadowRoot:(this.renderRoot=this.attachShadow({mode:`open`}),this.createRenderer()),M_(this,L_,new MutationObserver(e=>{this.mediaController&&!this.mediaController?.breakpointsComputed||e.some(e=>{let t=e.target;return t===this?!0:t.localName===`media-controller`?!!(U_[e.attributeName]||e.attributeName.startsWith(`breakpoint`)):!1})&&this.render()})),M_(this,H_,this.render.bind(this)),N_(this,R_,z_).call(this,`template`)}get mediaController(){return this.renderRoot.querySelector(`media-controller`)}get template(){return A_(this,P_)??this.constructor.template}set template(e){if(e===null){this.removeAttribute(`template`);return}typeof e==`string`?this.setAttribute(`template`,e):e instanceof HTMLTemplateElement&&(M_(this,P_,e),M_(this,I_,null),this.createRenderer())}get props(){let e=[...Array.from(this.mediaController?.attributes??[]).filter(({name:e})=>U_[e]||e.startsWith(`breakpoint`)),...Array.from(this.attributes)],t={};for(let n of e){let e=U_[n.name]??Ss(n.name),{value:r}=n;r==null?t[e]=!1:(ws(r)&&(r=parseFloat(r)),t[e]=r===``?!0:r)}return t}attributeChangedCallback(e,t,n){e===`template`&&t!=n&&N_(this,B_,V_).call(this)}connectedCallback(){this.addEventListener(os.BREAKPOINTS_COMPUTED,A_(this,H_)),A_(this,L_).observe(this,{attributes:!0}),A_(this,L_).observe(this.renderRoot,{attributes:!0,subtree:!0}),N_(this,B_,V_).call(this)}disconnectedCallback(){this.removeEventListener(os.BREAKPOINTS_COMPUTED,A_(this,H_)),A_(this,L_).disconnect()}createRenderer(){this.template instanceof HTMLTemplateElement&&this.template!==A_(this,F_)&&(M_(this,F_,this.template),this.renderer=new r_(this.template,this.props,this.constructor.processor),this.renderRoot.textContent=``,this.renderRoot.append(W_.content.cloneNode(!0),this.renderer))}render(){var e;(e=this.renderer)==null||e.update(this.props)}};P_=new WeakMap,F_=new WeakMap,I_=new WeakMap,L_=new WeakMap,R_=new WeakSet,z_=function(e){if(Object.prototype.hasOwnProperty.call(this,e)){let t=this[e];delete this[e],this[e]=t}},B_=new WeakSet,V_=function(){let e=this.getAttribute(`template`);if(!e||e===A_(this,I_))return;let t=this.getRootNode(),n=(t?.getElementById)?.call(t,e);if(n){M_(this,I_,e),M_(this,P_,n),this.createRenderer();return}K_(e)&&(M_(this,I_,e),q_(e).then(e=>{let t=Hs.createElement(`template`);t.innerHTML=e,M_(this,P_,t),this.createRenderer()}).catch(console.error))},H_=new WeakMap,G_.observedAttributes=[`template`],G_.processor=x_;function K_(e){if(!/^(\/|\.\/|https?:\/\/)/.test(e))return!1;let t=/^https?:\/\//.test(e)?void 0:location.origin;try{new URL(e,t)}catch{return!1}return!0}async function q_(e){let t=await fetch(e);if(t.status!==200)throw Error(`Failed to load resource: the server responded with a status of ${t.status}`);return t.text()}N.customElements.get(`media-theme`)||N.customElements.define(`media-theme`,G_);function J_({anchor:e,floating:t,placement:n}){let{x:r,y:i}=Z_(Y_({anchor:e,floating:t}),n);return{x:r,y:i}}function Y_({anchor:e,floating:t}){return{anchor:X_(e,t.offsetParent),floating:{x:0,y:0,width:t.offsetWidth,height:t.offsetHeight}}}function X_(e,t){let n=e.getBoundingClientRect(),r=t?.getBoundingClientRect()??{x:0,y:0};return{x:n.x-r.x,y:n.y-r.y,width:n.width,height:n.height}}function Z_({anchor:e,floating:t},n){let r=$_(n)===`x`?`y`:`x`,i=r===`y`?`height`:`width`,a=Q_(n),o=e.x+e.width/2-t.width/2,s=e.y+e.height/2-t.height/2,c=e[i]/2-t[i]/2,l;switch(a){case`top`:l={x:o,y:e.y-t.height};break;case`bottom`:l={x:o,y:e.y+e.height};break;case`right`:l={x:e.x+e.width,y:s};break;case`left`:l={x:e.x-t.width,y:s};break;default:l={x:e.x,y:e.y}}switch(n.split(`-`)[1]){case`start`:l[r]-=c;break;case`end`:l[r]+=c;break}return l}function Q_(e){return e.split(`-`)[0]}function $_(e){return[`top`,`bottom`].includes(Q_(e))?`y`:`x`}var ev=class extends Event{constructor({action:e=`auto`,relatedTarget:t,...n}){super(`invoke`,n),this.action=e,this.relatedTarget=t}},tv=class extends Event{constructor({newState:e,oldState:t,...n}){super(`toggle`,n),this.newState=e,this.oldState=t}},nv=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},q=(e,t,n)=>(nv(e,t,`read from private field`),n?n.call(e):t.get(e)),J=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},rv=(e,t,n,r)=>(nv(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),Y=(e,t,n)=>(nv(e,t,`access private method`),n),iv,av,ov,sv,cv,lv,uv,dv,fv,pv,mv,hv,gv,_v,vv,yv,bv,xv,Sv,Cv,wv,Tv,Ev,Dv,Ov,kv,Av,jv,Mv,Nv,Pv,Fv,Iv,Lv,Rv,zv,Bv,Vv,Hv,Uv,Wv,Gv,Kv,qv,Jv,Yv;function Xv({type:e,text:t,value:n,checked:r}){let i=Hs.createElement(`media-chrome-menu-item`);i.type=e??``,i.part.add(`menu-item`),e&&i.part.add(e),i.value=n,i.checked=r;let a=Hs.createElement(`span`);return a.textContent=t,i.append(a),i}function Zv(e,t){let n=e.querySelector(`:scope > [slot="${t}"]`);if(n?.nodeName==`SLOT`&&(n=n.assignedElements({flatten:!0})[0]),n)return n=n.cloneNode(!0),n;let r=e.shadowRoot.querySelector(`[name="${t}"] > svg`);return r?r.cloneNode(!0):``}function Qv(e){return`
    <style>
      :host {
        font: var(--media-font,
          var(--media-font-weight, normal)
  ...
  `}var $v={STYLE:`style`,HIDDEN:`hidden`,DISABLED:`disabled`,ANCHOR:`anchor`},ey=class extends N.HTMLElement{constructor(){if(super(),J(this,dv),J(this,pv),J(this,gv),J(this,vv),J(this,bv),J(this,Sv),J(this,Ev),J(this,Ov),J(this,Av),J(this,Mv),J(this,Pv),J(this,Iv),J(this,Rv),J(this,Bv),J(this,Hv),J(this,Wv),J(this,Kv),J(this,Jv),J(this,iv,null),J(this,av,null),J(this,ov,null),J(this,sv,new Set),J(this,cv,void 0),J(this,lv,!1),J(this,uv,null),J(this,hv,()=>{let e=q(this,sv),t=new Set(this.items);for(let n of e)t.has(n)||this.dispatchEvent(new CustomEvent(`removemenuitem`,{detail:n}));for(let n of t)e.has(n)||this.dispatchEvent(new CustomEvent(`addmenuitem`,{detail:n}));rv(this,sv,t)}),J(this,wv,()=>{Y(this,Ev,Dv).call(this),Y(this,Ov,kv).call(this,!1)}),J(this,Tv,()=>{Y(this,Ev,Dv).call(this)}),!this.shadowRoot){this.attachShadow(this.constructor.shadowRootOptions);let e=Js(this.attributes);this.shadowRoot.innerHTML=this.constructor.getTemplateHTML(e)}this.container=this.shadowRoot.querySelector(`#container`),this.defaultSlot=this.shadowRoot.querySelector(`slot:not([name])`),rv(this,cv,new MutationObserver(q(this,hv)))}static get observedAttributes(){return[$v.DISABLED,$v.HIDDEN,$v.STYLE,$v.ANCHOR,A.MEDIA_CONTROLLER]}static formatMenuItemText(e,t){return e}enable(){this.addEventListener(`click`,this),this.addEventListener(`focusout`,this),this.addEventListener(`keydown`,this),this.addEventListener(`invoke`,this),this.addEventListener(`toggle`,this)}disable(){this.removeEventListener(`click`,this),this.removeEventListener(`focusout`,this),this.removeEventListener(`keyup`,this),this.removeEventListener(`invoke`,this),this.removeEventListener(`toggle`,this)}handleEvent(e){switch(e.type){case`slotchange`:Y(this,dv,fv).call(this,e);break;case`invoke`:Y(this,vv,yv).call(this,e);break;case`click`:Y(this,Av,jv).call(this,e);break;case`toggle`:Y(this,Pv,Fv).call(this,e);break;case`focusout`:Y(this,Rv,zv).call(this,e);break;case`keydown`:Y(this,Bv,Vv).call(this,e);break}}connectedCallback(){var e,t;q(this,cv).observe(this.defaultSlot,{childList:!0}),rv(this,uv,cc(this.shadowRoot,`:host`)),Y(this,gv,_v).call(this),this.hasAttribute(`disabled`)||this.enable(),this.role||=`menu`,rv(this,iv,Xs(this)),(t=(e=q(this,iv))?.associateElement)==null||t.call(e,this),this.hidden||(Ks(ny(this),q(this,wv)),Ks(this,q(this,Tv))),Y(this,pv,mv).call(this),this.shadowRoot.addEventListener(`slotchange`,this)}disconnectedCallback(){var e,t;q(this,cv).disconnect(),qs(ny(this),q(this,wv)),qs(this,q(this,Tv)),this.disable(),(t=(e=q(this,iv))?.unassociateElement)==null||t.call(e,this),rv(this,iv,null),rv(this,av,null),rv(this,ov,null),this.shadowRoot.removeEventListener(`slotchange`,this)}attributeChangedCallback(e,t,n){var r,i,a,o;e===$v.HIDDEN&&n!==t?(q(this,lv)||rv(this,lv,!0),this.hidden?Y(this,Sv,Cv).call(this):Y(this,bv,xv).call(this),this.dispatchEvent(new tv({oldState:this.hidden?`open`:`closed`,newState:this.hidden?`closed`:`open`,bubbles:!0}))):e===A.MEDIA_CONTROLLER?(t&&((i=(r=q(this,iv))?.unassociateElement)==null||i.call(r,this),rv(this,iv,null)),n&&this.isConnected&&(rv(this,iv,Xs(this)),(o=(a=q(this,iv))?.associateElement)==null||o.call(a,this))):e===$v.DISABLED&&n!==t?n==null?this.enable():this.disable():e===$v.STYLE&&n!==t&&Y(this,gv,_v).call(this)}formatMenuItemText(e,t){return this.constructor.formatMenuItemText(e,t)}get anchor(){return this.getAttribute(`anchor`)}set anchor(e){this.setAttribute(`anchor`,`${e}`)}get anchorElement(){return this.anchor?rc(this)?.querySelector(`#${this.anchor}`):null}get items(){return this.defaultSlot.assignedElements({flatten:!0}).filter(ty)}get radioGroupItems(){return this.items.filter(e=>e.role===`menuitemradio`)}get checkedItems(){return this.items.filter(e=>e.checked)}get value(){return this.checkedItems[0]?.value??``}set value(e){let t=this.items.find(t=>t.value===e);t&&Y(this,Jv,Yv).call(this,t)}focus(){if(rv(this,av,nc()),this.items.length){Y(this,Kv,qv).call(this,this.items[0]),this.items[0].focus();return}this.querySelector(`[autofocus], [tabindex]:not([tabindex="-1"]), [role="menu"]`)?.focus()}handleSelect(e){var t;let n=Y(this,Hv,Uv).call(this,e);n&&(Y(this,Jv,Yv).call(this,n,n.type===`checkbox`),q(this,ov)&&!this.hidden&&((t=q(this,av))==null||t.focus(),this.hidden=!0))}get keysUsed(){return[`Enter`,`Escape`,`Tab`,` `,`ArrowDown`,`ArrowUp`,`Home`,`End`]}handleMove(e){let{key:t}=e,n=this.items,r=Y(this,Hv,Uv).call(this,e)??Y(this,Wv,Gv).call(this)??n[0],i=n.indexOf(r),a=Math.max(0,i);t===`ArrowDown`?a++:t===`ArrowUp`?a--:e.key===`Home`?a=0:e.key===`End`&&(a=n.length-1),a<0&&(a=n.length-1),a>n.length-1&&(a=0),Y(this,Kv,qv).call(this,n[a]),n[a].focus()}};iv=new WeakMap,av=new WeakMap,ov=new WeakMap,sv=new WeakMap,cv=new WeakMap,lv=new WeakMap,uv=new WeakMap,dv=new WeakSet,fv=function(e){let t=e.target;for(let e of t.assignedNodes({flatten:!0}))e.nodeType===3&&e.textContent.trim()===``&&e.remove();[`header`,`title`].includes(t.name)&&Y(this,pv,mv).call(this),t.name||q(this,hv).call(this)},pv=new WeakSet,mv=function(){let e=this.shadowRoot.querySelector(`slot[name="header"]`);e.hidden=this.shadowRoot.querySelector(`slot[name="title"]`).assignedNodes().length===0&&e.assignedNodes().length===0},hv=new WeakMap,gv=new WeakSet,_v=function(){let e=this.shadowRoot.querySelector(`#layout-row`),t=getComputedStyle(this).getPropertyValue(`--media-menu-layout`)?.trim();e.setAttribute(`media`,t===`row`?``:`width:0`)},vv=new WeakSet,yv=function(e){rv(this,ov,e.relatedTarget),ec(this,e.relatedTarget)||(this.hidden=!this.hidden)},bv=new WeakSet,xv=function(){var e;(e=q(this,ov))==null||e.setAttribute(`aria-expanded`,`true`),this.addEventListener(`transitionend`,()=>this.focus(),{once:!0}),Ks(ny(this),q(this,wv)),Ks(this,q(this,Tv))},Sv=new WeakSet,Cv=function(){var e;(e=q(this,ov))==null||e.setAttribute(`aria-expanded`,`false`),qs(ny(this),q(this,wv)),qs(this,q(this,Tv))},wv=new WeakMap,Tv=new WeakMap,Ev=new WeakSet,Dv=function(e){if(this.hasAttribute(`mediacontroller`)&&!this.anchor||this.hidden||!this.anchorElement)return;let{x:t,y:n}=J_({anchor:this.anchorElement,floating:this,placement:`top-start`});e??=this.offsetWidth;let r=ny(this).getBoundingClientRect(),i=r.width-t-e,a=r.height-n-this.offsetHeight,{style:o}=q(this,uv);o.setProperty(`position`,`absolute`),o.setProperty(`right`,`${Math.max(0,i)}px`),o.setProperty(`--_menu-bottom`,`${a}px`);let s=getComputedStyle(this),c=o.getPropertyValue(`--_menu-bottom`)===s.bottom?a:parseFloat(s.bottom),l=r.height-c-parseFloat(s.marginBottom);this.style.setProperty(`--_menu-max-height`,`${l}px`)},Ov=new WeakSet,kv=function(e){let t=this.querySelector(`[role="menuitem"][aria-haspopup][aria-expanded="true"]`),n=t?.querySelector(`[role="menu"]`),{style:r}=q(this,uv);if(e||r.setProperty(`--media-menu-transition-in`,`none`),n){let e=n.offsetHeight,r=Math.max(n.offsetWidth,t.offsetWidth);this.style.setProperty(`min-width`,`${r}px`),this.style.setProperty(`min-height`,`${e}px`),Y(this,Ev,Dv).call(this,r)}else this.style.removeProperty(`min-width`),this.style.removeProperty(`min-height`),Y(this,Ev,Dv).call(this);r.removeProperty(`--media-menu-transition-in`)},Av=new WeakSet,jv=function(e){var t;if(e.stopPropagation(),e.composedPath().includes(q(this,Mv,Nv))){(t=q(this,av))==null||t.focus(),this.hidden=!0;return}let n=Y(this,Hv,Uv).call(this,e);!n||n.hasAttribute(`disabled`)||(Y(this,Kv,qv).call(this,n),this.handleSelect(e))},Mv=new WeakSet,Nv=function(){return this.shadowRoot.querySelector(`slot[name="header"]`).assignedElements({flatten:!0})?.find(e=>e.matches(`button[part~="back"]`))},Pv=new WeakSet,Fv=function(e){if(e.target===this)return;Y(this,Iv,Lv).call(this);let t=Array.from(this.querySelectorAll(`[role="menuitem"][aria-haspopup]`));for(let n of t)n.invokeTargetElement!=e.target&&e.newState==`open`&&n.getAttribute(`aria-expanded`)==`true`&&!n.invokeTargetElement.hidden&&n.invokeTargetElement.dispatchEvent(new ev({relatedTarget:n}));for(let e of t)e.setAttribute(`aria-expanded`,`${!e.submenuElement.hidden}`);Y(this,Ov,kv).call(this,!0)},Iv=new WeakSet,Lv=function(){let e=this.querySelector(`[role="menuitem"] > [role="menu"]:not([hidden])`);this.container.classList.toggle(`has-expanded`,!!e)},Rv=new WeakSet,zv=function(e){var t;ec(this,e.relatedTarget)||(q(this,lv)&&((t=q(this,av))==null||t.focus()),q(this,ov)&&q(this,ov)!==e.relatedTarget&&!this.hidden&&(this.hidden=!0))},Bv=new WeakSet,Vv=function(e){var t,n,r,i,a;let{key:o,ctrlKey:s,altKey:c,metaKey:l}=e;if(!(s||c||l)&&this.keysUsed.includes(o))if(e.preventDefault(),e.stopPropagation(),o===`Tab`){if(q(this,lv)){this.hidden=!0;return}e.shiftKey?(n=(t=this.previousElementSibling)?.focus)==null||n.call(t):(i=(r=this.nextElementSibling)?.focus)==null||i.call(r),this.blur()}else o===`Escape`?((a=q(this,av))==null||a.focus(),q(this,lv)&&(this.hidden=!0)):o===`Enter`||o===` `?this.handleSelect(e):this.handleMove(e)},Hv=new WeakSet,Uv=function(e){return e.composedPath().find(e=>[`menuitemradio`,`menuitemcheckbox`].includes(e.role))},Wv=new WeakSet,Gv=function(){return this.items.find(e=>e.tabIndex===0)},Kv=new WeakSet,qv=function(e){for(let t of this.items)t.tabIndex=t===e?0:-1},Jv=new WeakSet,Yv=function(e,t){let n=[...this.checkedItems];e.type===`radio`&&this.radioGroupItems.forEach(e=>e.checked=!1),t?e.checked=!e.checked:e.checked=!0,this.checkedItems.some((e,t)=>e!=n[t])&&this.dispatchEvent(new Event(`change`,{bubbles:!0,composed:!0}))},ey.shadowRootOptions={mode:`open`},ey.getTemplateHTML=Qv;function ty(e){return[`menuitem`,`menuitemradio`,`menuitemcheckbox`].includes(e?.role)}function ny(e){return(e.getAttribute(`bounds`)?tc(e,`#${e.getAttribute(`bounds`)}`):Ys(e)||e.parentElement)??e}N.customElements.get(`media-chrome-menu`)||N.customElements.define(`media-chrome-menu`,ey);var ry=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},iy=(e,t,n)=>(ry(e,t,`read from private field`),n?n.call(e):t.get(e)),ay=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},oy=(e,t,n,r)=>(ry(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),sy=(e,t,n)=>(ry(e,t,`access private method`),n),cy,ly,uy,dy,fy,py,my,hy,gy,_y,vy,yy,by;function xy(e){return`
    <style>
      :host {
  ...
  `}function Sy(e){return``}var Cy={TYPE:`type`,VALUE:`value`,CHECKED:`checked`,DISABLED:`disabled`},wy=class extends N.HTMLElement{constructor(){if(super(),ay(this,uy),ay(this,fy),ay(this,my),ay(this,yy),ay(this,cy,!1),ay(this,ly,void 0),ay(this,gy,()=>{this.submenuElement.items&&this.setAttribute(`submenusize`,`${this.submenuElement.items.length}`);let e=this.shadowRoot.querySelector(`slot[name="description"]`),t=this.submenuElement.checkedItems?.[0],n=t?.dataset.description??t?.text,r=Hs.createElement(`span`);r.textContent=n??``,e.replaceChildren(r)}),ay(this,_y,e=>{let{key:t}=e;if(!this.keysUsed.includes(t)){this.removeEventListener(`keyup`,iy(this,_y));return}this.handleClick(e)}),ay(this,vy,e=>{let{metaKey:t,altKey:n,key:r}=e;if(t||n||!this.keysUsed.includes(r)){this.removeEventListener(`keyup`,iy(this,_y));return}this.addEventListener(`keyup`,iy(this,_y),{once:!0})}),!this.shadowRoot){this.attachShadow(this.constructor.shadowRootOptions);let e=Js(this.attributes);this.shadowRoot.innerHTML=this.constructor.getTemplateHTML(e)}}static get observedAttributes(){return[Cy.TYPE,Cy.DISABLED,Cy.CHECKED,Cy.VALUE]}enable(){this.hasAttribute(`tabindex`)||this.setAttribute(`tabindex`,`-1`),Ty(this)&&!this.hasAttribute(`aria-checked`)&&this.setAttribute(`aria-checked`,`false`),this.addEventListener(`click`,this),this.addEventListener(`keydown`,this)}disable(){this.removeAttribute(`tabindex`),this.removeEventListener(`click`,this),this.removeEventListener(`keydown`,this),this.removeEventListener(`keyup`,this)}handleEvent(e){switch(e.type){case`slotchange`:sy(this,uy,dy).call(this,e);break;case`click`:this.handleClick(e);break;case`keydown`:iy(this,vy).call(this,e);break;case`keyup`:iy(this,_y).call(this,e);break}}attributeChangedCallback(e,t,n){e===Cy.CHECKED&&Ty(this)&&!iy(this,cy)?this.setAttribute(`aria-checked`,n==null?`false`:`true`):e===Cy.TYPE&&n!==t?this.role=`menuitem`+n:e===Cy.DISABLED&&n!==t&&(n==null?this.enable():this.disable())}connectedCallback(){this.hasAttribute(Cy.DISABLED)||this.enable(),this.role=`menuitem`+this.type,oy(this,ly,Ey(this,this.parentNode)),sy(this,yy,by).call(this),this.submenuElement&&sy(this,fy,py).call(this),this.shadowRoot.addEventListener(`slotchange`,this)}disconnectedCallback(){this.disable(),sy(this,yy,by).call(this),oy(this,ly,null),this.shadowRoot.removeEventListener(`slotchange`,this)}get invokeTarget(){return this.getAttribute(`invoketarget`)}set invokeTarget(e){this.setAttribute(`invoketarget`,`${e}`)}get invokeTargetElement(){return this.invokeTarget?rc(this)?.querySelector(`#${this.invokeTarget}`):this.submenuElement}get submenuElement(){return this.shadowRoot.querySelector(`slot[name="submenu"]`).assignedElements({flatten:!0})[0]}get type(){return this.getAttribute(Cy.TYPE)??``}set type(e){this.setAttribute(Cy.TYPE,`${e}`)}get value(){return this.getAttribute(Cy.VALUE)??this.text}set value(e){this.setAttribute(Cy.VALUE,e)}get text(){return(this.textContent??``).trim()}get checked(){if(Ty(this))return this.getAttribute(`aria-checked`)===`true`}set checked(e){Ty(this)&&(oy(this,cy,!0),this.setAttribute(`aria-checked`,e?`true`:`false`),e?this.part.add(`checked`):this.part.remove(`checked`))}handleClick(e){Ty(this)||this.invokeTargetElement&&ec(this,e.target)&&this.invokeTargetElement.dispatchEvent(new ev({relatedTarget:this}))}get keysUsed(){return[`Enter`,` `]}};cy=new WeakMap,ly=new WeakMap,uy=new WeakSet,dy=function(e){let t=e.target;if(!t?.name)for(let e of t.assignedNodes({flatten:!0}))e instanceof Text&&e.textContent.trim()===``&&e.remove();t.name===`submenu`&&(this.submenuElement?sy(this,fy,py).call(this):sy(this,my,hy).call(this))},fy=new WeakSet,py=async function(){this.setAttribute(`aria-haspopup`,`menu`),this.setAttribute(`aria-expanded`,`${!this.submenuElement.hidden}`),this.submenuElement.addEventListener(`change`,iy(this,gy)),this.submenuElement.addEventListener(`addmenuitem`,iy(this,gy)),this.submenuElement.addEventListener(`removemenuitem`,iy(this,gy)),iy(this,gy).call(this)},my=new WeakSet,hy=function(){this.removeAttribute(`aria-haspopup`),this.removeAttribute(`aria-expanded`),this.submenuElement.removeEventListener(`change`,iy(this,gy)),this.submenuElement.removeEventListener(`addmenuitem`,iy(this,gy)),this.submenuElement.removeEventListener(`removemenuitem`,iy(this,gy)),iy(this,gy).call(this)},gy=new WeakMap,_y=new WeakMap,vy=new WeakMap,yy=new WeakSet,by=function(){let e=iy(this,ly)?.radioGroupItems;if(!e)return;let t=e.filter(e=>e.getAttribute(`aria-checked`)===`true`).pop();t||=e[0];for(let t of e)t.setAttribute(`aria-checked`,`false`);t?.setAttribute(`aria-checked`,`true`)},wy.shadowRootOptions={mode:`open`},wy.getTemplateHTML=xy,wy.getSuffixSlotInnerHTML=Sy;function Ty(e){return e.type===`radio`||e.type===`checkbox`}function Ey(e,t){if(!e)return null;let{host:n}=e.getRootNode();return!t&&n?Ey(e,n):t?.items?t:Ey(t,t?.parentNode)}N.customElements.get(`media-chrome-menu-item`)||N.customElements.define(`media-chrome-menu-item`,wy);function Dy(e){return`
    ${ey.getTemplateHTML(e)}
    <style>
      :host {
        --_menu-bg: rgb(20 20 30 / .8);
  ...
  `}var Oy=class extends ey{get anchorElement(){return this.anchor===`auto`?Ys(this).querySelector(`media-settings-menu-button`):super.anchorElement}};Oy.getTemplateHTML=Dy,N.customElements.get(`media-settings-menu`)||N.customElements.define(`media-settings-menu`,Oy);function ky(e){return`
    ${wy.getTemplateHTML.call(this,e)}
    <style>
      slot:not([name="submenu"]) {
  ...
  `}var jy=class extends wy{};jy.shadowRootOptions={mode:`open`},jy.getTemplateHTML=ky,jy.getSuffixSlotInnerHTML=Ay,N.customElements.get(`media-settings-menu-item`)||N.customElements.define(`media-settings-menu-item`,jy);var My=class extends rd{connectedCallback(){super.connectedCallback(),this.invokeTargetElement&&this.setAttribute(`aria-haspopup`,`menu`)}get invokeTarget(){return this.getAttribute(`invoketarget`)}set invokeTarget(e){this.setAttribute(`invoketarget`,`${e}`)}get invokeTargetElement(){return this.invokeTarget?rc(this)?.querySelector(`#${this.invokeTarget}`):null}handleClick(){var e;(e=this.invokeTargetElement)==null||e.dispatchEvent(new ev({relatedTarget:this}))}};N.customElements.get(`media-chrome-menu-button`)||N.customElements.define(`media-chrome-menu-button`,My);function Ny(){return`
    <style>
  ...
  `}function Py(){return M(`Settings`)}var Fy=class extends My{static get observedAttributes(){return[...super.observedAttributes,`target`]}connectedCallback(){super.connectedCallback(),this.setAttribute(`aria-label`,M(`settings`))}get invokeTargetElement(){return this.invokeTarget==null?Ys(this).querySelector(`media-settings-menu`):super.invokeTargetElement}};Fy.getSlotTemplateHTML=Ny,Fy.getTooltipContentHTML=Py,N.customElements.get(`media-settings-menu-button`)||N.customElements.define(`media-settings-menu-button`,Fy);var Iy=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},Ly=(e,t,n)=>(Iy(e,t,`read from private field`),n?n.call(e):t.get(e)),Ry=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},zy=(e,t,n,r)=>(Iy(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),By=(e,t,n)=>(Iy(e,t,`access private method`),n),Vy,Hy,Uy,Wy,Gy,Ky,qy=class extends ey{constructor(){super(...arguments),Ry(this,Uy),Ry(this,Gy),Ry(this,Vy,[]),Ry(this,Hy,void 0)}static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_AUDIO_TRACK_LIST,j.MEDIA_AUDIO_TRACK_ENABLED,j.MEDIA_AUDIO_TRACK_UNAVAILABLE]}attributeChangedCallback(e,t,n){super.attributeChangedCallback(e,t,n),e===j.MEDIA_AUDIO_TRACK_ENABLED&&t!==n?this.value=n:e===j.MEDIA_AUDIO_TRACK_LIST&&t!==n&&(zy(this,Vy,ys(n??``)),By(this,Uy,Wy).call(this))}connectedCallback(){super.connectedCallback(),this.addEventListener(`change`,By(this,Gy,Ky))}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`change`,By(this,Gy,Ky))}get anchorElement(){return this.anchor===`auto`?Ys(this)?.querySelector(`media-audio-track-menu-button`):super.anchorElement}get mediaAudioTrackList(){return Ly(this,Vy)}set mediaAudioTrackList(e){zy(this,Vy,e),By(this,Uy,Wy).call(this)}get mediaAudioTrackEnabled(){return R(this,j.MEDIA_AUDIO_TRACK_ENABLED)??``}set mediaAudioTrackEnabled(e){z(this,j.MEDIA_AUDIO_TRACK_ENABLED,e)}};Vy=new WeakMap,Hy=new WeakMap,Uy=new WeakSet,Wy=function(){if(Ly(this,Hy)===JSON.stringify(this.mediaAudioTrackList))return;zy(this,Hy,JSON.stringify(this.mediaAudioTrackList));let e=this.mediaAudioTrackList;this.defaultSlot.textContent=``,e.sort((e,t)=>e.id.localeCompare(t.id,void 0,{numeric:!0}));for(let t of e){let e=Xv({type:`radio`,text:this.formatMenuItemText(t.label,t),value:`${t.id}`,checked:t.enabled});e.prepend(Zv(this,`checked-indicator`)),this.defaultSlot.append(e)}},Gy=new WeakSet,Ky=function(){if(this.value==null)return;let e=new N.CustomEvent(k.MEDIA_AUDIO_TRACK_REQUEST,{composed:!0,bubbles:!0,detail:this.value});this.dispatchEvent(e)},N.customElements.get(`media-audio-track-menu`)||N.customElements.define(`media-audio-track-menu`,qy);var Jy=`<svg aria-hidden="true" viewBox="0 0 24 24">
  ...
  `}function Xy(){return M(`Audio`)}var Zy=e=>{let t=M(`Audio`);e.setAttribute(`aria-label`,t)},Qy=class extends My{static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_AUDIO_TRACK_ENABLED,j.MEDIA_AUDIO_TRACK_UNAVAILABLE]}connectedCallback(){super.connectedCallback(),Zy(this)}attributeChangedCallback(e,t,n){super.attributeChangedCallback(e,t,n),e===j.MEDIA_LANG&&Zy(this)}get invokeTargetElement(){return this.invokeTarget==null?Ys(this)?.querySelector(`media-audio-track-menu`):super.invokeTargetElement}get mediaAudioTrackEnabled(){return R(this,j.MEDIA_AUDIO_TRACK_ENABLED)??``}set mediaAudioTrackEnabled(e){z(this,j.MEDIA_AUDIO_TRACK_ENABLED,e)}};Qy.getSlotTemplateHTML=Yy,Qy.getTooltipContentHTML=Xy,N.customElements.get(`media-audio-track-menu-button`)||N.customElements.define(`media-audio-track-menu-button`,Qy);var $y=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},eb=(e,t,n)=>($y(e,t,`read from private field`),n?n.call(e):t.get(e)),tb=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},nb=(e,t,n,r)=>($y(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),rb=(e,t,n)=>($y(e,t,`access private method`),n),ib,ab,ob,sb,cb,lb=`
  <svg aria-hidden="true" viewBox="0 0 26 24" part="captions-indicator indicator">
    <path d="M22.83 5.68a2.58 2.58 0 0 0-2.3-2.5c-3.62-.24-11.44-.24-15.06 0a2.58 2.58 0 0 0-2.3 2.5c-.23 4.21-.23 8.43 0 12.64a2.58 2.58 0 0 0 2.3 2.5c3.62.24 11.44.24 15.06 0a2.58 2.58 0 0 0 2.3-2.5c.23-4.21.23-8.43 0-12.64Zm-11.39 9.45a3.07 3.07 0 0 1-1.91.57 3.06 3.06 0 0 1-2.34-1 3.75 3.75 0 0 1-.92-2.67 3.92 3.92 0 0 1 .92-2.77 3.18 3.18 0 0 1 2.43-1 2.94 2.94 0 0 1 2.13.78c.364.359.62.813.74 1.31l-1.43.35a1.49 1.49 0 0 0-1.51-1.17 1.61 1.61 0 0 0-1.29.58 2.79 2.79 0 0 0-.5 1.89 3 3 0 0 0 .49 1.93 1.61 1.61 0 0 0 1.27.58 1.48 1.48 0 0 0 1-.37 2.1 2.1 0 0 0 .59-1.14l1.4.44a3.23 3.23 0 0 1-1.07 1.69Zm7.22 0a3.07 3.07 0 0 1-1.91.57 3.06 3.06 0 0 1-2.34-1 3.75 3.75 0 0 1-.92-2.67 3.88 3.88 0 0 1 .93-2.77 3.14 3.14 0 0 1 2.42-1 3 3 0 0 1 2.16.82 2.8 2.8 0 0 1 .73 1.31l-1.43.35a1.49 1.49 0 0 0-1.51-1.21 1.61 1.61 0 0 0-1.29.58A2.79 2.79 0 0 0 15 12a3 3 0 0 0 .49 1.93 1.61 1.61 0 0 0 1.27.58 1.44 1.44 0 0 0 1-.37 2.1 2.1 0 0 0 .6-1.15l1.4.44a3.17 3.17 0 0 1-1.1 1.7Z"/>
  </svg>`;function ub(e){return`
    ${ey.getTemplateHTML(e)}
    <slot name="captions-indicator" hidden>${lb}</slot>
  `}var db=class extends ey{constructor(){super(...arguments),tb(this,ab),tb(this,sb),tb(this,ib,void 0)}static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_SUBTITLES_LIST,j.MEDIA_SUBTITLES_SHOWING]}attributeChangedCallback(e,t,n){super.attributeChangedCallback(e,t,n),e===j.MEDIA_SUBTITLES_LIST&&t!==n?rb(this,ab,ob).call(this):e===j.MEDIA_SUBTITLES_SHOWING&&t!==n&&(this.value=n||``,rb(this,ab,ob).call(this))}connectedCallback(){super.connectedCallback(),this.addEventListener(`change`,rb(this,sb,cb))}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`change`,rb(this,sb,cb))}get anchorElement(){return this.anchor===`auto`?Ys(this).querySelector(`media-captions-menu-button`):super.anchorElement}get mediaSubtitlesList(){return fb(this,j.MEDIA_SUBTITLES_LIST)}set mediaSubtitlesList(e){pb(this,j.MEDIA_SUBTITLES_LIST,e)}get mediaSubtitlesShowing(){return fb(this,j.MEDIA_SUBTITLES_SHOWING)}set mediaSubtitlesShowing(e){pb(this,j.MEDIA_SUBTITLES_SHOWING,e)}};ib=new WeakMap,ab=new WeakSet,ob=function(){let e=eb(this,ib)!==JSON.stringify(this.mediaSubtitlesList),t=this.value!==this.getAttribute(j.MEDIA_SUBTITLES_SHOWING);if(!e&&!t)return;nb(this,ib,JSON.stringify(this.mediaSubtitlesList)),this.defaultSlot.textContent=``;let n=!this.value,r=Xv({type:`radio`,text:this.formatMenuItemText(M(`Off`)),value:`off`,checked:n});r.prepend(Zv(this,`checked-indicator`)),this.defaultSlot.append(r);let i=this.mediaSubtitlesList;for(let e of i){let t=Xv({type:`radio`,text:this.formatMenuItemText(e.label,e),value:fl(e),checked:this.value==fl(e)});t.prepend(Zv(this,`checked-indicator`)),(e.kind??`subs`)===`captions`&&t.append(Zv(this,`captions-indicator`)),this.defaultSlot.append(t)}},sb=new WeakSet,cb=function(){let e=this.mediaSubtitlesShowing,t=this.getAttribute(j.MEDIA_SUBTITLES_SHOWING),n=this.value!==t;if(e?.length&&n&&this.dispatchEvent(new N.CustomEvent(k.MEDIA_DISABLE_SUBTITLES_REQUEST,{composed:!0,bubbles:!0,detail:e})),!this.value||!n)return;let r=new N.CustomEvent(k.MEDIA_SHOW_SUBTITLES_REQUEST,{composed:!0,bubbles:!0,detail:this.value});this.dispatchEvent(r)},db.getTemplateHTML=ub;var fb=(e,t)=>{let n=e.getAttribute(t);return n?ul(n):[]},pb=(e,t,n)=>{if(!n?.length){e.removeAttribute(t);return}let r=pl(n);e.getAttribute(t)!==r&&e.setAttribute(t,r)};N.customElements.get(`media-captions-menu`)||N.customElements.define(`media-captions-menu`,db);var mb=`<svg aria-hidden="true" viewBox="0 0 26 24">
  <path d="M22.83 5.68a2.58 2.58 0 0 0-2.3-2.5c-3.62-.24-11.44-.24-15.06 0a2.58 2.58 0 0 0-2.3 2.5c-.23 4.21-.23 8.43 0 12.64a2.58 2.58 0 0 0 2.3 2.5c3.62.24 11.44.24 15.06 0a2.58 2.58 0 0 0 2.3-2.5c.23-4.21.23-8.43 0-12.64Zm-11.39 9.45a3.07 3.07 0 0 1-1.91.57 3.06 3.06 0 0 1-2.34-1 3.75 3.75 0 0 1-.92-2.67 3.92 3.92 0 0 1 .92-2.77 3.18 3.18 0 0 1 2.43-1 2.94 2.94 0 0 1 2.13.78c.364.359.62.813.74 1.31l-1.43.35a1.49 1.49 0 0 0-1.51-1.17 1.61 1.61 0 0 0-1.29.58 2.79 2.79 0 0 0-.5 1.89 3 3 0 0 0 .49 1.93 1.61 1.61 0 0 0 1.27.58 1.48 1.48 0 0 0 1-.37 2.1 2.1 0 0 0 .59-1.14l1.4.44a3.23 3.23 0 0 1-1.07 1.69Zm7.22 0a3.07 3.07 0 0 1-1.91.57 3.06 3.06 0 0 1-2.34-1 3.75 3.75 0 0 1-.92-2.67 3.88 3.88 0 0 1 .93-2.77 3.14 3.14 0 0 1 2.42-1 3 3 0 0 1 2.16.82 2.8 2.8 0 0 1 .73 1.31l-1.43.35a1.49 1.49 0 0 0-1.51-1.21 1.61 1.61 0 0 0-1.29.58A2.79 2.79 0 0 0 15 12a3 3 0 0 0 .49 1.93 1.61 1.61 0 0 0 1.27.58 1.44 1.44 0 0 0 1-.37 2.1 2.1 0 0 0 .6-1.15l1.4.44a3.17 3.17 0 0 1-1.1 1.7Z"/>
</svg>`,hb=`<svg aria-hidden="true" viewBox="0 0 26 24">
  <path d="M17.73 14.09a1.4 1.4 0 0 1-1 .37 1.579 1.579 0 0 1-1.27-.58A3 3 0 0 1 15 12a2.8 2.8 0 0 1 .5-1.85 1.63 1.63 0 0 1 1.29-.57 1.47 1.47 0 0 1 1.51 1.2l1.43-.34A2.89 2.89 0 0 0 19 9.07a3 3 0 0 0-2.14-.78 3.14 3.14 0 0 0-2.42 1 3.91 3.91 0 0 0-.93 2.78 3.74 3.74 0 0 0 .92 2.66 3.07 3.07 0 0 0 2.34 1 3.07 3.07 0 0 0 1.91-.57 3.17 3.17 0 0 0 1.07-1.74l-1.4-.45c-.083.43-.3.822-.62 1.12Zm-7.22 0a1.43 1.43 0 0 1-1 .37 1.58 1.58 0 0 1-1.27-.58A3 3 0 0 1 7.76 12a2.8 2.8 0 0 1 .5-1.85 1.63 1.63 0 0 1 1.29-.57 1.47 1.47 0 0 1 1.51 1.2l1.43-.34a2.81 2.81 0 0 0-.74-1.32 2.94 2.94 0 0 0-2.13-.78 3.18 3.18 0 0 0-2.43 1 4 4 0 0 0-.92 2.78 3.74 3.74 0 0 0 .92 2.66 3.07 3.07 0 0 0 2.34 1 3.07 3.07 0 0 0 1.91-.57 3.23 3.23 0 0 0 1.07-1.74l-1.4-.45a2.06 2.06 0 0 1-.6 1.07Zm12.32-8.41a2.59 2.59 0 0 0-2.3-2.51C18.72 3.05 15.86 3 13 3c-2.86 0-5.72.05-7.53.17a2.59 2.59 0 0 0-2.3 2.51c-.23 4.207-.23 8.423 0 12.63a2.57 2.57 0 0 0 2.3 2.5c1.81.13 4.67.19 7.53.19 2.86 0 5.72-.06 7.53-.19a2.57 2.57 0 0 0 2.3-2.5c.23-4.207.23-8.423 0-12.63Zm-1.49 12.53a1.11 1.11 0 0 1-.91 1.11c-1.67.11-4.45.18-7.43.18-2.98 0-5.76-.07-7.43-.18a1.11 1.11 0 0 1-.91-1.11c-.21-4.14-.21-8.29 0-12.43a1.11 1.11 0 0 1 .91-1.11C7.24 4.56 10 4.49 13 4.49s5.76.07 7.43.18a1.11 1.11 0 0 1 .91 1.11c.21 4.14.21 8.29 0 12.43Z"/>
    ...
    <slot name="icon">
      ...
      <slot name="off">${hb}</slot>
    </slot>
  `}function _b(){return M(`Captions`)}var vb=e=>{e.setAttribute(`data-captions-enabled`,vl(e).toString())},yb=e=>{e.setAttribute(`aria-label`,M(`closed captions`))},bb=class extends My{static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_SUBTITLES_LIST,j.MEDIA_SUBTITLES_SHOWING,j.MEDIA_LANG]}connectedCallback(){super.connectedCallback(),yb(this),vb(this)}attributeChangedCallback(e,t,n){super.attributeChangedCallback(e,t,n),e===j.MEDIA_SUBTITLES_SHOWING?vb(this):e===j.MEDIA_LANG&&yb(this)}get invokeTargetElement(){return this.invokeTarget==null?Ys(this)?.querySelector(`media-captions-menu`):super.invokeTargetElement}get mediaSubtitlesList(){return xb(this,j.MEDIA_SUBTITLES_LIST)}set mediaSubtitlesList(e){Sb(this,j.MEDIA_SUBTITLES_LIST,e)}get mediaSubtitlesShowing(){return xb(this,j.MEDIA_SUBTITLES_SHOWING)}set mediaSubtitlesShowing(e){Sb(this,j.MEDIA_SUBTITLES_SHOWING,e)}};bb.getSlotTemplateHTML=gb,bb.getTooltipContentHTML=_b;var xb=(e,t)=>{let n=e.getAttribute(t);return n?ul(n):[]},Sb=(e,t,n)=>{if(!n?.length){e.removeAttribute(t);return}let r=pl(n);e.getAttribute(t)!==r&&e.setAttribute(t,r)};N.customElements.get(`media-captions-menu-button`)||N.customElements.define(`media-captions-menu-button`,bb);var Cb=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},wb=(e,t,n)=>(Cb(e,t,`read from private field`),n?n.call(e):t.get(e)),Tb=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},Eb=(e,t,n)=>(Cb(e,t,`access private method`),n),Db,Ob,kb,Ab,jb,Mb={RATES:`rates`},Nb=class extends ey{constructor(){super(),Tb(this,Ob),Tb(this,Ab),Tb(this,Db,new sl(this,Mb.RATES,{defaultValue:lm})),Eb(this,Ob,kb).call(this)}static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_PLAYBACK_RATE,Mb.RATES]}attributeChangedCallback(e,t,n){super.attributeChangedCallback(e,t,n),e===j.MEDIA_PLAYBACK_RATE&&t!=n?(this.value=n,Eb(this,Ob,kb).call(this)):e===Mb.RATES&&t!=n&&(wb(this,Db).value=n,Eb(this,Ob,kb).call(this))}connectedCallback(){super.connectedCallback(),this.addEventListener(`change`,Eb(this,Ab,jb))}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`change`,Eb(this,Ab,jb))}get anchorElement(){return this.anchor===`auto`?Ys(this).querySelector(`media-playback-rate-menu-button`):super.anchorElement}get rates(){return wb(this,Db)}set rates(e){e?Array.isArray(e)?wb(this,Db).value=e.join(` `):typeof e==`string`&&(wb(this,Db).value=e):wb(this,Db).value=``,Eb(this,Ob,kb).call(this)}get mediaPlaybackRate(){return P(this,j.MEDIA_PLAYBACK_RATE,1)}set mediaPlaybackRate(e){F(this,j.MEDIA_PLAYBACK_RATE,e)}};Db=new WeakMap,Ob=new WeakSet,kb=function(){this.defaultSlot.textContent=``;let e=this.mediaPlaybackRate,t=new Set(Array.from(wb(this,Db)).map(e=>Number(e)));e>0&&!t.has(e)&&t.add(e);let n=Array.from(t).sort((e,t)=>e-t);for(let t of n){let n=Xv({type:`radio`,text:this.formatMenuItemText(`${t}x`,t),value:t.toString(),checked:e===t});n.prepend(Zv(this,`checked-indicator`)),this.defaultSlot.append(n)}},Ab=new WeakSet,jb=function(){if(!this.value)return;let e=new N.CustomEvent(k.MEDIA_PLAYBACK_RATE_REQUEST,{composed:!0,bubbles:!0,detail:this.value});this.dispatchEvent(e)},N.customElements.get(`media-playback-rate-menu`)||N.customElements.define(`media-playback-rate-menu`,Nb);function Pb(e){return`
    <style>
      :host {
        min-width: 5ch;
        padding: var(--media-button-padding, var(--media-control-padding, 10px 5px));
    ...
    <slot name="icon">${e.mediaplaybackrate||1}x</slot>
  `}function Fb(){return M(`Playback rate`)}var Ib=class extends My{static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_PLAYBACK_RATE]}constructor(){super(),this.container=this.shadowRoot.querySelector(`slot[name="icon"]`),this.container.innerHTML=`${this.mediaPlaybackRate??1}x`}attributeChangedCallback(e,t,n){if(super.attributeChangedCallback(e,t,n),e===j.MEDIA_PLAYBACK_RATE){let e=n?+n:NaN,t=Number.isNaN(e)?1:e;this.container.innerHTML=`${t}x`,this.setAttribute(`aria-label`,M(`Playback rate {playbackRate}`,{playbackRate:t}))}}get invokeTargetElement(){return this.invokeTarget==null?Ys(this).querySelector(`media-playback-rate-menu`):super.invokeTargetElement}get mediaPlaybackRate(){return P(this,j.MEDIA_PLAYBACK_RATE,1)}set mediaPlaybackRate(e){F(this,j.MEDIA_PLAYBACK_RATE,e)}};Ib.getSlotTemplateHTML=Pb,Ib.getTooltipContentHTML=Fb,N.customElements.get(`media-playback-rate-menu-button`)||N.customElements.define(`media-playback-rate-menu-button`,Ib);var Lb=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},Rb=(e,t,n)=>(Lb(e,t,`read from private field`),n?n.call(e):t.get(e)),zb=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},Bb=(e,t,n,r)=>(Lb(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),Vb=(e,t,n)=>(Lb(e,t,`access private method`),n),Hb,Ub,Wb,Gb,Kb,qb,Jb=class extends ey{constructor(){super(...arguments),zb(this,Wb),zb(this,Kb),zb(this,Hb,[]),zb(this,Ub,{})}static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_RENDITION_LIST,j.MEDIA_RENDITION_SELECTED,j.MEDIA_RENDITION_UNAVAILABLE,j.MEDIA_HEIGHT,j.MEDIA_WIDTH]}static formatMenuItemText(e,t){return super.formatMenuItemText(e,t)}static formatRendition(e,{showBitrate:t=!1}={}){let n=`${Math.min(e.width,e.height)}p`;if(t&&e.bitrate){let t=e.bitrate/1e6;return`${n} (${`${t.toFixed(+(t<1))} Mbps`})`}return this.formatMenuItemText(n,e)}static compareRendition(e,t){return t.height===e.height?(t.bitrate??0)-(e.bitrate??0):t.height-e.height}attributeChangedCallback(e,t,n){if(super.attributeChangedCallback(e,t,n),t!==n)switch(e){case j.MEDIA_RENDITION_SELECTED:this.value=n??`auto`,Vb(this,Wb,Gb).call(this);break;case j.MEDIA_RENDITION_LIST:Bb(this,Hb,hs(n)),Vb(this,Wb,Gb).call(this);break;case j.MEDIA_HEIGHT:case j.MEDIA_WIDTH:Vb(this,Wb,Gb).call(this);break}}connectedCallback(){super.connectedCallback(),this.addEventListener(`change`,Vb(this,Kb,qb))}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener(`change`,Vb(this,Kb,qb))}get anchorElement(){return this.anchor===`auto`?Ys(this).querySelector(`media-rendition-menu-button`):super.anchorElement}get mediaRenditionList(){return Rb(this,Hb)}set mediaRenditionList(e){Bb(this,Hb,e),Vb(this,Wb,Gb).call(this)}get mediaRenditionSelected(){return R(this,j.MEDIA_RENDITION_SELECTED)}set mediaRenditionSelected(e){z(this,j.MEDIA_RENDITION_SELECTED,e)}get mediaHeight(){return P(this,j.MEDIA_HEIGHT)}set mediaHeight(e){F(this,j.MEDIA_HEIGHT,e)}get mediaWidth(){return P(this,j.MEDIA_WIDTH)}set mediaWidth(e){F(this,j.MEDIA_WIDTH,e)}compareRendition(e,t){return this.constructor.compareRendition(e,t)}formatMenuItemText(e,t){return this.constructor.formatMenuItemText(e,t)}formatRendition(e,t){return this.constructor.formatRendition(e,t)}showRenditionBitrate(e){return this.mediaRenditionList.some(t=>t!==e&&t.height===e.height&&t.bitrate!==e.bitrate)}};Hb=new WeakMap,Ub=new WeakMap,Wb=new WeakSet,Gb=function(){let e=!this.mediaRenditionSelected;if(Rb(this,Ub).mediaRenditionList===JSON.stringify(this.mediaRenditionList)&&Rb(this,Ub).mediaHeight===this.mediaHeight&&Rb(this,Ub).mediaWidth===this.mediaWidth&&Rb(this,Ub).isAuto===e)return;Rb(this,Ub).mediaRenditionList=JSON.stringify(this.mediaRenditionList),Rb(this,Ub).mediaHeight=this.mediaHeight,Rb(this,Ub).mediaWidth=this.mediaWidth,Rb(this,Ub).isAuto=e;let t=this.mediaRenditionList.sort(this.compareRendition.bind(this)),n=t.find(e=>e.id===this.mediaRenditionSelected);for(let e of t)e.selected=e===n;this.defaultSlot.textContent=``;for(let n of t){let t=Xv({type:`radio`,text:this.formatRendition(n,{showBitrate:this.showRenditionBitrate(n)}),value:`${n.id}`,checked:n.selected&&!e});t.prepend(Zv(this,`checked-indicator`)),this.defaultSlot.append(t)}let r=n&&this.showRenditionBitrate(n),i;e&&(n?i=this.formatMenuItemText(`${M(`Auto`)} \u2022 ${this.formatRendition(n,{showBitrate:r})}`,n):this.mediaHeight>0&&this.mediaWidth>0&&(i=this.formatMenuItemText(`${M(`Auto`)} (${Math.min(this.mediaWidth,this.mediaHeight)}p)`))),i||=this.formatMenuItemText(M(`Auto`));let a=Xv({type:`radio`,text:i,value:`auto`,checked:e});a.dataset.description=i,a.prepend(Zv(this,`checked-indicator`)),this.defaultSlot.append(a)},Kb=new WeakSet,qb=function(){if(this.value==null)return;let e=new N.CustomEvent(k.MEDIA_RENDITION_REQUEST,{composed:!0,bubbles:!0,detail:this.value});this.dispatchEvent(e)},N.customElements.get(`media-rendition-menu`)||N.customElements.define(`media-rendition-menu`,Jb);var Yb=`<svg aria-hidden="true" viewBox="0 0 24 24">
  <path d="M13.5 2.5h2v6h-2v-2h-11v-2h11v-2Zm4 2h4v2h-4v-2Zm-12 4h2v6h-2v-2h-3v-2h3v-2Zm4 2h12v2h-12v-2Zm1 4h2v6h-2v-2h-8v-2h8v-2Zm4 2h7v2h-7v-2Z" />
</svg>`;function Xb(){return`
    <style>
      :host([aria-expanded="true"]) slot[name=tooltip] {
        display: none;
      }
    </style>
    <slot name="icon">${Yb}</slot>
  `}function Zb(){return M(`Quality`)}var Qb=class extends My{static get observedAttributes(){return[...super.observedAttributes,j.MEDIA_RENDITION_SELECTED,j.MEDIA_RENDITION_UNAVAILABLE,j.MEDIA_HEIGHT]}connectedCallback(){super.connectedCallback(),this.setAttribute(`aria-label`,M(`quality`))}get invokeTargetElement(){return this.invokeTarget==null?Ys(this).querySelector(`media-rendition-menu`):super.invokeTargetElement}get mediaRenditionSelected(){return R(this,j.MEDIA_RENDITION_SELECTED)}set mediaRenditionSelected(e){z(this,j.MEDIA_RENDITION_SELECTED,e)}get mediaHeight(){return P(this,j.MEDIA_HEIGHT)}set mediaHeight(e){F(this,j.MEDIA_HEIGHT,e)}};Qb.getSlotTemplateHTML=Xb,Qb.getTooltipContentHTML=Zb,N.customElements.get(`media-rendition-menu-button`)||N.customElements.define(`media-rendition-menu-button`,Qb);var $b=(e,t,n)=>{if(!t.has(e))throw TypeError(`Cannot `+n)},ex=(e,t,n)=>($b(e,t,`read from private field`),n?n.call(e):t.get(e)),tx=(e,t,n)=>{if(t.has(e))throw TypeError(`Cannot add the same private member more than once`);t instanceof WeakSet?t.add(e):t.set(e,n)},nx=(e,t,n,r)=>($b(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),rx=(e,t,n)=>($b(e,t,`access private method`),n),ix,ax,ox,sx,cx,lx,ux,dx,fx,px,mx,hx,gx,_x,vx;function yx(e){return`
      ${ey.getTemplateHTML(e)}
      <style>
        :host {
          --_menu-bg: rgb(20 20 30 / .8);
    ...
    `}var bx=class extends ey{constructor(){super(),tx(this,ax),tx(this,sx),tx(this,lx),tx(this,dx),tx(this,mx),tx(this,ix,!1),tx(this,px,e=>{let t=e.target,n=t?.nodeName===`VIDEO`,r=rx(this,dx,fx).call(this,t);(n||r)&&(ex(this,ix)?rx(this,sx,cx).call(this):rx(this,mx,hx).call(this,e))}),tx(this,gx,e=>{let t=e.target,n=this.contains(t),r=e.button===2,i=t?.nodeName===`VIDEO`,a=rx(this,dx,fx).call(this,t);n||r&&(i||a)||rx(this,sx,cx).call(this)}),tx(this,_x,e=>{e.key===`Escape`&&rx(this,sx,cx).call(this)}),tx(this,vx,e=>{let t=e.target;if(t.matches?.call(t,`button[invoke="copy"]`)){let e=t.closest(`media-context-menu-item`)?.querySelector(`input[slot="copy"]`);e&&navigator.clipboard.writeText(e.value)}rx(this,sx,cx).call(this)}),this.setAttribute(`noautohide`,``),rx(this,ax,ox).call(this)}connectedCallback(){super.connectedCallback(),Ys(this).addEventListener(`contextmenu`,ex(this,px)),this.addEventListener(`click`,ex(this,vx))}disconnectedCallback(){super.disconnectedCallback(),Ys(this).removeEventListener(`contextmenu`,ex(this,px)),this.removeEventListener(`click`,ex(this,vx)),document.removeEventListener(`mousedown`,ex(this,gx)),document.removeEventListener(`keydown`,ex(this,_x))}};ix=new WeakMap,ax=new WeakSet,ox=function(){this.hidden=!ex(this,ix)},sx=new WeakSet,cx=function(){nx(this,ix,!1),rx(this,ax,ox).call(this)},lx=new WeakSet,ux=function(){document.querySelectorAll(`media-context-menu`).forEach(e=>{var t;e!==this&&rx(t=e,sx,cx).call(t)})},dx=new WeakSet,fx=function(e){return e?e.hasAttribute(`slot`)&&e.getAttribute(`slot`)===`media`?!0:e.nodeName.includes(`-`)&&e.tagName.includes(`-`)?e.hasAttribute(`src`)||e.hasAttribute(`poster`)||e.hasAttribute(`preload`)||e.hasAttribute(`playsinline`):!1:!1},px=new WeakMap,mx=new WeakSet,hx=function(e){e.preventDefault(),rx(this,lx,ux).call(this),nx(this,ix,!0),this.style.position=`fixed`,this.style.left=`${e.clientX}px`,this.style.top=`${e.clientY}px`,rx(this,ax,ox).call(this),document.addEventListener(`mousedown`,ex(this,gx),{once:!0}),document.addEventListener(`keydown`,ex(this,_x),{once:!0})},gx=new WeakMap,_x=new WeakMap,vx=new WeakMap,bx.getTemplateHTML=yx,N.customElements.get(`media-context-menu`)||N.customElements.define(`media-context-menu`,bx);function xx(e){return`
    ${wy.getTemplateHTML.call(this,e)}
    <style>
        ::slotted(*) {
  ...
  `}var Sx=class extends wy{};Sx.shadowRootOptions={mode:`open`},Sx.getTemplateHTML=xx,N.customElements.get(`media-context-menu-item`)||N.customElements.define(`media-context-menu-item`,Sx);var Cx=e=>{throw TypeError(e)},wx=(e,t,n)=>t.has(e)||Cx(`Cannot `+n),X=(e,t,n)=>(wx(e,t,`read from private field`),n?n.call(e):t.get(e)),Tx=(e,t,n)=>t.has(e)?Cx(`Cannot add the same private member more than once`):t instanceof WeakSet?t.add(e):t.set(e,n),Ex=(e,t,n,r)=>(wx(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),Dx=(e,t,n)=>(wx(e,t,`access private method`),n),Ox=class{addEventListener(){}removeEventListener(){}dispatchEvent(e){return!0}};if(typeof DocumentFragment>`u`){class e extends Ox{}globalThis.DocumentFragment=e}var kx=class extends Ox{},Ax=class extends Ox{},jx={get(e){},define(e,t,n){},getName(e){return null},upgrade(e){},whenDefined(e){return Promise.resolve(kx)}},Mx,Nx=class{constructor(e,t={}){Tx(this,Mx),Ex(this,Mx,t?.detail)}get detail(){return X(this,Mx)}initCustomEvent(){}};Mx=new WeakMap;function Px(e,t){return new kx}var Fx={document:{createElement:Px},DocumentFragment,customElements:jx,CustomEvent:Nx,EventTarget:Ox,HTMLElement:kx,HTMLVideoElement:Ax},Ix=typeof window>`u`||globalThis.customElements===void 0,Lx=Ix?Fx:globalThis,Rx=Ix?Fx.document:globalThis.document;function zx(e){let t=``;return Object.entries(e).forEach(([e,n])=>{n!=null&&(t+=`${Bx(e)}: ${n}; `)}),t?t.trim():void 0}function Bx(e){return e.replace(/([a-z])([A-Z])/g,`$1-$2`).toLowerCase()}function Vx(e){return e.replace(/[-_]([a-z])/g,(e,t)=>t.toUpperCase())}function Hx(e){if(e==null)return;let t=+e;return Number.isNaN(t)?void 0:t}function Ux(e){let t=Wx(e).toString();return t?`?`+t:``}function Wx(e){let t={};for(let n in e)e[n]!=null&&(t[n]=e[n]);return new URLSearchParams(t)}var Gx=(e,t)=>!e||!t?!1:e.contains(t)?!0:Gx(e,t.getRootNode().host),Kx=`mux.com`,qx=(()=>{try{return`3.13.0`}catch{}return`UNKNOWN`})(),Jx=()=>qx,Yx=(e,{token:t,customDomain:n=Kx,thumbnailTime:r,programTime:i}={})=>{let a=t==null?r:void 0,{aud:o}=Lr(t)??{};if(!(t&&o!==`t`))return`https://image.${n}/${e}/thumbnail.webp${Ux({token:t,time:a,program_time:i})}`},Xx=(e,{token:t,customDomain:n=Kx,programStartTime:r,programEndTime:i}={})=>{let{aud:a}=Lr(t)??{};if(!(t&&a!==`s`))return`https://image.${n}/${e}/storyboard.vtt${Ux({token:t,format:`webp`,program_start_time:r,program_end_time:i})}`},Zx=e=>{if(e){if([T.LIVE,T.ON_DEMAND].includes(e))return e;if(e!=null&&e.includes(`live`))return T.LIVE}},Qx={crossorigin:`crossOrigin`,playsinline:`playsInline`};function $x(e){return Qx[e]??Vx(e)}var eS,tS,nS,rS=class{constructor(e,t){Tx(this,eS),Tx(this,tS),Tx(this,nS,[]),Ex(this,eS,e),Ex(this,tS,t)}[Symbol.iterator](){return X(this,nS).values()}get length(){return X(this,nS).length}get value(){return X(this,nS).join(` `)??``}set value(e){e!==this.value&&(Ex(this,nS,[]),this.add(...e?.split(` `)??[]))}toString(){return this.value}item(e){return X(this,nS)[e]}values(){return X(this,nS).values()}keys(){return X(this,nS).keys()}forEach(e){X(this,nS).forEach(e)}add(...e){var t,n;e.forEach(e=>{this.contains(e)||X(this,nS).push(e)}),!(this.value===``&&!((t=X(this,eS))!=null&&t.hasAttribute(`${X(this,tS)}`)))&&((n=X(this,eS))==null||n.setAttribute(`${X(this,tS)}`,`${this.value}`))}remove(...e){var t;e.forEach(e=>{X(this,nS).splice(X(this,nS).indexOf(e),1)}),(t=X(this,eS))==null||t.setAttribute(`${X(this,tS)}`,`${this.value}`)}contains(e){return X(this,nS).includes(e)}toggle(e,t){return t===void 0?this.contains(e)?(this.remove(e),!1):(this.add(e),!0):t?(this.add(e),!0):(this.remove(e),!1)}replace(e,t){this.remove(e),this.add(t)}};eS=new WeakMap,tS=new WeakMap,nS=new WeakMap;var iS=`[mux-player ${Jx()}]`;function aS(...e){console.warn(iS,...e)}function oS(...e){console.error(iS,...e)}function sS(e){let t=e.message??``;e.context&&(t+=` ${e.context}`),e.file&&(t+=` ${E(`Read more: `)}
https://github.com/muxinc/elements/blob/main/errors/${e.file}`),aS(t)}var cS={AUTOPLAY:`autoplay`,CROSSORIGIN:`crossorigin`,LOOP:`loop`,MUTED:`muted`,PLAYSINLINE:`playsinline`,PRELOAD:`preload`},lS={VOLUME:`volume`,PLAYBACKRATE:`playbackrate`,MUTED:`muted`};({...cS,...lS});var uS=Object.freeze({length:0,start(e){let t=e>>>0;if(t>=this.length)throw new DOMException(`Failed to execute 'start' on 'TimeRanges': The index provided (${t}) is greater than or equal to the maximum bound (${this.length}).`);return 0},end(e){let t=e>>>0;if(t>=this.length)throw new DOMException(`Failed to execute 'end' on 'TimeRanges': The index provided (${t}) is greater than or equal to the maximum bound (${this.length}).`);return 0}}),dS=Object.values(cS).filter(e=>cS.PLAYSINLINE!==e),fS=Object.values(lS),pS=[...dS,...fS],mS=class extends Lx.HTMLElement{static get observedAttributes(){return pS}constructor(){super()}attributeChangedCallback(e,t,n){switch(e){case lS.MUTED:this.media&&(this.media.muted=n!=null,this.media.defaultMuted=n!=null);return;case lS.VOLUME:{let e=Hx(n)??1;this.media&&(this.media.volume=e);return}case lS.PLAYBACKRATE:{let e=Hx(n)??1;this.media&&(this.media.playbackRate=e,this.media.defaultPlaybackRate=e);return}}}play(){return this.media?.play()??Promise.reject()}pause(){var e;(e=this.media)==null||e.pause()}load(){var e;(e=this.media)==null||e.load()}get media(){return this.shadowRoot?.querySelector(`mux-video`)}get audioTracks(){return this.media.audioTracks}get videoTracks(){return this.media.videoTracks}get audioRenditions(){return this.media.audioRenditions}get videoRenditions(){return this.media.videoRenditions}get paused(){return this.media?.paused??!0}get duration(){return this.media?.duration??NaN}get ended(){return this.media?.ended??!1}get buffered(){return this.media?.buffered??uS}get seekable(){return this.media?.seekable??uS}get readyState(){return this.media?.readyState??0}get videoWidth(){return this.media?.videoWidth??0}get videoHeight(){return this.media?.videoHeight??0}get currentSrc(){return this.media?.currentSrc??``}get currentTime(){return this.media?.currentTime??0}set currentTime(e){this.media&&(this.media.currentTime=Number(e))}get volume(){return this.media?.volume??1}set volume(e){this.media&&(this.media.volume=Number(e))}get playbackRate(){return this.media?.playbackRate??1}set playbackRate(e){this.media&&(this.media.playbackRate=Number(e))}get defaultPlaybackRate(){return Hx(this.getAttribute(lS.PLAYBACKRATE))??1}set defaultPlaybackRate(e){e==null?this.removeAttribute(lS.PLAYBACKRATE):this.setAttribute(lS.PLAYBACKRATE,`${e}`)}get crossOrigin(){return hS(this,cS.CROSSORIGIN)}set crossOrigin(e){this.setAttribute(cS.CROSSORIGIN,`${e}`)}get autoplay(){return hS(this,cS.AUTOPLAY)!=null}set autoplay(e){e?this.setAttribute(cS.AUTOPLAY,typeof e==`string`?e:``):this.removeAttribute(cS.AUTOPLAY)}get loop(){return hS(this,cS.LOOP)!=null}set loop(e){e?this.setAttribute(cS.LOOP,``):this.removeAttribute(cS.LOOP)}get muted(){return this.media?.muted??!1}set muted(e){this.media&&(this.media.muted=!!e)}get defaultMuted(){return hS(this,cS.MUTED)!=null}set defaultMuted(e){e?this.setAttribute(cS.MUTED,``):this.removeAttribute(cS.MUTED)}get playsInline(){return hS(this,cS.PLAYSINLINE)!=null}set playsInline(e){oS(`playsInline is set to true by default and is not currently supported as a setter.`)}get preload(){return this.media?this.media.preload:this.getAttribute(`preload`)}set preload(e){[``,`none`,`metadata`,`auto`].includes(e)?this.setAttribute(cS.PRELOAD,e):this.removeAttribute(cS.PRELOAD)}};function hS(e,t){return e.media?e.media.getAttribute(t):e.getAttribute(t)}var gS=mS,_S=`:host {
...
`,vS=new WeakMap,yS=class e{constructor(e,t){this.element=e,this.type=t,this.element.addEventListener(this.type,this);let n=vS.get(this.element);n&&n.set(this.type,this)}set(e){if(typeof e==`function`)this.handleEvent=e.bind(this.element);else if(typeof e==`object`&&typeof e.handleEvent==`function`)this.handleEvent=e.handleEvent.bind(e);else{this.element.removeEventListener(this.type,this);let e=vS.get(this.element);e&&e.delete(this.type)}}static for(t){vS.has(t.element)||vS.set(t.element,new Map);let n=t.attributeName.slice(2),r=vS.get(t.element);return r&&r.has(n)?r.get(n):new e(t.element,n)}};function bS(e,t){return e instanceof d_&&e.attributeName.startsWith(`on`)?(yS.for(e).set(t),e.element.removeAttributeNS(e.attributeNamespace,e.attributeName),!0):!1}function xS(e,t){return t instanceof jS&&e instanceof f_?(t.renderInto(e),!0):!1}function SS(e,t){return t instanceof DocumentFragment&&e instanceof f_?(t.childNodes.length&&e.replace(...t.childNodes),!0):!1}function CS(e,t){if(e instanceof d_){let n=e.attributeNamespace,r=e.element.getAttributeNS(n,e.attributeName);return String(t)!==r&&(e.value=String(t)),!0}return e.value=String(t),!0}function wS(e,t){if(e instanceof d_&&t instanceof Element){let n=e.element;return n[e.attributeName]!==t&&(e.element.removeAttributeNS(e.attributeNamespace,e.attributeName),n[e.attributeName]=t),!0}return!1}function TS(e,t){if(typeof t==`boolean`&&e instanceof d_){let n=e.attributeNamespace;return t!==e.element.hasAttributeNS(n,e.attributeName)&&(e.booleanValue=t),!0}return!1}function ES(e,t){return t===!1&&e instanceof f_?(e.replace(``),!0):!1}function DS(e,t){wS(e,t)||TS(e,t)||bS(e,t)||ES(e,t)||xS(e,t)||SS(e,t)||CS(e,t)}var OS=new Map,kS=new WeakMap,AS=new WeakMap,jS=class{constructor(e,t,n){this.strings=e,this.values=t,this.processor=n,this.stringsKey=this.strings.join(``)}get template(){if(OS.has(this.stringsKey))return OS.get(this.stringsKey);{let e=Rx.createElement(`template`),t=this.strings.length-1;return e.innerHTML=this.strings.reduce((e,n,r)=>e+n+(r<t?`{{ ${r} }}`:``),``),OS.set(this.stringsKey,e),e}}renderInto(e){var t;let n=this.template;if(kS.get(e)!==n){kS.set(e,n);let t=new r_(n,this.values,this.processor);AS.set(e,t),e instanceof f_?e.replace(...t.children):e.appendChild(t);return}let r=AS.get(e);(t=r?.update)==null||t.call(r,this.values)}},MS={processCallback(e,t,n){if(n)for(let[e,r]of t)e in n&&DS(r,n[e]??``)}};function NS(e,...t){return new jS(e,t,MS)}function PS(e,t){e.renderInto(t)}var FS=e=>{let{tokens:t}=e;return t.drm?`:host(:not([cast-receiver])) { --_cast-button-drm-display: none; }`:``},IS=e=>NS`
  <style>
    ${FS(e)}
    ${_S}
  </style>
  ${zS(e)}
`,LS=e=>{let t=e.hotKeys?`${e.hotKeys}`:``;return Zx(e.streamType)===`live`&&(t+=` noarrowleft noarrowright`),t},RS=Object.values({TOP:`top`,CENTER:`center`,BOTTOM:`bottom`,LAYER:`layer`,MEDIA_LAYER:`media-layer`,POSTER_LAYER:`poster-layer`,VERTICAL_LAYER:`vertical-layer`,CENTERED_LAYER:`centered-layer`,GESTURE_LAYER:`gesture-layer`,CONTROLLER_LAYER:`controller`,BUTTON:`button`,RANGE:`range`,THUMB:`thumb`,DISPLAY:`display`,CONTROL_BAR:`control-bar`,MENU_BUTTON:`menu-button`,MENU:`menu`,MENU_ITEM:`menu-item`,OPTION:`option`,POSTER:`poster`,LIVE:`live`,PLAY:`play`,PRE_PLAY:`pre-play`,SEEK_BACKWARD:`seek-backward`,SEEK_FORWARD:`seek-forward`,MUTE:`mute`,CAPTIONS:`captions`,AIRPLAY:`airplay`,PIP:`pip`,FULLSCREEN:`fullscreen`,CAST:`cast`,PLAYBACK_RATE:`playback-rate`,VOLUME:`volume`,TIME:`time`,TITLE:`title`,AUDIO_TRACK:`audio-track`,RENDITION:`rendition`}).join(`, `),zS=e=>{var t;return NS`
  <media-theme
    ...
    audio="${e.audio??!1}"
    style="${zx({"--media-primary-color":e.primaryColor,"--media-secondary-color":e.secondaryColor,"--media-accent-color":e.accentColor})??!1}"
  ...
  >
    ...
    >
      ${e.storyboard?NS`<track label="thumbnails" default kind="metadata" src="${e.storyboard}" />`:NS``}
      <slot></slot>
    </mux-video>
...
`,qS=Rx.createElement(`template`);`innerHTML`in qS&&(qS.innerHTML=KS);var JS=class extends G_{};JS.template=qS.content?.children?.[0],Lx.customElements.get(`media-theme-gerwig`)||Lx.customElements.define(`media-theme-gerwig`,JS);var YS=`gerwig`,XS={SRC:`src`,POSTER:`poster`},Z={STYLE:`style`,DEFAULT_HIDDEN_CAPTIONS:`default-hidden-captions`,PRIMARY_COLOR:`primary-color`,SECONDARY_COLOR:`secondary-color`,ACCENT_COLOR:`accent-color`,FORWARD_SEEK_OFFSET:`forward-seek-offset`,BACKWARD_SEEK_OFFSET:`backward-seek-offset`,PLAYBACK_TOKEN:`playback-token`,THUMBNAIL_TOKEN:`thumbnail-token`,STORYBOARD_TOKEN:`storyboard-token`,FULLSCREEN_ELEMENT:`fullscreen-element`,DRM_TOKEN:`drm-token`,STORYBOARD_SRC:`storyboard-src`,THUMBNAIL_TIME:`thumbnail-time`,AUDIO:`audio`,NOHOTKEYS:`nohotkeys`,HOTKEYS:`hotkeys`,PLAYBACK_RATES:`playbackrates`,DEFAULT_SHOW_REMAINING_TIME:`default-show-remaining-time`,DEFAULT_DURATION:`default-duration`,TITLE:`title`,VIDEO_TITLE:`video-title`,PLACEHOLDER:`placeholder`,THEME:`theme`,DEFAULT_STREAM_TYPE:`default-stream-type`,TARGET_LIVE_WINDOW:`target-live-window`,EXTRA_SOURCE_PARAMS:`extra-source-params`,NO_VOLUME_PREF:`no-volume-pref`,NO_MUTED_PREF:`no-muted-pref`,CAST_RECEIVER:`cast-receiver`,NO_TOOLTIPS:`no-tooltips`,PROUDLY_DISPLAY_MUX_BADGE:`proudly-display-mux-badge`,DISABLE_PSEUDO_ENDED:`disable-pseudo-ended`},ZS=[`audio`,`backwardseekoffset`,`defaultduration`,`defaultshowremainingtime`,`defaultsubtitles`,`noautoseektolive`,`disabled`,`exportparts`,`forwardseekoffset`,`hideduration`,`hotkeys`,`nohotkeys`,`playbackrates`,`defaultstreamtype`,`streamtype`,`style`,`targetlivewindow`,`template`,`title`,`videotitle`,`novolumepref`,`nomutedpref`,`proudlydisplaymuxbadge`];function QS(e,t){return{src:!e.playbackId&&e.src,playbackId:e.playbackId,hasSrc:!!e.playbackId||!!e.src||!!e.currentSrc,poster:e.poster,storyboard:e.media?.currentSrc&&e.storyboard,storyboardSrc:e.getAttribute(Z.STORYBOARD_SRC),fullscreenElement:e.getAttribute(Z.FULLSCREEN_ELEMENT),placeholder:e.getAttribute(`placeholder`),themeTemplate:eC(e),thumbnailTime:!e.tokens.thumbnail&&e.thumbnailTime,autoplay:e.autoplay,crossOrigin:e.crossOrigin,loop:e.loop,noHotKeys:e.hasAttribute(Z.NOHOTKEYS),hotKeys:e.getAttribute(Z.HOTKEYS),muted:e.muted,paused:e.paused,preload:e.preload,envKey:e.envKey,preferCmcd:e.preferCmcd,debug:e.debug,disableTracking:e.disableTracking,disableCookies:e.disableCookies,tokens:e.tokens,beaconCollectionDomain:e.beaconCollectionDomain,maxResolution:e.maxResolution,minResolution:e.minResolution,maxAutoResolution:e.maxAutoResolution,programStartTime:e.programStartTime,programEndTime:e.programEndTime,assetStartTime:e.assetStartTime,assetEndTime:e.assetEndTime,renditionOrder:e.renditionOrder,metadata:e.metadata,playerInitTime:e.playerInitTime,playerSoftwareName:e.playerSoftwareName,playerSoftwareVersion:e.playerSoftwareVersion,startTime:e.startTime,initialBandwidthEstimateKbps:e.initialBandwidthEstimateKbps,initialEstimateSegments:e.initialEstimateSegments,minPreloadSegments:e.minPreloadSegments,preferPlayback:e.preferPlayback,audio:e.audio,defaultStreamType:e.defaultStreamType,targetLiveWindow:e.getAttribute(O.TARGET_LIVE_WINDOW),streamType:Zx(e.getAttribute(O.STREAM_TYPE)),primaryColor:e.getAttribute(Z.PRIMARY_COLOR),secondaryColor:e.getAttribute(Z.SECONDARY_COLOR),accentColor:e.getAttribute(Z.ACCENT_COLOR),forwardSeekOffset:e.forwardSeekOffset,backwardSeekOffset:e.backwardSeekOffset,defaultHiddenCaptions:e.defaultHiddenCaptions,defaultDuration:e.defaultDuration,defaultShowRemainingTime:e.defaultShowRemainingTime,hideDuration:tC(e),playbackRates:e.getAttribute(Z.PLAYBACK_RATES),customDomain:e.getAttribute(O.CUSTOM_DOMAIN)??void 0,title:e.getAttribute(Z.TITLE),videoTitle:e.getAttribute(Z.VIDEO_TITLE)??e.getAttribute(Z.TITLE),novolumepref:e.hasAttribute(Z.NO_VOLUME_PREF),nomutedpref:e.hasAttribute(Z.NO_MUTED_PREF),proudlyDisplayMuxBadge:e.hasAttribute(Z.PROUDLY_DISPLAY_MUX_BADGE),castReceiver:e.castReceiver,disablePseudoEnded:e.hasAttribute(Z.DISABLE_PSEUDO_ENDED),capRenditionToPlayerSize:e.capRenditionToPlayerSize,...t,extraSourceParams:e.extraSourceParams}}var $S=sp.formatErrorMessage;sp.formatErrorMessage=e=>{if(e instanceof w){let t=US(e,!1);return`
    ...
    `}return $S(e)};function eC(e){var t;let n=e.theme;if(n){let r=((t=e.getRootNode())?.getElementById)?.call(t,n);if(r&&r instanceof HTMLTemplateElement)return r;n.startsWith(`media-theme-`)||(n=`media-theme-${n}`);let i=Lx.customElements.get(n);if(i!=null&&i.template)return i.template}}function tC(e){let t=e.mediaController?.querySelector(`media-time-display`);return t&&getComputedStyle(t).getPropertyValue(`--media-duration-display-display`).trim()===`none`}function nC(e){let t=e.videoTitle?{video_title:e.videoTitle}:{};return e.getAttributeNames().filter(e=>e.startsWith(`metadata-`)).reduce((t,n)=>{let r=e.getAttribute(n);return r!==null&&(t[n.replace(/^metadata-/,``).replace(/-/g,`_`)]=r),t},t)}var rC=Object.values(O),iC=Object.values(XS),aC=Object.values(Z),oC=Jx(),sC=`mux-player`,cC={isDialogOpen:!1},lC={redundant_streams:!0},uC,dC,fC,pC,mC,hC,gC,_C,vC,yC,bC,xC,Q,SC,CC,wC,TC,EC,DC,OC,kC,AC=class extends gS{constructor(){super(),Tx(this,Q),Tx(this,uC),Tx(this,dC,!1),Tx(this,fC,{}),Tx(this,pC,!0),Tx(this,mC,new rS(this,`hotkeys`)),Tx(this,hC),Tx(this,gC,()=>Dx(this,Q,TC).call(this)),Tx(this,_C,()=>Dx(this,Q,TC).call(this)),Tx(this,vC,()=>Dx(this,Q,TC).call(this)),Tx(this,yC),Tx(this,bC,{...cC,onCloseErrorDialog:e=>{e.composedPath()[0]?.localName===`media-error-dialog`&&Dx(this,Q,wC).call(this,{isDialogOpen:!1})},onFocusInErrorDialog:e=>{e.composedPath()[0]?.localName===`media-error-dialog`&&(Gx(this,Rx.activeElement)||e.preventDefault())}}),Tx(this,xC,e=>{let t=this.media?.error;if(!(t instanceof w)){let{message:e,code:n}=t??{};t=new w(e,n)}if(!(t!=null&&t.fatal)){aS(t),t.data&&aS(`${t.name} data:`,t.data);return}let n=GS(t,!1);n.message&&sS(n),oS(t),t.data&&oS(`${t.name} data:`,t.data),Dx(this,Q,wC).call(this,{isDialogOpen:!0})}),Ex(this,uC,na()),this.attachShadow({mode:`open`}),Dx(this,Q,CC).call(this),this.isConnected&&Dx(this,Q,SC).call(this)}static get NAME(){return sC}static get VERSION(){return oC}static get observedAttributes(){return[...gS.observedAttributes??[],...iC,...rC,...aC]}get mediaTheme(){return this.shadowRoot?.querySelector(`media-theme`)}get mediaController(){return(this.mediaTheme?.shadowRoot)?.querySelector(`media-controller`)}connectedCallback(){Dx(this,Q,SC).call(this);let e=this.media;e&&(e.metadata=nC(this))}disconnectedCallback(){var e,t,n,r,i,a;(e=X(this,hC))==null||e.disconnect(),(t=this.media)==null||t.removeEventListener(`streamtypechange`,X(this,gC)),(n=this.media)==null||n.removeEventListener(`loadstart`,X(this,_C)),this.removeEventListener(`error`,X(this,xC)),this.media&&(this.media.errorTranslator=void 0),(r=this.media?.textTracks)==null||r.removeEventListener(`addtrack`,X(this,vC)),(i=this.media?.textTracks)==null||i.removeEventListener(`removetrack`,X(this,vC)),(a=X(this,yC))==null||a.call(this),Ex(this,yC,void 0),Ex(this,dC,!1)}attributeChangedCallback(e,t,n){switch(Dx(this,Q,SC).call(this),super.attributeChangedCallback(e,t,n),e){case Z.HOTKEYS:X(this,mC).value=n;break;case Z.THUMBNAIL_TIME:n!=null&&this.tokens.thumbnail&&aS(E(`Use of thumbnail-time with thumbnail-token is currently unsupported. Ignore thumbnail-time.`).toString());break;case Z.THUMBNAIL_TOKEN:if(n){let e=Lr(n);if(e){let{aud:t}=e,n=bi.THUMBNAIL;t!==n&&aS(E(`The {tokenNamePrefix}-token has an incorrect aud value: {aud}. aud value should be {expectedAud}.`).format({aud:t,expectedAud:n,tokenNamePrefix:`thumbnail`}))}}break;case Z.STORYBOARD_TOKEN:if(n){let e=Lr(n);if(e){let{aud:t}=e,n=bi.STORYBOARD;t!==n&&aS(E(`The {tokenNamePrefix}-token has an incorrect aud value: {aud}. aud value should be {expectedAud}.`).format({aud:t,expectedAud:n,tokenNamePrefix:`storyboard`}))}}break;case Z.DRM_TOKEN:if(n){let e=Lr(n);if(e){let{aud:t}=e,n=bi.DRM;t!==n&&aS(E(`The {tokenNamePrefix}-token has an incorrect aud value: {aud}. aud value should be {expectedAud}.`).format({aud:t,expectedAud:n,tokenNamePrefix:`drm`}))}}break;case O.PLAYBACK_ID:n!=null&&n.includes(`?token`)&&oS(E(`The specificed playback ID {playbackId} contains a token which must be provided via the playback-token attribute.`).format({playbackId:n}));break;case O.STREAM_TYPE:n&&![T.LIVE,T.ON_DEMAND,T.UNKNOWN].includes(n)?[`ll-live`,`live:dvr`,`ll-live:dvr`].includes(this.streamType)?this.targetLiveWindow=n.includes(`dvr`)?1/0:0:sS({file:`invalid-stream-type.md`,message:E("Invalid stream-type value supplied: `{streamType}`. Please provide stream-type as either: `on-demand` or `live`").format({streamType:this.streamType})}):n===T.LIVE?this.getAttribute(Z.TARGET_LIVE_WINDOW)??(this.targetLiveWindow=0):this.targetLiveWindow=NaN;break;case Z.FULLSCREEN_ELEMENT:if(n!=null||n!==t){let e=Rx.getElementById(n),t=e?.querySelector(`mux-player`);this.mediaController&&e&&t&&(this.mediaController.fullscreenElement=e)}break;case O.CAP_RENDITION_TO_PLAYER_SIZE:(n==null||n!==t)&&(this.capRenditionToPlayerSize=n==null?void 0:!0);break}[O.PLAYBACK_ID,XS.SRC,Z.PLAYBACK_TOKEN].includes(e)&&t!==n&&Ex(this,bC,{...X(this,bC),...cC}),Dx(this,Q,TC).call(this,{[$x(e)]:n})}async requestFullscreen(e){var t;if(!(!this.mediaController||this.mediaController.hasAttribute(j.MEDIA_IS_FULLSCREEN)))return(t=this.mediaController)==null||t.dispatchEvent(new Lx.CustomEvent(k.MEDIA_ENTER_FULLSCREEN_REQUEST,{composed:!0,bubbles:!0})),new Promise((e,t)=>{var n;(n=this.mediaController)==null||n.addEventListener(os.MEDIA_IS_FULLSCREEN,()=>e(),{once:!0})})}async exitFullscreen(){var e;if(!(!this.mediaController||!this.mediaController.hasAttribute(j.MEDIA_IS_FULLSCREEN)))return(e=this.mediaController)==null||e.dispatchEvent(new Lx.CustomEvent(k.MEDIA_EXIT_FULLSCREEN_REQUEST,{composed:!0,bubbles:!0})),new Promise((e,t)=>{var n;(n=this.mediaController)==null||n.addEventListener(os.MEDIA_IS_FULLSCREEN,()=>e(),{once:!0})})}get preferCmcd(){return this.getAttribute(O.PREFER_CMCD)??void 0}set preferCmcd(e){e!==this.preferCmcd&&(e?vr.includes(e)?this.setAttribute(O.PREFER_CMCD,e):aS(`Invalid value for preferCmcd. Must be one of ${vr.join()}`):this.removeAttribute(O.PREFER_CMCD))}get hasPlayed(){return this.mediaController?.hasAttribute(j.MEDIA_HAS_PLAYED)??!1}get inLiveWindow(){return this.mediaController?.hasAttribute(j.MEDIA_TIME_IS_LIVE)}get _hls(){return this.media?._hls}get mux(){return this.media?.mux}get theme(){return this.getAttribute(Z.THEME)??YS}set theme(e){this.setAttribute(Z.THEME,`${e}`)}get themeProps(){let e=this.mediaTheme;if(!e)return;let t={};for(let n of e.getAttributeNames()){if(ZS.includes(n))continue;let r=e.getAttribute(n);t[Vx(n)]=r===``?!0:r}return t}set themeProps(e){var t,n;Dx(this,Q,SC).call(this);let r={...this.themeProps,...e};for(let i in r){if(ZS.includes(i))continue;let r=e?.[i];typeof r==`boolean`||r==null?(t=this.mediaTheme)==null||t.toggleAttribute(Bx(i),!!r):(n=this.mediaTheme)==null||n.setAttribute(Bx(i),r)}}get playbackId(){return this.getAttribute(O.PLAYBACK_ID)??void 0}set playbackId(e){e?this.setAttribute(O.PLAYBACK_ID,e):this.removeAttribute(O.PLAYBACK_ID)}get src(){return this.playbackId?jC(this,XS.SRC)??void 0:this.getAttribute(XS.SRC)??void 0}set src(e){e?this.setAttribute(XS.SRC,e):this.removeAttribute(XS.SRC)}get poster(){let e=this.getAttribute(XS.POSTER);if(e!=null)return e;let{tokens:t}=this;if(t.playback&&!t.thumbnail){aS(`Missing expected thumbnail token. No poster image will be shown`);return}if(this.playbackId&&!this.audio)return Yx(this.playbackId,{customDomain:this.customDomain,thumbnailTime:this.thumbnailTime??this.startTime,programTime:this.programStartTime,token:t.thumbnail})}set poster(e){e||e===``?this.setAttribute(XS.POSTER,e):this.removeAttribute(XS.POSTER)}get storyboardSrc(){return this.getAttribute(Z.STORYBOARD_SRC)??void 0}set storyboardSrc(e){e?this.setAttribute(Z.STORYBOARD_SRC,e):this.removeAttribute(Z.STORYBOARD_SRC)}get storyboard(){let{tokens:e}=this;if(this.storyboardSrc&&!e.storyboard)return this.storyboardSrc;if(!(this.audio||!this.playbackId||!this.streamType||[T.LIVE,T.UNKNOWN].includes(this.streamType)||e.playback&&!e.storyboard))return Xx(this.playbackId,{customDomain:this.customDomain,token:e.storyboard,programStartTime:this.programStartTime,programEndTime:this.programEndTime})}get audio(){return this.hasAttribute(Z.AUDIO)}set audio(e){if(!e){this.removeAttribute(Z.AUDIO);return}this.setAttribute(Z.AUDIO,``)}get hotkeys(){return X(this,mC)}get nohotkeys(){return this.hasAttribute(Z.NOHOTKEYS)}set nohotkeys(e){if(!e){this.removeAttribute(Z.NOHOTKEYS);return}this.setAttribute(Z.NOHOTKEYS,``)}get thumbnailTime(){return Hx(this.getAttribute(Z.THUMBNAIL_TIME))}set thumbnailTime(e){this.setAttribute(Z.THUMBNAIL_TIME,`${e}`)}get videoTitle(){return this.getAttribute(Z.VIDEO_TITLE)??this.getAttribute(Z.TITLE)??``}set videoTitle(e){e!==this.videoTitle&&(e?this.setAttribute(Z.VIDEO_TITLE,e):this.removeAttribute(Z.VIDEO_TITLE))}get placeholder(){return jC(this,Z.PLACEHOLDER)??``}set placeholder(e){this.setAttribute(Z.PLACEHOLDER,`${e}`)}get primaryColor(){let e=this.getAttribute(Z.PRIMARY_COLOR);if(e!=null||this.mediaTheme&&(e=(Lx.getComputedStyle(this.mediaTheme)?.getPropertyValue(`--_primary-color`))?.trim(),e))return e}set primaryColor(e){this.setAttribute(Z.PRIMARY_COLOR,`${e}`)}get secondaryColor(){let e=this.getAttribute(Z.SECONDARY_COLOR);if(e!=null||this.mediaTheme&&(e=(Lx.getComputedStyle(this.mediaTheme)?.getPropertyValue(`--_secondary-color`))?.trim(),e))return e}set secondaryColor(e){this.setAttribute(Z.SECONDARY_COLOR,`${e}`)}get accentColor(){let e=this.getAttribute(Z.ACCENT_COLOR);if(e!=null||this.mediaTheme&&(e=(Lx.getComputedStyle(this.mediaTheme)?.getPropertyValue(`--_accent-color`))?.trim(),e))return e}set accentColor(e){this.setAttribute(Z.ACCENT_COLOR,`${e}`)}get defaultShowRemainingTime(){return this.hasAttribute(Z.DEFAULT_SHOW_REMAINING_TIME)}set defaultShowRemainingTime(e){e?this.setAttribute(Z.DEFAULT_SHOW_REMAINING_TIME,``):this.removeAttribute(Z.DEFAULT_SHOW_REMAINING_TIME)}get playbackRates(){if(this.hasAttribute(Z.PLAYBACK_RATES))return this.getAttribute(Z.PLAYBACK_RATES).trim().split(/\s*,?\s+/).map(e=>Number(e)).filter(e=>!Number.isNaN(e)).sort((e,t)=>e-t)}set playbackRates(e){if(!e){this.removeAttribute(Z.PLAYBACK_RATES);return}this.setAttribute(Z.PLAYBACK_RATES,e.join(` `))}get forwardSeekOffset(){return Hx(this.getAttribute(Z.FORWARD_SEEK_OFFSET))??10}set forwardSeekOffset(e){this.setAttribute(Z.FORWARD_SEEK_OFFSET,`${e}`)}get backwardSeekOffset(){return Hx(this.getAttribute(Z.BACKWARD_SEEK_OFFSET))??10}set backwardSeekOffset(e){this.setAttribute(Z.BACKWARD_SEEK_OFFSET,`${e}`)}get defaultHiddenCaptions(){return this.hasAttribute(Z.DEFAULT_HIDDEN_CAPTIONS)}set defaultHiddenCaptions(e){e?this.setAttribute(Z.DEFAULT_HIDDEN_CAPTIONS,``):this.removeAttribute(Z.DEFAULT_HIDDEN_CAPTIONS)}get defaultDuration(){return Hx(this.getAttribute(Z.DEFAULT_DURATION))}set defaultDuration(e){e==null?this.removeAttribute(Z.DEFAULT_DURATION):this.setAttribute(Z.DEFAULT_DURATION,`${e}`)}get playerInitTime(){return this.hasAttribute(O.PLAYER_INIT_TIME)?Hx(this.getAttribute(O.PLAYER_INIT_TIME)):X(this,uC)}set playerInitTime(e){e!=this.playerInitTime&&(e==null?this.removeAttribute(O.PLAYER_INIT_TIME):this.setAttribute(O.PLAYER_INIT_TIME,`${+e}`))}get playerSoftwareName(){return this.getAttribute(O.PLAYER_SOFTWARE_NAME)??sC}get playerSoftwareVersion(){return this.getAttribute(O.PLAYER_SOFTWARE_VERSION)??oC}get beaconCollectionDomain(){return this.getAttribute(O.BEACON_COLLECTION_DOMAIN)??void 0}set beaconCollectionDomain(e){e!==this.beaconCollectionDomain&&(e?this.setAttribute(O.BEACON_COLLECTION_DOMAIN,e):this.removeAttribute(O.BEACON_COLLECTION_DOMAIN))}get maxResolution(){return this.getAttribute(O.MAX_RESOLUTION)??void 0}set maxResolution(e){e!==this.maxResolution&&(e?this.setAttribute(O.MAX_RESOLUTION,e):this.removeAttribute(O.MAX_RESOLUTION))}get minResolution(){return this.getAttribute(O.MIN_RESOLUTION)??void 0}set minResolution(e){e!==this.minResolution&&(e?this.setAttribute(O.MIN_RESOLUTION,e):this.removeAttribute(O.MIN_RESOLUTION))}get maxAutoResolution(){return this.getAttribute(O.MAX_AUTO_RESOLUTION)??void 0}set maxAutoResolution(e){e==null?this.removeAttribute(O.MAX_AUTO_RESOLUTION):this.setAttribute(O.MAX_AUTO_RESOLUTION,e)}get renditionOrder(){return this.getAttribute(O.RENDITION_ORDER)??void 0}set renditionOrder(e){e!==this.renditionOrder&&(e?this.setAttribute(O.RENDITION_ORDER,e):this.removeAttribute(O.RENDITION_ORDER))}get programStartTime(){return Hx(this.getAttribute(O.PROGRAM_START_TIME))}set programStartTime(e){e==null?this.removeAttribute(O.PROGRAM_START_TIME):this.setAttribute(O.PROGRAM_START_TIME,`${e}`)}get programEndTime(){return Hx(this.getAttribute(O.PROGRAM_END_TIME))}set programEndTime(e){e==null?this.removeAttribute(O.PROGRAM_END_TIME):this.setAttribute(O.PROGRAM_END_TIME,`${e}`)}get assetStartTime(){return Hx(this.getAttribute(O.ASSET_START_TIME))}set assetStartTime(e){e==null?this.removeAttribute(O.ASSET_START_TIME):this.setAttribute(O.ASSET_START_TIME,`${e}`)}get assetEndTime(){return Hx(this.getAttribute(O.ASSET_END_TIME))}set assetEndTime(e){e==null?this.removeAttribute(O.ASSET_END_TIME):this.setAttribute(O.ASSET_END_TIME,`${e}`)}get extraSourceParams(){return this.hasAttribute(Z.EXTRA_SOURCE_PARAMS)?[...new URLSearchParams(this.getAttribute(Z.EXTRA_SOURCE_PARAMS)).entries()].reduce((e,[t,n])=>(e[t]=n,e),{}):lC}set extraSourceParams(e){e==null?this.removeAttribute(Z.EXTRA_SOURCE_PARAMS):this.setAttribute(Z.EXTRA_SOURCE_PARAMS,new URLSearchParams(e).toString())}get customDomain(){return this.getAttribute(O.CUSTOM_DOMAIN)??void 0}set customDomain(e){e!==this.customDomain&&(e?this.setAttribute(O.CUSTOM_DOMAIN,e):this.removeAttribute(O.CUSTOM_DOMAIN))}get envKey(){return jC(this,O.ENV_KEY)??void 0}set envKey(e){this.setAttribute(O.ENV_KEY,`${e}`)}get noVolumePref(){return this.hasAttribute(Z.NO_VOLUME_PREF)}set noVolumePref(e){e?this.setAttribute(Z.NO_VOLUME_PREF,``):this.removeAttribute(Z.NO_VOLUME_PREF)}get noMutedPref(){return this.hasAttribute(Z.NO_MUTED_PREF)}set noMutedPref(e){e?this.setAttribute(Z.NO_MUTED_PREF,``):this.removeAttribute(Z.NO_MUTED_PREF)}get debug(){return jC(this,O.DEBUG)!=null}set debug(e){e?this.setAttribute(O.DEBUG,``):this.removeAttribute(O.DEBUG)}get disableTracking(){return jC(this,O.DISABLE_TRACKING)!=null}set disableTracking(e){this.toggleAttribute(O.DISABLE_TRACKING,!!e)}get disableCookies(){return jC(this,O.DISABLE_COOKIES)!=null}set disableCookies(e){e?this.setAttribute(O.DISABLE_COOKIES,``):this.removeAttribute(O.DISABLE_COOKIES)}get streamType(){return this.getAttribute(O.STREAM_TYPE)??this.media?.streamType??T.UNKNOWN}set streamType(e){this.setAttribute(O.STREAM_TYPE,`${e}`)}get defaultStreamType(){return this.getAttribute(Z.DEFAULT_STREAM_TYPE)??this.mediaController?.getAttribute(Z.DEFAULT_STREAM_TYPE)??T.ON_DEMAND}set defaultStreamType(e){e?this.setAttribute(Z.DEFAULT_STREAM_TYPE,e):this.removeAttribute(Z.DEFAULT_STREAM_TYPE)}get targetLiveWindow(){return this.hasAttribute(Z.TARGET_LIVE_WINDOW)?+this.getAttribute(Z.TARGET_LIVE_WINDOW):this.media?.targetLiveWindow??NaN}set targetLiveWindow(e){e==this.targetLiveWindow||Number.isNaN(e)&&Number.isNaN(this.targetLiveWindow)||(e==null?this.removeAttribute(Z.TARGET_LIVE_WINDOW):this.setAttribute(Z.TARGET_LIVE_WINDOW,`${+e}`))}get liveEdgeStart(){return this.media?.liveEdgeStart}get startTime(){return Hx(jC(this,O.START_TIME))}set startTime(e){this.setAttribute(O.START_TIME,`${e}`)}get initialBandwidthEstimateKbps(){return Hx(jC(this,O.INITIAL_BANDWIDTH_ESTIMATE_KBPS))}set initialBandwidthEstimateKbps(e){e==null?this.removeAttribute(O.INITIAL_BANDWIDTH_ESTIMATE_KBPS):this.setAttribute(O.INITIAL_BANDWIDTH_ESTIMATE_KBPS,`${e}`)}get initialEstimateSegments(){return Hx(jC(this,O.INITIAL_ESTIMATE_SEGMENTS))}set initialEstimateSegments(e){e==null?this.removeAttribute(O.INITIAL_ESTIMATE_SEGMENTS):this.setAttribute(O.INITIAL_ESTIMATE_SEGMENTS,`${e}`)}get minPreloadSegments(){return Hx(jC(this,O.MIN_PRELOAD_SEGMENTS))}set minPreloadSegments(e){e==null?this.removeAttribute(O.MIN_PRELOAD_SEGMENTS):this.setAttribute(O.MIN_PRELOAD_SEGMENTS,`${e}`)}get preferPlayback(){let e=this.getAttribute(O.PREFER_PLAYBACK);if(e===gr.MSE||e===gr.NATIVE)return e}set preferPlayback(e){e!==this.preferPlayback&&(e===gr.MSE||e===gr.NATIVE?this.setAttribute(O.PREFER_PLAYBACK,e):this.removeAttribute(O.PREFER_PLAYBACK))}get metadata(){return this.media?.metadata}set metadata(e){if(Dx(this,Q,SC).call(this),!this.media){oS(`underlying media element missing when trying to set metadata. metadata will not be set.`);return}this.media.metadata={...nC(this),...e}}get _hlsConfig(){return this.media?._hlsConfig}set _hlsConfig(e){if(Dx(this,Q,SC).call(this),!this.media){oS(`underlying media element missing when trying to set _hlsConfig. _hlsConfig will not be set.`);return}this.media._hlsConfig=e}async addCuePoints(e){if(Dx(this,Q,SC).call(this),!this.media){oS(`underlying media element missing when trying to addCuePoints. cuePoints will not be added.`);return}return this.media?.addCuePoints(e)}get activeCuePoint(){return this.media?.activeCuePoint}get cuePoints(){return this.media?.cuePoints??[]}addChapters(e){if(Dx(this,Q,SC).call(this),!this.media){oS(`underlying media element missing when trying to addChapters. chapters will not be added.`);return}return this.media?.addChapters(e)}get activeChapter(){return this.media?.activeChapter}get chapters(){return this.media?.chapters??[]}getStartDate(){return this.media?.getStartDate()}get currentPdt(){return this.media?.currentPdt}get tokens(){let e=this.getAttribute(Z.PLAYBACK_TOKEN),t=this.getAttribute(Z.DRM_TOKEN),n=this.getAttribute(Z.THUMBNAIL_TOKEN),r=this.getAttribute(Z.STORYBOARD_TOKEN);return{...X(this,fC),...e==null?{}:{playback:e},...t==null?{}:{drm:t},...n==null?{}:{thumbnail:n},...r==null?{}:{storyboard:r}}}set tokens(e){Ex(this,fC,e??{})}get playbackToken(){return this.getAttribute(Z.PLAYBACK_TOKEN)??void 0}set playbackToken(e){this.setAttribute(Z.PLAYBACK_TOKEN,`${e}`)}get drmToken(){return this.getAttribute(Z.DRM_TOKEN)??void 0}set drmToken(e){this.setAttribute(Z.DRM_TOKEN,`${e}`)}get thumbnailToken(){return this.getAttribute(Z.THUMBNAIL_TOKEN)??void 0}set thumbnailToken(e){this.setAttribute(Z.THUMBNAIL_TOKEN,`${e}`)}get storyboardToken(){return this.getAttribute(Z.STORYBOARD_TOKEN)??void 0}set storyboardToken(e){this.setAttribute(Z.STORYBOARD_TOKEN,`${e}`)}addTextTrack(e,t,n,r){let i=this.media?.nativeEl;if(i)return ei(i,e,t,n,r)}removeTextTrack(e){let t=this.media?.nativeEl;if(t)return ti(t,e)}get textTracks(){return this.media?.textTracks}get castReceiver(){return this.getAttribute(Z.CAST_RECEIVER)??void 0}set castReceiver(e){e!==this.castReceiver&&(e?this.setAttribute(Z.CAST_RECEIVER,e):this.removeAttribute(Z.CAST_RECEIVER))}get castCustomData(){return this.media?.castCustomData}set castCustomData(e){if(!this.media){oS(`underlying media element missing when trying to set castCustomData. castCustomData will not be set.`);return}this.media.castCustomData=e}get noTooltips(){return this.hasAttribute(Z.NO_TOOLTIPS)}set noTooltips(e){if(!e){this.removeAttribute(Z.NO_TOOLTIPS);return}this.setAttribute(Z.NO_TOOLTIPS,``)}get proudlyDisplayMuxBadge(){return this.hasAttribute(Z.PROUDLY_DISPLAY_MUX_BADGE)}set proudlyDisplayMuxBadge(e){e?this.setAttribute(Z.PROUDLY_DISPLAY_MUX_BADGE,``):this.removeAttribute(Z.PROUDLY_DISPLAY_MUX_BADGE)}get capRenditionToPlayerSize(){return this.media?.capRenditionToPlayerSize}set capRenditionToPlayerSize(e){if(!this.media){oS(`underlying media element missing when trying to set capRenditionToPlayerSize`);return}this.media.capRenditionToPlayerSize=e}};uC=new WeakMap,dC=new WeakMap,fC=new WeakMap,pC=new WeakMap,mC=new WeakMap,hC=new WeakMap,gC=new WeakMap,_C=new WeakMap,vC=new WeakMap,yC=new WeakMap,bC=new WeakMap,xC=new WeakMap,Q=new WeakSet,SC=function(){var e,t;if(!X(this,dC)){Ex(this,dC,!0),Dx(this,Q,TC).call(this);try{if(customElements.upgrade(this.mediaTheme),!(this.mediaTheme instanceof Lx.HTMLElement))throw``}catch{oS(`<media-theme> failed to upgrade!`)}try{customElements.upgrade(this.media)}catch{oS(`underlying media element failed to upgrade!`)}try{if(customElements.upgrade(this.mediaController),!(this.mediaController instanceof Iu))throw``}catch{oS(`<media-controller> failed to upgrade!`)}Dx(this,Q,EC).call(this),Dx(this,Q,DC).call(this),Dx(this,Q,OC).call(this),Ex(this,pC,this.mediaController?.hasAttribute(B.USER_INACTIVE)??!0),Dx(this,Q,kC).call(this),(e=this.media)==null||e.addEventListener(`streamtypechange`,X(this,gC)),(t=this.media)==null||t.addEventListener(`loadstart`,X(this,_C))}},CC=function(){var e,t;try{(e=window==null?void 0:window.CSS)==null||e.registerProperty({name:`--media-primary-color`,syntax:`<color>`,inherits:!0}),(t=window==null?void 0:window.CSS)==null||t.registerProperty({name:`--media-secondary-color`,syntax:`<color>`,inherits:!0})}catch{}},wC=function(e){Object.assign(X(this,bC),e),Dx(this,Q,TC).call(this)},TC=function(e={}){PS(IS(QS(this,{...X(this,bC),...e})),this.shadowRoot)},EC=function(){let e=e=>{var t,n;if(!(e!=null&&e.startsWith(`theme-`)))return;let r=e.replace(/^theme-/,``);if(ZS.includes(r))return;let i=this.getAttribute(e);i==null?(n=this.mediaTheme)==null||n.removeAttribute(r):(t=this.mediaTheme)==null||t.setAttribute(r,i)};Ex(this,hC,new MutationObserver(t=>{for(let{attributeName:n}of t)e(n)})),X(this,hC).observe(this,{attributes:!0}),this.getAttributeNames().forEach(e)},DC=function(){this.addEventListener(`error`,X(this,xC)),this.media&&(this.media.errorTranslator=(e={})=>{if(!(this.media?.error instanceof w))return e;let t=GS(this.media?.error,!1);return{player_error_code:this.media?.error.code,player_error_message:t.message?String(t.message):e.player_error_message,player_error_context:t.context?String(t.context):e.player_error_context}})},OC=function(){var e,t;(e=this.media?.textTracks)==null||e.addEventListener(`addtrack`,X(this,vC)),(t=this.media?.textTracks)==null||t.addEventListener(`removetrack`,X(this,vC))},kC=function(){var e,t;if(!/Firefox/i.test(navigator.userAgent))return;let n,r=new WeakMap,i=()=>this.streamType===T.LIVE&&!this.secondaryColor&&this.offsetWidth>=800,a=(e,t,n=!1)=>{i()||Array.from(e&&e.activeCues||[]).forEach(e=>{if(!(!e.snapToLines||e.line<-5||e.line>=0&&e.line<10))if(!t||this.paused){let t=e.text.split(`
`).length,i=-3;this.streamType===T.LIVE&&(i=-2);let a=i-t;if(e.line===a&&!n)return;r.has(e)||r.set(e,e.line),e.line=a}else setTimeout(()=>{e.line=r.get(e)||`auto`},500)})},o=()=>{a(n,this.mediaController?.hasAttribute(B.USER_INACTIVE)??!1)},s=()=>{let e=Array.from(this.mediaController?.media?.textTracks||[]).filter(e=>[`subtitles`,`captions`].includes(e.kind)&&e.mode===`showing`)[0];e!==n&&n?.removeEventListener(`cuechange`,o),n=e,n?.addEventListener(`cuechange`,o),a(n,X(this,pC))};s(),(e=this.textTracks)==null||e.addEventListener(`change`,s),(t=this.textTracks)==null||t.addEventListener(`addtrack`,s);let c=()=>{let e=this.mediaController?.hasAttribute(B.USER_INACTIVE)??!0;X(this,pC)!==e&&(Ex(this,pC,e),a(n,X(this,pC)))};this.addEventListener(`userinactivechange`,c),Ex(this,yC,()=>{var e,t;n?.removeEventListener(`cuechange`,o),(e=this.textTracks)==null||e.removeEventListener(`change`,s),(t=this.textTracks)==null||t.removeEventListener(`addtrack`,s),this.removeEventListener(`userinactivechange`,c)})};function jC(e,t){return e.media?e.media.getAttribute(t):e.getAttribute(t)}var MC=AC,NC=e=>{throw TypeError(e)},PC=(e,t,n)=>t.has(e)||NC(`Cannot `+n),FC=(e,t,n)=>(PC(e,t,`read from private field`),n?n.call(e):t.get(e)),IC=(e,t,n)=>t.has(e)?NC(`Cannot add the same private member more than once`):t instanceof WeakSet?t.add(e):t.set(e,n),LC=(e,t,n,r)=>(PC(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),RC=class{addEventListener(){}removeEventListener(){}dispatchEvent(e){return!0}};if(typeof DocumentFragment>`u`){class e extends RC{}globalThis.DocumentFragment=e}var zC=class extends RC{},BC=class extends RC{},VC={get(e){},define(e,t,n){},getName(e){return null},upgrade(e){},whenDefined(e){return Promise.resolve(zC)}},HC,UC=class{constructor(e,t={}){IC(this,HC),LC(this,HC,t?.detail)}get detail(){return FC(this,HC)}initCustomEvent(){}};HC=new WeakMap;function WC(e,t){return new zC}var GC={document:{createElement:WC},DocumentFragment,customElements:VC,CustomEvent:UC,EventTarget:RC,HTMLElement:zC,HTMLVideoElement:BC},KC=typeof window>`u`||globalThis.customElements===void 0,qC=KC?GC:globalThis;KC?GC.document:globalThis.document,qC.customElements.get(`mux-player`)||(qC.customElements.define(`mux-player`,MC),qC.MuxPlayerElement=MC);var JC=!0,YC={className:`class`,classname:`class`,htmlFor:`for`,crossOrigin:`crossorigin`,viewBox:`viewBox`,playsInline:`playsinline`,autoPlay:`autoplay`,playbackRate:`playbackrate`},XC=e=>e==null,ZC=(e,t)=>XC(t)?!1:e in t,QC=e=>e.replace(/[A-Z]/g,e=>`-${e.toLowerCase()}`),$C=(e,t)=>{if(!(!JC&&typeof t==`boolean`&&!t)){if(ZC(e,YC))return YC[e];if(t!==void 0)return/[A-Z]/.test(e)?QC(e):e}},ew=(e,t)=>!JC&&typeof e==`boolean`?``:e,tw=(e={})=>{let{ref:t,...n}=e;return Object.entries(n).reduce((e,[t,n])=>{let r=$C(t,n);return r&&(e[r]=ew(n,t)),e},{})};function nw(e,t){if(typeof e==`function`)return e(t);e!=null&&(e.current=t)}function rw(...e){return t=>{let n=!1,r=e.map(e=>{let r=nw(e,t);return!n&&typeof r==`function`&&(n=!0),r});if(n)return()=>{for(let t=0;t<r.length;t++){let n=r[t];typeof n==`function`?n():nw(e[t],null)}}}}function iw(...e){return o.useCallback(rw(...e),e)}var aw=Object.prototype.hasOwnProperty,ow=(e,t)=>{if(Object.is(e,t))return!0;if(typeof e!=`object`||!e||typeof t!=`object`||!t)return!1;if(Array.isArray(e))return!Array.isArray(t)||e.length!==t.length?!1:e.some((e,n)=>t[n]===e);let n=Object.keys(e),r=Object.keys(t);if(n.length!==r.length)return!1;for(let r=0;r<n.length;r++)if(!aw.call(t,n[r])||!Object.is(e[n[r]],t[n[r]]))return!1;return!0},sw=(e,t,n)=>!ow(t,e[n]),cw=(e,t,n)=>{e[n]=t},lw=(e,t,n,r=cw,i=sw)=>(0,o.useEffect)(()=>{let a=n?.current;a&&i(a,t,e)&&r(a,t,e)},[n?.current,t]),uw=(()=>{try{return`3.13.0`}catch{}return`UNKNOWN`})(),dw=()=>uw,$=(e,t,n)=>(0,o.useEffect)(()=>{let r=t?.current;if(!r||!n)return;let i=e,a=n;return r.addEventListener(i,a),()=>{r.removeEventListener(i,a)}},[t?.current,n,e]),fw=o.forwardRef(({children:e,...t},n)=>o.createElement(`mux-player`,{suppressHydrationWarning:!0,...tw(t),ref:n},e)),pw=(e,t)=>{let{onAbort:n,onCanPlay:r,onCanPlayThrough:i,onEmptied:a,onLoadStart:o,onLoadedData:s,onLoadedMetadata:c,onProgress:l,onDurationChange:u,onVolumeChange:d,onRateChange:f,onResize:p,onWaiting:m,onPlay:h,onPlaying:g,onTimeUpdate:_,onPause:ee,onSeeking:te,onSeeked:ne,onStalled:re,onSuspend:ie,onEnded:ae,onError:oe,onCuePointChange:se,onChapterChange:ce,metadata:le,tokens:ue,paused:de,playbackId:fe,playbackRates:pe,currentTime:me,themeProps:he,extraSourceParams:ge,castCustomData:_e,_hlsConfig:ve,...ye}=t;return lw(`tokens`,ue,e),lw(`playbackId`,fe,e),lw(`playbackRates`,pe,e),lw(`metadata`,le,e),lw(`extraSourceParams`,ge,e),lw(`_hlsConfig`,ve,e),lw(`themeProps`,he,e),lw(`castCustomData`,_e,e),lw(`paused`,de,e,(e,t)=>{t!=null&&(t?e.pause():e.play())},(e,t,n)=>e.hasAttribute(`autoplay`)&&!e.hasPlayed?!1:sw(e,t,n)),lw(`currentTime`,me,e,(e,t)=>{t!=null&&(e.currentTime=t)}),$(`abort`,e,n),$(`canplay`,e,r),$(`canplaythrough`,e,i),$(`emptied`,e,a),$(`loadstart`,e,o),$(`loadeddata`,e,s),$(`loadedmetadata`,e,c),$(`progress`,e,l),$(`durationchange`,e,u),$(`volumechange`,e,d),$(`ratechange`,e,f),$(`resize`,e,p),$(`waiting`,e,m),$(`play`,e,h),$(`playing`,e,g),$(`timeupdate`,e,_),$(`pause`,e,ee),$(`seeking`,e,te),$(`seeked`,e,ne),$(`stalled`,e,re),$(`suspend`,e,ie),$(`ended`,e,ae),$(`error`,e,oe),$(`cuepointchange`,e,se),$(`chapterchange`,e,ce),[ye]},mw=dw(),hw=`mux-player-react`,gw=o.forwardRef((e,t)=>{let n=(0,o.useRef)(null),r=iw(n,t),[i]=pw(n,e),[a]=(0,o.useState)(e.playerInitTime??na());return o.createElement(fw,{ref:r,defaultHiddenCaptions:e.defaultHiddenCaptions,playerSoftwareName:hw,playerSoftwareVersion:mw,playerInitTime:a,...i})});export{xr as MaxResolution,w as MediaError,Sr as MinResolution,Cr as RenditionOrder,gw as default,na as generatePlayerInitTime,hw as playerSoftwareName,mw as playerSoftwareVersion};